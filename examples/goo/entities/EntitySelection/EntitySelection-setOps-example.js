...
console.log('Flying mammals', flyingMammals.get().map(function (entity) {
	return entity.name;
}));
console.log('Flying or mammals', flyingOrMammals.get().map(function (entity) {
	return entity.name;
}));
console.log('!Mammals', notMammals.get().map(function (entity) {
	return entity.name;
}));
