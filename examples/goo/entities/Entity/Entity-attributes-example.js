...
// a very simple game
var hero = world.createEntity().setTag('hero').setAttribute('hit-points', 30).setAttribute('attack-power', 3).setTag('alive').addToWorld();

var monster = world.createEntity().setTag('monster').setAttribute('hit-points', 20).setAttribute('attack-power', 2).setTag('alive').addToWorld();
