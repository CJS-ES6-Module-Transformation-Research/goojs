...
var typeexpressionstypeparser_parsejs = _interopRequireWildcard(_typeParser);

var _ternSerializer = require("./type-expressions/tern-serializer");

var typeexpressionsternserializer_serializejs = _interopRequireWildcard(_ternSerializer);
...
var compileOptions = function () {
	var generateId = (0, _util.utiljs)('_options_');
...
function buildClasses(classes) {
	...
	_fs2.default.writeFileSync(args.outPath + _util.utiljs + 'tern-defs.json', result);
}
