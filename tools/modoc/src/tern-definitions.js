...
var _defaultTernDefinitions2 = _interopRequireDefault(_defaultTernDefinitions);
...
function buildClasses(classes) {
	...
	var ternDefinitions = {
		...
		'Context': _defaultTernDefinitions2.default['Context'],
		'Arguments': _defaultTernDefinitions2.default['Arguments']
	};
