...
import { parse as typeparser_parsejs } from "./type-expressions/type-parser";
import { serialize as ternserializer_serializejs } from "./type-expressions/tern-serializer";
...
function makeConverter(classNames) {
	...
	return function (closureType) {
		var parsed = typeparser_parsejs.parse(closureType);
		var ternType = ternserializer_serializejs.serialize(parsed);
