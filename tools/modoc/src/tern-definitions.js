...
import { parse } from "./type-expressions/type-parser";
import { serialize } from "./type-expressions/tern-serializer";
...
function makeConverter(classNames) {
	...
	return function (closureType) {
		var parsed = parse(closureType);
		var ternType = serialize(parsed);
