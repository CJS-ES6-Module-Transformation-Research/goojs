...
var tagAndIdentifier = function tagAndIdentifier(tag) {
	return {
		tag: tag,
		identifier: (0, _util.tagToIdentifier)(tag)
	};
};
...
var all = function all(jsData, files) {
	if (!typesRegex) {
		var types = files.map(_util.getFileName);
...
exports.all = mod_all = all;
exports.compileComment = mod_compileComment = compileComment;
exports.link = mod_link = link;
var mod_all;
exports.all = mod_all;

var mod_compileComment;
exports.compileComment = mod_compileComment;

var mod_link;
exports.link = mod_link;