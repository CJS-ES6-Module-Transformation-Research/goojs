...
var link = exports.link = function link(comment) {
	if (!comment) {
		return;
	}
...
var compileComment = exports.compileComment = function compileComment(rawComment) {
...
var all = exports.all = function all(jsData, files) {
	if (!typesRegex) {
