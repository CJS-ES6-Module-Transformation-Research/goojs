...
var tokenizer_tokenizejs = _interopRequireWildcard(_tokenizer);
...
var _parse = function _parse(stringOrTokens) {
	var tokens = typeof stringOrTokens === 'string' ? tokenizer_tokenizejs(stringOrTokens) : stringOrTokens;
