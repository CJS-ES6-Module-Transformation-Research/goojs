...
function compileDoc(files) {
	...
	files.forEach(function (file) {
		console.log('compiling doc for ' + (0, _util.utiljs)(file));
...
exports.getFiles = mod_getFiles = getFiles;
var filterPrivates;
filterPrivates = filterPrivates;
exports.compileDoc = mod_compileDoc = compileDoc;
var mod_getFiles;
exports.getFiles = mod_getFiles;

var mod_compileDoc;
exports.compileDoc = mod_compileDoc;