...
getFiles = function getFiles(ext_path_path, callback) {
	return (0, _glob2.default)(ext_path_path + '/**/!(index).html', function (err, files) {
...
getFilesSync = function getFilesSync(ext_path_path) {
	return _glob2.default.sync(ext_path_path + '/**/!(index).html');
};

var run;

run = function run(rootPath, title) {
