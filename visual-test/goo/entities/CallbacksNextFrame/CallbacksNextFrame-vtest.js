...
V.describe(['Every frame a callback will spin the boxes a bit and schedule itself to execute one more time, the next frame.', 'The boxes should therefore spin smoothly/continuously'].join('\n'));
