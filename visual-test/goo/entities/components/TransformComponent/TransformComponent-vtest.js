...
V.describe(['One of the box towers are assembled with the preserve-transform option enabled and one without.', 'After repeated assembling/disassembling the boxes should remain in their initial positions.'].join('\n'));
