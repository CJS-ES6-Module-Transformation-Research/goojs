...
function addFire(gooRunner) {
	...
	gooRunner.world.createEntity(particleComponent.meshData, material, particleComponent, [10, 0, 0]).addToWorld();
}
...
function addBox(gooRunner) {
	...
	gooRunner.world.createEntity(boxMeshData, boxMaterial, [0, 15.01, 0]).addToWorld();
}
