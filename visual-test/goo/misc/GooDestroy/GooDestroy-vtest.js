...
V.describe(['Hit 1 to create a goo instance and 2 to destroy it.', ' Use this visual test to check if the garbage collector can collect anything related to goo'].join('\n'));
