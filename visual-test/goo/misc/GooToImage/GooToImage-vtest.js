...
V.describe(['This vtest shows how to get an image from a canvas.', 'Press A to slice the scene in several images display them and kill the goo renderer.'].join('\n'));
