...
V.describe(['A scene with a goon and the bloom post effect is loaded and unloaded repeatedly.', 'All resources should be deallocated on unload and with time the memory usage should not go up.', 'Use a webgl inspector to track how many textures/buffers/programs are used at any time.'].join('\n'));
