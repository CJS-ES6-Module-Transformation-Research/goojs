...
var plane = gooRunner.world.createEntity(new Box(30, 30, 0.5), V.getColoredMaterial(1, 1, 1, 1), [0, 0, -6]).addToWorld();
...
addSpotLight(gooRunner).set([3, -4, 5]).lookAt(Vector3.ZERO, Vector3.UNIT_Y);
