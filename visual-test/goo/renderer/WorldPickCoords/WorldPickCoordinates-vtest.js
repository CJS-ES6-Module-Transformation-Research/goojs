...
V.describe(['Click on any object and a small red sphere should appear at the intersection between the pick ray originating from the camera and the clicked-on object', 'Change the projection mode by hitting P'].join('\n'));
...
var onPick = function onPick(event) {
	if (event.entity) {
