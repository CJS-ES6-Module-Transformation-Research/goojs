...
V.describe(['Select and entity and transform it using the transform gizmos.', 'Change the active gizmo by hitting 1, 2, 3, 4 or 5.'].join('\n'));
	...
	document.body.addEventListener('keydown', function (e) {
		switch (e.which) {
			...
			case 53:
				...
				break;
			default:
				console.log(['1: translate gizmo, global', '2: translate gizmo, local', '3: rotate gizmo, global', '4: rotate gizmo, local', '5: scale gizmo'].join('\n'));
		}
	});
