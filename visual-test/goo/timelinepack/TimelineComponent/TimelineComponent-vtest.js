...
V.describe(['Value/event channels in action.', 'The shapes\' rotation and scale are controlled by a value channel and the messages in the console are triggered by event channels.'].join('\n'));
...
function getValueChannel() {
	...
	var channel = new ValueChannel('id', {
		...
		callbackEnd: function callbackEnd() {
			trace = [];
		}
	});
