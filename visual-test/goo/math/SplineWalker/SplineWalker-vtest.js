...
V.describe(['The spheres on the spline to the left distributed by interpolating with a constant increment on `t`.', 'The spheres on the spline to the right are distributed uniformly by using a SplineWalker.'].join(''));
...
var controlPoints0 = [new Vector3(-1, -1, 0), new Vector3(1, -1, 0), new Vector3(1, 0.5, 0), new Vector3(0, 1, 0), new Vector3(-1, 1.5, 0), new Vector3(-0.5, 2.25, 0), new Vector3(0, 2, 0)];
