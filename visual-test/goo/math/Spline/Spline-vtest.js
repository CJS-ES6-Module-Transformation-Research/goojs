...
var line = function line(from, to, ends) {
...
function cubicBezier(controlPoints, nSteps) {
	var getPoint = Spline.cubicInterpolation.bind(null, controlPoints[0], controlPoints[1], controlPoints[2], controlPoints[3]);
...
function quadraticBezier(controlPoints, nSteps) {
	var getPoint = Spline.quadraticInterpolation.bind(null, controlPoints[0], controlPoints[1], controlPoints[2]);
...
var splineControlPoints = [new Vector3(-1, -1, 0), new Vector3(1, -1, 0), new Vector3(1, 0.5, 0), new Vector3(0, 1, 0), new Vector3(-1, 1.5, 0), new Vector3(-0.5, 2.25, 0), new Vector3(0, 2, 0)];

var cubicBezierControlPoints = [new Vector3(-4, -1, 0), new Vector3(-5, 1, 0), new Vector3(-2, 1, 0), new Vector3(-3, -1, 0)];

var quadraticBezierControlPoints = [new Vector3(5, -1, 0), new Vector3(3, -1, 0), new Vector3(3, 0, 0)];
