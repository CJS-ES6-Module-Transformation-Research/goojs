...
var uniformBoxEntity = world.createEntity(uniformBoxMeshData, materialUniform, 'Uniform', [-4.5, 0, 0]).addToWorld();
V.showNormals(uniformBoxEntity);

// add unfolded mapped box
var unfoldedBoxMeshData = new Box(1, 1, 1, 1, 1, Box.TextureModes.Unfolded);
var unfoldedBoxEntity = world.createEntity(unfoldedBoxMeshData, materialUnfolded, 'Unfolded', [4.5, 0, 0]).addToWorld();
