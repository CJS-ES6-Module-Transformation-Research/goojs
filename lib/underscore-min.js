...
!function () {
  var n = this,
  ...
  };"undefined" != typeof _exports ? ("undefined" != typeof module && module.exports && (_exports = module.exports = j), _exports._ = j) : n._ = j, j.VERSION = "1.5.1";var A = j.each = j.forEach = function (n, t, e) {
    ...
    var u = arguments.length > 2;if (null == n && (n = []), v && n.reduce === v) return e && (t = j.bind(t, e)), u ? n.reduce(t, r) : n.reduce(t);if (A(n, function (n, i, a) {
      u ? r = t.call(e, r, n, i, a) : (r = n, u = !0);
    }), !u) throw new TypeError(E);return r;
  }, j.reduceRight = j.foldr = function (n, t, r, e) {
    var u = arguments.length > 2;if (null == n && (n = []), h && n.reduceRight === h) return e && (t = j.bind(t, e)), u ? n.reduceRight(t, r) : n.reduceRight(t);var i = n.length;if (i !== +i) {
    ...
    var e = [];return null == n ? e : d && n.filter === d ? n.filter(t, r) : (A(n, function (n, u, i) {
    ...
    t || (t = j.identity);var u = !0;return null == n ? u : g && n.every === g ? n.every(t, e) : (A(n, function (n, i, a) {
    ...
    var e = F(t);return j.pluck(j.map(n, function (n, t, u) {
    ...
    var u = {},
        i = F(null == t ? j.identity : t);return A(n, function (t, a) {
      var o = i.call(r, t, a, n);e(u, o, t);
    }), u;
    ...
    r = null == r ? j.identity : F(r);for (var u = r.call(e, t), i = 0, a = n.length; a > i;) {
    ...
    }if (y && n.indexOf === y) return n.indexOf(t, r);for (; u > e; e++) {
      if (n[e] === t) return e;
    }return -1;
  }, j.lastIndexOf = function (n, t, r) {
    if (null == n) return -1;var e = null != r;if (b && n.lastIndexOf === b) return e ? n.lastIndexOf(t, r) : n.lastIndexOf(t);for (var u = e ? r : n.length; u--;) {
      if (n[u] === t) return u;
    }return -1;
  }, j.range = function (n, t, r) {
    arguments.length <= 1 && (t = n || 0, n = 0), r = arguments[2] || 1;for (var e = Math.max(Math.ceil((t - n) / r), 0), u = 0, i = new Array(e); e > u;) {
      i[u++] = n, n += r;
    }return i;
  };var M = function M() {};j.bind = function (n, t) {
    var r, _e;if (w && n.bind === w) return w.apply(n, o.call(arguments, 1));if (!j.isFunction(n)) throw new TypeError();return r = o.call(arguments, 2), _e = function e() {
      if (!(this instanceof _e)) return n.apply(t, r.concat(o.call(arguments)));M.prototype = n.prototype;var u = new M();M.prototype = null;var i = n.apply(u, r.concat(o.call(arguments)));return Object(i) === i ? i : u;
    };
    ...
    var e,
        u = null;return function () {
      var i = this,
          a = arguments,
          o = function o() {
        u = null, r || (e = n.apply(i, a));
      },
          c = r && !u;return clearTimeout(u), u = setTimeout(o, t), c && (e = n.apply(i, a)), e;
    };
  }, j.once = function (n) {
    var t,
        r = !1;return function () {
    ...
    if (n !== Object(n)) throw new TypeError("Invalid object");var t = [];for (var r in n) {
      j.has(n, r) && t.push(r);
    }return t;
  }, j.values = function (n) {
    ...
    var t = {},
        r = c.apply(e, o.call(arguments, 1));for (var u in n) {
    ...
    if (n === t) return 0 !== n || 1 / n == 1 / t;if (null == n || null == t) return n === t;n instanceof j && (n = n._wrapped), t instanceof j && (t = t._wrapped);var u = l.call(n);if (u != l.call(t)) return !1;switch (u) {case "[object String]":
        ...
        return n.source == t.source && n.global == t.global && n.multiline == t.multiline && n.ignoreCase == t.ignoreCase;}if ("object" != (typeof n === "undefined" ? "undefined" : _typeof(n)) || "object" != (typeof t === "undefined" ? "undefined" : _typeof(t))) return !1;for (var i = r.length; i--;) {
    ...
    if (null == n) return !0;if (j.isArray(n) || j.isString(n)) return 0 === n.length;for (var t in n) {
