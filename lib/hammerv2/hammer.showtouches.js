(function (Hammer) {
    ...
    Hammer.plugins.showTouches = function () {
        ...
        var template = '<div style="position:absolute;left:0;top:0;height:14px;width:14px;border:solid 2px #777;' + 'background:rgba(255,255,255,.7);border-radius:20px;pointer-events:none;' + 'margin-top:-9px;margin-left:-9px;"></div>';
        ...
        Hammer.gesture.register({
            name: 'show_touches',
            priority: 0,
            handler: function handler(ev, inst) {
                // get touches by ID
                var touches_index = {};
