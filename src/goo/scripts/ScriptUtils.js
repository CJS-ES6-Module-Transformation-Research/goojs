...
var functionObject_isRefType = function(type) {
...
var functionObject_TYPE_VALIDATORS = function() {
    var isVec = function(length) {
        return function(data) {
            return Array.isArray(data) && data.length === length;
        };
...
var functionObject_PARAMETER_CONTROLS = function() {
    var typeControls = {
        "string": ["key"],
        "int": ["spinner", "slider", "jointSelector"],
        "float": ["spinner", "slider"],
...
var functionObject_fillDefaultValues = function(parameters, specs) {
...
var functionObject_fillDefaultNames = function(specs) {
    if (!(specs instanceof Array)) {
        return;
    }
...
var functionObject_getKey = function(str) {
...
var functionObject__keyInverse = function(assoc) {
    var inverseAssoc = {};
...
var functionObject_keyForCode = function(code) {
