...
EnvironmentHandler.prototype = Object.create(ConfigHandlerjs.prototype);
EnvironmentHandler.prototype.constructor = EnvironmentHandler;
ConfigHandlerjs._registerClass('environment', EnvironmentHandler);

EnvironmentHandler.prototype._prepare = function (config) {
	ObjectUtilsjs.defaults(config, defaults);
};
...
EnvironmentHandler.prototype._update = function (ref, config, options) {
	...
	return ConfigHandlerjs.prototype._update.call(this, ref, config, options).then(function (object) {
		...
		object.fog = ObjectUtilsjs.deepClone(config.fog);
