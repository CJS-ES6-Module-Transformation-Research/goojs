...
import { TransformComponent as TransformComponent_TransformComponentjs } from "../../entities/components/TransformComponent";
...
TransformComponentHandler.prototype = Object.create(ComponentHandler_ComponentHandlerjs.prototype);
TransformComponentHandler.prototype.constructor = TransformComponentHandler;
ComponentHandler_ComponentHandlerjs._registerClass('transform', TransformComponentHandler);
...
TransformComponentHandler.prototype._create = function () {
	return new TransformComponent_TransformComponentjs();
};
...
TransformComponentHandler.prototype.update = function (entity, config, options) {
	...
	return ComponentHandler_ComponentHandlerjs.prototype.update.call(this, entity, config, options).then(function (component) {
		...
		component.transform.setRotationXYZ(
			MathUtils_MathUtilsjs.DEG_TO_RAD * config.rotation[0],
			MathUtils_MathUtilsjs.DEG_TO_RAD * config.rotation[1],
			MathUtils_MathUtilsjs.DEG_TO_RAD * config.rotation[2]
		);
		// Scale
