...
(0, _ComponentHandler._registerClass)('transform', TransformComponentHandler);
...
TransformComponentHandler.prototype.update = function (entity, config, options) {
	...
	return _ComponentHandler.ComponentHandler.prototype.update.call(this, entity, config, options).then(function (component) {
		...
		// Rotation
		component.transform.setRotationXYZ(_MathUtils.DEG_TO_RAD * config.rotation[0], _MathUtils.DEG_TO_RAD * config.rotation[1], _MathUtils.DEG_TO_RAD * config.rotation[2]);
		// Scale
 ...
 * @hidden
 */
exports.TransformComponentHandler = mod_TransformComponentHandler;