...
SkyboxHandler.prototype._remove = function (ref) {
	...
	if (this._activeSkyboxRef === ref) {
		...
		this._activeSkyshape = null;
		ShaderBuilderjs_SKYBOX = null;
		ShaderBuilderjs_SKYSPHERE = null;
		this._activeSkyboxRef = null;
	}
};
...
SkyboxHandler.prototype._show = function (skyshape) {
	...
	ShaderBuilderjs_SKYBOX = skyshape === this._skybox ? this._skyboxTexture : null;
	ShaderBuilderjs_SKYSPHERE = skyshape === this._skysphere ? this._skysphereTexture : null;
};
