...
loadershandlersConfigHandler_ConfigHandlerjs._registerClass('skybox', SkyboxHandler);
...
SkyboxHandler.prototype._remove = function (ref) {
	...
	if (this._activeSkyboxRef === ref) {
		...
		this._activeSkyshape = null;
		renderershadersShaderBuilder_ShaderBuilderjs.SKYBOX = null;
		renderershadersShaderBuilder_ShaderBuilderjs.SKYSPHERE = null;
		this._activeSkyboxRef = null;
	}
};
...
SkyboxHandler.prototype._show = function (skyshape) {
	...
	renderershadersShaderBuilder_ShaderBuilderjs.SKYBOX = skyshape === this._skybox ? this._skyboxTexture : null;
	renderershadersShaderBuilder_ShaderBuilderjs.SKYSPHERE = skyshape === this._skysphere ? this._skysphereTexture : null;
};
