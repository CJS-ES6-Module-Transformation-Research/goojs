...
HtmlComponentHandler.prototype = Object.create(ComponentHandlerjs.prototype);
ComponentHandlerjs._registerClass('html', HtmlComponentHandler);
...
HtmlComponentHandler.prototype._loadImages = function (domElement, options) {
	...
	function loadImage(htmlImage) {
		...
		if (!imageRef) { return PromiseUtilsjs.resolve(); }
