...
LightComponentHandler.prototype.update = function (entity, config, options) {
	var that = this;
	var Light = {
		SpotLight_SpotLightjs: _SpotLight.SpotLight,
		DirectionalLight_DirectionalLightjs: _DirectionalLight.DirectionalLight,
		PointLight_PointLightjs: _PointLight.PointLight
	};
