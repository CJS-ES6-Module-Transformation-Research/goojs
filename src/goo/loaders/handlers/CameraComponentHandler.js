...
import { CameraComponent as CameraComponent_CameraComponentjs } from "../../entities/components/CameraComponent";
...
ComponentHandler_ComponentHandlerjs._registerClass('camera', CameraComponentHandler);
...
CameraComponentHandler.prototype._create = function () {
	var camera = new Camera_Camerajs(45, 1, 1, 1000);
	var component = new CameraComponent_CameraComponentjs(camera);
	return component;
};
...
CameraComponentHandler.prototype.update = function (entity, config, options) {
	return ComponentHandler_ComponentHandlerjs.prototype.update.call(this, entity, config, options).then(function (component) {
		if (!component) { return; }
		component.camera.setProjectionMode(Camera_Camerajs[config.projectionMode]);
