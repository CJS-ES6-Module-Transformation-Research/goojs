...
MeshDataComponentHandler.prototype = Object.create(ComponentHandlerjs.prototype);
MeshDataComponentHandler.prototype.constructor = MeshDataComponentHandler;
ComponentHandlerjs._registerClass('meshData', MeshDataComponentHandler);
...
MeshDataComponentHandler.prototype.update = function (entity, config, options) {
	...
	return ComponentHandlerjs.prototype.update.call(this, entity, config, options).then(function (component) {
		...
		if (config.shape) {
			var shapeCreator = ShapeCreatorMemoizedjs['create' + StringUtilsjs.capitalize(config.shape)];
			if (shapeCreator) {
