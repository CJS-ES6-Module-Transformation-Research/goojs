...
MeshRendererComponentHandler.prototype = Object.create(ComponentHandlerjs.prototype);
MeshRendererComponentHandler.prototype.constructor = MeshRendererComponentHandler;
ComponentHandlerjs._registerClass('meshRenderer', MeshRendererComponentHandler);

MeshRendererComponentHandler.DEFAULT_MATERIAL = new Materialjs(ShaderLibjs.uber, 'Default material');
...
MeshRendererComponentHandler.prototype.update = function (entity, config, options) {
   ...
   return ComponentHandlerjs.prototype.update.call(this, entity, config, options).then(function (component) {
       ...
       var promises = [];
       ObjectUtilsjs.forEach(materials, function (item) {
