...
MeshRendererComponentHandler.DEFAULT_MATERIAL = new rendererMaterial_Materialjs(ShaderLibjs_uber, 'Default material');
 ...
 * @hidden
 */
export { MeshRendererComponentHandler_MeshRendererComponentHandler as MeshRendererComponentHandler };
