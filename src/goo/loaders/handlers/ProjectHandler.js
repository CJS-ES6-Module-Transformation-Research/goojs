...
ProjectHandler.prototype = Object.create(ConfigHandler_ConfigHandlerjs.prototype);
ProjectHandler.prototype.constructor = ProjectHandler;
ConfigHandler_ConfigHandlerjs._registerClass('project', ProjectHandler);
...
ProjectHandler.prototype._update = function (ref, config, options) {
	var that = this;
	return ConfigHandler_ConfigHandlerjs.prototype._update.call(this, ref, config, options).then(function (project) {
		if (!project) { return; }
