...
MachineHandler.prototype = Object.create(ConfigHandlerjs.prototype);
MachineHandler.prototype.constructor = MachineHandler;

ConfigHandlerjs._registerClass('machine', MachineHandler);
...
MachineHandler.prototype._update = function (ref, config, options) {
	var that = this;
	return ConfigHandlerjs.prototype._update.call(this, ref, config, options).then(function (machine) {
		if (!machine) { return; }
		machine.id = ref;
...
MachineHandler.prototype._updateActions = function (state, stateConfig) {
	...
	var actions = [];
	ObjectUtilsjs.forEach(stateConfig.actions, function (actionConfig) {
