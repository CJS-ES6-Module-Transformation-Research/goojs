...
import { Actions as fsmpackstatemachineactionsActions_Actionsjs } from "../fsmpack/statemachine/actions/Actions";
...
MachineHandler.prototype._updateActions = function (state, stateConfig) {
	...
	for (var i = 0; i < state._actions.length; i++) {
		...
		if (!stateConfig.actions || !utilObjectUtils_ObjectUtilsjs.actions[action.id]) {
