...
Action.prototype.configure = function (settings) {
	FsmUtils_FsmUtilsjs.setParameters.call(this, settings, this.constructor.external.parameters);
	FsmUtils_FsmUtilsjs.setTransitions.call(this, settings, this.constructor.external.transitions);
};
