...
Action.prototype.configure = function (settings) {
  _FsmUtils.setParameters.call(this, settings, this.constructor.external.parameters);
  _FsmUtils.setTransitions.call(this, settings, this.constructor.external.transitions);
};
