...
Action.prototype.configure = function (settings) {
	FsmUtilsjs.setParameters.call(this, settings, this.constructor.external.parameters);
	FsmUtilsjs.setTransitions.call(this, settings, this.constructor.external.transitions);
};
