...
import { Quadratic as Easingjs_Quadratic } from "../../../util/Easing";

function ShakeAction/*id, settings*/() {
	Action_Actionjs.apply(this, arguments);

	this.oldVal = new Vector3_Vector3js();
	this.target = new Vector3_Vector3js();
	this.vel = new Vector3_Vector3js();
	this.completed = false;
}

ShakeAction.prototype = Object.create(Action_Actionjs.prototype);
...
ShakeAction.prototype.configure = function (settings) {
	...
	this.easing = Easingjs_Quadratic.InOut;
	this.eventToEmit = settings.transitions.complete;
};

ShakeAction.prototype.enter = function (fsm) {
	this.oldVal.set(Vector3_Vector3js.ZERO);
	this.target.set(Vector3_Vector3js.ZERO);
	this.vel.set(Vector3_Vector3js.ZERO);
	this.iter = 0;
...
ShakeAction.prototype.update = function (fsm) {
	...
	var level = MathUtils_MathUtilsjs.lerp(fT, this.startLevel, this.endLevel);
