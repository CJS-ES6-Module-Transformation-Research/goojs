...
SetRotationAction.prototype = Object.create(Actionjs.prototype);
...
SetRotationAction.prototype.setRotation = function (fsm) {
	if (this.entity !== null) {
		this.entity.transformComponent.transform.setRotationXYZ(
			FsmUtilsjs.getValue(this.amountX, fsm),
			FsmUtilsjs.getValue(this.amountY, fsm),
			FsmUtilsjs.getValue(this.amountZ, fsm)
		);
