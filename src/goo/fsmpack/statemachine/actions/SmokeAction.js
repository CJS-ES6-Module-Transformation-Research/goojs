...
SmokeAction.prototype = Object.create(Actionjs.prototype);
...
SmokeAction.prototype.enter = function (fsm) {
	...
	if (!SmokeAction.material) {
		SmokeAction.material = new Materialjs(ShaderLibjs.particles);
	...
	this.smokeEntity = ParticleSystemUtilsjs.createParticleSystemEntity(
		gooRunner.world,
		ParticleLibjs.getSmoke({
			scale: scale,
			color: this.color
		}),
