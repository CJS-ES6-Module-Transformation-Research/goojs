...
var Actions_register = function(name, actionClass) {
    _actions[name] = actionClass;
};

var Actions_actionForType = function(name) {
    return _actions[name];
};

var Actions_allActions = function() {
    var actions = {};
...
var Actions_allActionsArray = function() {
    var array = [];
