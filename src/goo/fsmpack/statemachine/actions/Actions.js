...
exports.allActionsArray = exports.actionForType = undefined;
...
var Actions_allActionsArray;
var Actions_allActions;
var Actions_actionForType;
var Actions_register;

var _actions = {};

var IGNORED_ACTIONS = ['Eval', 'HTMLPick', 'Remove', 'Collides', 'Tag'];

Actions_register = function Actions_register(name, actionClass) {
	_actions[name] = actionClass;
};

exports.actionForType = Actions_actionForType = function Actions_actionForType(name) {
	return _actions[name];
};

Actions_allActions = function Actions_allActions() {
	var actions = {};
...
exports.allActionsArray = Actions_allActionsArray = function Actions_allActionsArray() {
	var array = [];
...
for (var actionName in allActions) {
	...
	Actions_register(action.external.key, action);
}

exports.actionForType = Actions_actionForType;
exports.allActionsArray = Actions_allActionsArray;