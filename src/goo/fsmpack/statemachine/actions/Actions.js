...
register = function register(name, actionClass) {
	_actions[name] = actionClass;
};

exports.actionForType = actionForType = function actionForType(name) {
...
exports.allActionsArray = allActionsArray = function allActionsArray() {
	var array = [];
...
exports.actionForType = actionForType;
exports.allActionsArray = allActionsArray;