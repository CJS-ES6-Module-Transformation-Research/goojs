...
Actions_register = function (name, actionClass) {
	_actions[name] = actionClass;
};

Actions_actionForType = function (name) {
...
Actions_allActionsArray = function () {
	var array = [];
...
export { Actions_actionForType as actionForType, Actions_allActionsArray as allActionsArray };