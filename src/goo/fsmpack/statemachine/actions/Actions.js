...
var Actions_register = function Actions_register(name, actionClass) {
				_actions[name] = actionClass;
};

var Actions_actionForType = function Actions_actionForType(name) {
				return _actions[name];
};

var Actions_allActions = function Actions_allActions() {
				var actions = {};
...
var Actions_allActionsArray = function Actions_allActionsArray() {
				var array = [];
