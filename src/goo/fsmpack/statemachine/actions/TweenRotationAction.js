var TweenRotationAction_TweenRotationAction = TweenRotationAction;
...
TweenRotationAction.prototype.enter = function (fsm) {
	...
	this.quatTo.fromRotationMatrix(new mathMatrix3_Matrix3js().fromAngles(this.to[0] * MathUtilsjs_DEG_TO_RAD, this.to[1] * MathUtilsjs_DEG_TO_RAD, this.to[2] * MathUtilsjs_DEG_TO_RAD));
	if (this.relative) {
...
export { TweenRotationAction_TweenRotationAction as TweenRotationAction };