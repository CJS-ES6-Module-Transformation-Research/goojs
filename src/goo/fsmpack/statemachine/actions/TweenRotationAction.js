...
TweenRotationAction.prototype.enter = function (fsm) {
	...
	this.quatTo.fromRotationMatrix(new _Matrix.Matrix3().fromAngles(this.to[0] * _MathUtils.DEG_TO_RAD, this.to[1] * _MathUtils.DEG_TO_RAD, this.to[2] * _MathUtils.DEG_TO_RAD));
	if (this.relative) {
