var mod_CompareDistanceAction = CompareDistanceAction;
...
CompareDistanceAction.prototype = Object.create(Action_Action.prototype);
...
CompareDistanceAction.prototype.compare = function (fsm) {
	...
	if (this.camera) {
		delta = translation.clone().sub(Renderer_Renderer.mainCamera.translation);
	} else {
...
export { mod_CompareDistanceAction as CompareDistanceAction };