...
var functionObject_split = function(x) {
    var i = Math.floor(x);
    var f = MathUtils.scurve5(x - i);
...
var functionObject_fractal1d = function(x, scale, octaves, persistance, lacunarity, type) {
    var result = 0;
    var amplitude = 1;
    var normalizer = 0;
...
var functionObject_fractal2d = function(x, y, scale, octaves, persistance, lacunarity, type) {
    var result = 0;
    var amplitude = 1;
    var normalizer = 0;
...
var functionObject_fractal3d = function(x, y, z, scale, octaves, persistance, lacunarity, type) {
    var result = 0;
    var amplitude = 1;
    var normalizer = 0;
...
var functionObject_fractal4d = function(x, y, z, w, scale, octaves, persistance, lacunarity, type) {
    var result = 0;
    var amplitude = 1;
    var normalizer = 0;
