...
exports.getRenderablesFor = getRenderablesFor = function getRenderablesFor(component, options) {
	var meshes, material;
...
exports.update = update = function update(renderables, component, camera, renderer) {
...
exports.getRenderablesFor = getRenderablesFor;
