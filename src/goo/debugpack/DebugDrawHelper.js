...
var DebugDrawHelper_getRenderablesFor = function(component, options) {
    ...
    if (component.type === "LightComponent") {
        ...
        material = new rendererMaterial_Materialjs(
            renderershadersShaderLib_ShaderLibjs.simpleColored,
...
var DebugDrawHelper_update = function(renderables, component, camera, renderer) {
