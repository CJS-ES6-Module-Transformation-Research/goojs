...
DebugDrawHelper.getRenderablesFor = function (component, options) {
	...
	if (component.type === 'LightComponent') {
		...
		material = new _Material.Material(ShaderLib.simpleColored, 'DebugDrawLightMaterial');
	} else if (component.type === 'CameraComponent') {
		meshes = cameraDebug.getMesh(component.camera, options);
		material = new _Material.Material(ShaderLib.simpleLit, 'DebugDrawCameraMaterial');
		...
		material = new _Material.Material(ShaderLib.simpleColored, 'DebugMeshRendererComponentMaterial');
	} else if (component instanceof _SkeletonPose.SkeletonPose) {
		meshes = skeletonDebug.getMesh(component, options);
		var materials = [new _Material.Material(ShaderLib.uber, 'SkeletonDebugMaterial'), new _Material.Material(ShaderLib.uber, 'SkeletonDebugMaterial')];
		var renderables = [];
...
var objectLiteral_getRenderablesFor = function objectLiteral_getRenderablesFor(component, options) {
	var meshes, material;
...
exports.getRenderablesFor = objectLiteral_getRenderablesFor;
