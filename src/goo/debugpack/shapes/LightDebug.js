...
function buildCircle(radius, nSegments) {
	...
	var meshData = new MeshDatajs(MeshDatajs.defaultMap([MeshDatajs.POSITION]), nSegments, indices.length);
...
function buildUmbrella(nSegments) {
	...
	var meshData = new MeshDatajs(MeshDatajs.defaultMap([MeshDatajs.POSITION]), nSegments + 1, indices.length);
...
function buildTube(nSegments) {
	...
	var meshData = new MeshDatajs(MeshDatajs.defaultMap([MeshDatajs.POSITION]), nSegments * 2, indices.length);
