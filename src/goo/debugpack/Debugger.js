var Debugger_Debugger = Debugger;
import { MarkerComponent as componentsMarkerComponent_MarkerComponentjs } from "./components/MarkerComponent";
import { MarkerSystem as systemsMarkerSystem_MarkerSystemjs } from "./systems/MarkerSystem";
...
Debugger.prototype.inject = function (goo) {
	...
	if (!this.goo.world.getSystem('MarkerSystem')) {
		this.goo.world.setSystem(new systemsMarkerSystem_MarkerSystemjs(this.goo));
	}
...
function updateMarker(picked, oldPicked) {
	if (picked !== oldPicked) {
		...
		if (picked !== null) {
			picked.setComponent(new componentsMarkerComponent_MarkerComponentjs(picked));
		}
	}
	else {
 ...
 */
export { Debugger_Debugger as Debugger };
