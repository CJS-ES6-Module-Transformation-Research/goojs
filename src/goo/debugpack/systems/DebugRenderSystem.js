...
DebugRenderSystem.prototype.setup = function () {
	_SystemBus.anonymus.addListener('goo.setCurrentCamera', this.cameraListener);
	_SystemBus.anonymus.addListener('goo.setLights', this.lightsListener);
};
...
DebugRenderSystem.prototype.cleanup = function () {
	_SystemBus.anonymus.removeListener('goo.setCurrentCamera', this.cameraListener);
	_SystemBus.anonymus.removeListener('goo.setLights', this.lightsListener);
};
