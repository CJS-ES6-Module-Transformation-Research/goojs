...
function FilledPolygon(verts, indices) {
	...
	MeshDatajs.call(this, attributeMap, this.verts.length / 3, this.indices.length);

	this.rebuild();
}

FilledPolygon.prototype = Object.create(MeshDatajs.prototype);
...
FilledPolygon.prototype.rebuild = function () {
	...
	for (var i = 0; i < this.indices.length; i += 3) {
		var normal = MathUtilsjs.getTriangleNormal(
