...
FilledPolygon.prototype.rebuild = function () {
	...
	for (var i = 0; i < this.indices.length; i += 3) {
		var normal = (0, _MathUtils.getTriangleNormal)(this.verts[this.indices[i + 0] * 3 + 0], this.verts[this.indices[i + 0] * 3 + 1], this.verts[this.indices[i + 0] * 3 + 2], this.verts[this.indices[i + 1] * 3 + 0], this.verts[this.indices[i + 1] * 3 + 1], this.verts[this.indices[i + 1] * 3 + 2], this.verts[this.indices[i + 2] * 3 + 0], this.verts[this.indices[i + 2] * 3 + 1], this.verts[this.indices[i + 2] * 3 + 2]);
 ...
 * @param {Array} indices Array of indices
 */
exports.FilledPolygon = mod_FilledPolygon;