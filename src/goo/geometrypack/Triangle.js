...
Triangle.prototype.rebuild = function () {
	...
	var normals = (0, _MathUtils.getTriangleNormal)(this.verts[0], this.verts[1], this.verts[2], this.verts[3], this.verts[4], this.verts[5], this.verts[6], this.verts[7], this.verts[8]);
