...
function PolyLine(verts, closed) {
	...
	_MeshData2.default.call(this, attributeMap, this.verts.length / 3, this.verts.length / 3);
...
PolyLine.prototype = Object.create(_MeshData2.default.prototype);
...
PolyLine.prototype.mul = function (rhs) {
	...
	return new _Surface2.default(verts, rhsNVerts);
};
...
(function () {
	function getRotationMatrix(verts, index, up, store) {
		...
		var lookAtVector = new _Vector2.default(verts[futureIndex * 3 + 0] - verts[oldIndex * 3 + 0], verts[futureIndex * 3 + 1] - verts[oldIndex * 3 + 1], verts[futureIndex * 3 + 2] - verts[oldIndex * 3 + 2]);
	...
	var FORWARD = _Vector2.default.UNIT_Z;
  ...
  */
	PolyLine.prototype.pipe = function (polyLine, options) {
		...
		var forward = new _Vector2.default();
		var up = _Vector2.default.UNIT_Y.clone();
		var right = new _Vector2.default();

		var rotation = new _Matrix2.default();
		var twist = new _Matrix2.default();
		var scale;
		...
		for (var i = 0; i < this.verts.length; i += 3) {
			...
			for (var j = 0; j < polyLine.verts.length; j += 3) {
				var vertex = new _Vector2.default(polyLine.verts[j + 0], polyLine.verts[j + 1], polyLine.verts[j + 2]);
		...
		return new _Surface2.default(verts, polyLineNVerts);
	};
})();
...
PolyLine.prototype.lathe = function (nSegments) {
	...
	return new _Surface2.default(verts, nSegments + 1, true);
};
