...
function Grid(xSegments, ySegments, width, height) {
	...
	MeshData_MeshDatajs.call(this, attributeMap, vertsCount, idcsCount);
	this.indexModes[0] = 'Lines';
	this.rebuild();
}

Grid.prototype = Object.create(MeshData_MeshDatajs.prototype);
...
Grid.prototype.clone = function () {
	var options = ObjectUtils_ObjectUtilsjs.shallowSelectiveClone(this, ['xSegments', 'ySegments', 'width', 'height']);
