...
function Grid(xSegments, ySegments, width, height) {
	...
	_MeshData2.default.call(this, attributeMap, vertsCount, idcsCount);
	this.indexModes[0] = 'Lines';
	this.rebuild();
}

Grid.prototype = Object.create(_MeshData2.default.prototype);
...
Grid.prototype.clone = function () {
	var options = _ObjectUtils2.default.shallowSelectiveClone(this, ['xSegments', 'ySegments', 'width', 'height']);
