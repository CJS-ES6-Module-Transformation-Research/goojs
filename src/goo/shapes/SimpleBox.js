...
SimpleBox.prototype.rebuild = function () {
	...
	this.getAttributeBuffer(MeshDatajs_POSITION).set([-xExtent, -yExtent, -zExtent, xExtent, -yExtent, -zExtent, xExtent, yExtent, -zExtent, -xExtent, yExtent, -zExtent, -xExtent, -yExtent, zExtent, xExtent, -yExtent, zExtent, xExtent, yExtent, zExtent, -xExtent, yExtent, zExtent]);
...
var exported_SimpleBox = SimpleBox;
 ...
 */
exports.SimpleBox = exported_SimpleBox;
