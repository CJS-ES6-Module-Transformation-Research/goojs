...
function Cone(radialSamples, radius, height) {
	...
	MeshData_MeshDatajs.call(this, attributeMap, this.radialSamples * 3 + this.radialSamples + 1, this.radialSamples * 3 * 2);
...
Cone.prototype = Object.create(MeshData_MeshDatajs.prototype);
...
Cone.prototype.clone = function () {
	var options = ObjectUtils_ObjectUtilsjs.shallowSelectiveClone(this, ['radialSamples', 'radius', 'height']);
