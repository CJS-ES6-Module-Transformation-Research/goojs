...
function Box(width, height, length, tileX, tileY, textureMode) {
	...
	MeshData_MeshDatajs.call(this, attributeMap, 24, 36);

	this.rebuild();
}

Box.prototype = Object.create(MeshData_MeshDatajs.prototype);
...
Box.prototype.rebuild = function () {
	...
	this.getAttributeBuffer(MeshData_MeshDatajs.POSITION).set(vertices);
	...
	this.getAttributeBuffer(MeshData_MeshDatajs.NORMAL).set(normals);
...
Box.prototype.clone = function () {
	var options = ObjectUtils_ObjectUtilsjs.shallowSelectiveClone(this, ['tileX', 'tileY', 'textureMode']);
