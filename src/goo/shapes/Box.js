...
function Box(width, height, length, tileX, tileY, textureMode) {
	...
	MeshDatajs.call(this, attributeMap, 24, 36);

	this.rebuild();
}

Box.prototype = Object.create(MeshDatajs.prototype);
...
Box.prototype.rebuild = function () {
	...
	this.getAttributeBuffer(MeshDatajs.POSITION).set(vertices);
	...
	this.getAttributeBuffer(MeshDatajs.NORMAL).set(normals);
...
Box.prototype.clone = function () {
	var options = ObjectUtilsjs.shallowSelectiveClone(this, ['tileX', 'tileY', 'textureMode']);
