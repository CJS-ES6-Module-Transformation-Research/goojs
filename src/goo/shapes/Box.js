...
function Box(width, height, length, tileX, tileY, textureMode) {
  ...
  */
	...
	_MeshData2.default.call(this, attributeMap, 24, 36);

	this.rebuild();
}

Box.prototype = Object.create(_MeshData2.default.prototype);
...
Box.prototype.rebuild = function () {
	...
	this.getAttributeBuffer(_MeshData2.default.POSITION).set(vertices);
	...
	this.getAttributeBuffer(_MeshData2.default.NORMAL).set(normals);
...
Box.prototype.clone = function () {
	var options = _ObjectUtils2.default.shallowSelectiveClone(this, ['tileX', 'tileY', 'textureMode']);
