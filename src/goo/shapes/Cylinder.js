...
function Cylinder(radialSamples, radiusTop, radiusBottom, height) {
	...
	MeshData_MeshDatajs.call(this, attributeMap, this.radialSamples * 4 + 2 + 2, (this.radialSamples * 3) * 4);
...
Cylinder.prototype = Object.create(MeshData_MeshDatajs.prototype);
...
Cylinder.prototype.rebuild = function () {
	...
	var normal = new Vector3_Vector3js();
...
Cylinder.prototype.clone = function () {
	var options = ObjectUtils_ObjectUtilsjs.shallowSelectiveClone(this, ['radialSamples', 'radiusTop', 'radiusBottom', 'height']);
