var LogicLayer_LogicLayer = LogicLayer;
...
LogicLayer_resolvePortID = function(instDesc, portName) {
 ...
 */
LogicLayer_doConnections = function(instDesc, portID, func) {
    if (instDesc.outConnections === undefined) {
        return;
    }
 ...
 */
LogicLayer_writeValue = function(instDesc, outPortID, value) {
    //
 ...
 */
LogicLayer_writeValueToLayerOutput = function(outNodeDesc, outPortDesc, value) {
    // TODO: Cache writeFn
 ...
 */
LogicLayer_readPort = function(instDesc, portID) {
 ...
 */
LogicLayer_fireEvent = function(instDesc, outPortID) {
    LogicLayer_doConnections(instDesc, outPortID, function(targetDesc, portID) {
...
LogicLayer_resolveEntityRef = function(instDesc, entityRef) {
    if (entityRef === "[self]") {
...
export { LogicLayer_writeValue as writeValue, LogicLayer_writeValueToLayerOutput as writeValueToLayerOutput, LogicLayer_readPort as readPort, LogicLayer_fireEvent as fireEvent, LogicLayer_resolveEntityRef as resolveEntityRef };
 ...
 * @private
 */
export { LogicLayer_LogicLayer as LogicLayer };