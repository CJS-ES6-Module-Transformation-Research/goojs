...
exports.LogicLayer = exports.resolveEntityRef = exports.fireEvent = exports.readPort = exports.writeValueToLayerOutput = exports.writeValue = undefined;

var _LogicInterface = require('./LogicInterface');

var LogicLayer_resolveEntityRef;
var LogicLayer_fireEvent;
var LogicLayer_readPort;
var LogicLayer_writeValueToLayerOutput;
var LogicLayer_writeValue;
var LogicLayer_doConnections;
var LogicLayer_resolvePortID;
...
LogicLayer_resolvePortID = function LogicLayer_resolvePortID(instDesc, portName) {
  if (typeof portName === "number") {
    return portName;
  }

  if ((0, _LogicInterface.isDynamicPortName)(portName)) {
    return portName;
  }
  ...
  for (var j = 0; j < ports.length; j++) {
    if ((0, _LogicInterface.makePortDataName)(ports[j]) === portName) {
      return ports[j].id;
    }
  }
...
LogicLayer.prototype.resolveTargetAndPortID = function (targetRef, portName) {
  ...
  if (tgt.obj.entityRef !== undefined && (0, _LogicInterface.isDynamicPortName)(portName)) {
    ...
    for (var n in logicLayer2._logicInterfaces) {
      ...
      if (l.obj.type === 'LogicNodeInput' && l.obj.dummyInport !== null && (0, _LogicInterface.makePortDataName)(l.obj.dummyInport)) {
        return {
          target: l,
          portID: portName
        };
  ...
  var directAttempt = LogicLayer_resolvePortID(tgt, portName);
...
LogicLayer.prototype.addConnectionByName = function (instDesc, sourcePort, targetName, targetPort) {
  ...
  // resolve from name
  var sourcePortID = LogicLayer_resolvePortID(instDesc, sourcePort);
 ...
 */
LogicLayer_doConnections = function LogicLayer_doConnections(instDesc, portID, func) {
  if (instDesc.outConnections === undefined) {
    return;
  }
 ...
 */
exports.writeValue = LogicLayer_writeValue = function LogicLayer_writeValue(instDesc, outPortID, value) {
  //
  LogicLayer_doConnections(instDesc, outPortID, function (targetDesc, portID) {
    // write
 ...
 */
exports.writeValueToLayerOutput = LogicLayer_writeValueToLayerOutput = function LogicLayer_writeValueToLayerOutput(outNodeDesc, outPortDesc, value) {
  // TODO: Cache writeFn
 ...
 */
exports.readPort = LogicLayer_readPort = function LogicLayer_readPort(instDesc, portID) {
 ...
 */
exports.fireEvent = LogicLayer_fireEvent = function LogicLayer_fireEvent(instDesc, outPortID) {
  LogicLayer_doConnections(instDesc, outPortID, function (targetDesc, portID) {
    targetDesc.obj.onEvent(targetDesc, portID);
  });
};;

exports.resolveEntityRef = LogicLayer_resolveEntityRef = function LogicLayer_resolveEntityRef(instDesc, entityRef) {
  if (entityRef === "[self]") {
...
exports.writeValue = LogicLayer_writeValue;
exports.writeValueToLayerOutput = LogicLayer_writeValueToLayerOutput;
exports.readPort = LogicLayer_readPort;
exports.fireEvent = LogicLayer_fireEvent;
exports.resolveEntityRef = LogicLayer_resolveEntityRef;
 ...
 * @private
 */
exports.LogicLayer = exported_LogicLayer;
