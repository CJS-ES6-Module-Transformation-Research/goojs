...
LogicNodeVec3Add.prototype.onInputChanged = function (instDesc) {
	var vec1 = _LogicLayer.LogicLayer.readPort(instDesc, LogicNodeVec3Add_inportX);
	var vec2 = _LogicLayer.LogicLayer.readPort(instDesc, LogicNodeVec3Add_inportY);

	var vec = new _Vector.Vector3();
	vec.copy(vec1).add(vec2);

	_LogicLayer.LogicLayer.writeValue(this.logicInstance, LogicNodeVec3Add_outportSum, vec);
};
...
_LogicNodes.LogicNodes.registerType('LogicNodeVec3Add', LogicNodeVec3Add);
