...
LogicNodeSine.prototype.onInputChanged = function (instDesc, portID, value) {
	_LogicLayer.LogicLayer.writeValue(this.logicInstance, LogicNodeSine_outportSin, Math.sin(value));
	_LogicLayer.LogicLayer.writeValue(this.logicInstance, LogicNodeSine_outportCos, Math.cos(value));
};
