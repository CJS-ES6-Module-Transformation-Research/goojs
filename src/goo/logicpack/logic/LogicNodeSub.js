...
LogicNodeSub.prototype.onInputChanged = function (instDesc /*, portID, value */) {
	var out = (0, _LogicLayer.readPort)(instDesc, LogicNodeSub_inportX) - (0, _LogicLayer.readPort)(instDesc, LogicNodeSub_inportY);

	(0, _LogicLayer.writeValue)(this.logicInstance, LogicNodeSub_outportSum, out);
};
...
(0, _LogicNodes.registerType)('LogicNodeSub', LogicNodeSub);
