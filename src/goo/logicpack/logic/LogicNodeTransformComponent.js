...
LogicNodeTransformComponent.prototype.onInputChanged = function (instDesc, portID, value) {
	...
	LogicLayerjs_writeValue(this.logicInstance, LogicNodeTransformComponent_outportPos, entity.transformComponent.transform.translation.clone());
	LogicLayerjs_writeValue(this.logicInstance, LogicNodeTransformComponent_outportRot, entity.transformComponent.transform.rotation.clone());
};
