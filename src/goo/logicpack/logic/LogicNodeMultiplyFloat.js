...
LogicNodeMultiplyFloat.prototype.onInputChanged = function (instDesc) {
	var x = _LogicLayer.LogicLayer.readPort(instDesc, LogicNodeMultiplyFloat_inportX);
	var y = this.value;
	_LogicLayer.LogicLayer.writeValue(instDesc, LogicNodeMultiplyFloat_outportProduct, x * y);
};
