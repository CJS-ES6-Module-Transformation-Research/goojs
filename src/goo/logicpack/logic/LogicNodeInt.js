...
LogicNodeInt.prototype.onConnected = function (instDesc) {
	(0, _LogicLayer.writeValue)(instDesc, LogicNodeInt_outportInt, this.value);
};
...
LogicNodeInt.prototype.onEvent = function (instDesc, evt) {
	...
	(0, _LogicLayer.writeValue)(this.logicInstance, LogicNodeInt_outportInt, this.value);
};
...
(0, _LogicNodes.registerType)('LogicNodeInt', LogicNodeInt);
