...
LogicNodeMultiply.prototype.onInputChanged = function (instDesc) {
	var x = (0, _LogicLayer.readPort)(instDesc, LogicNodeMultiply_inportX);
	var y = (0, _LogicLayer.readPort)(instDesc, LogicNodeMultiply_inportY);
	(0, _LogicLayer.writeValue)(instDesc, LogicNodeMultiply_outportProduct, x * y);
};
...
(0, _LogicNodes.registerType)('LogicNodeMultiply', LogicNodeMultiply);
