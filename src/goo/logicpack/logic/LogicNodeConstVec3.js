var LogicNodeConstVec3_LogicNodeConstVec3 = LogicNodeConstVec3;
...
LogicNodeConstVec3.prototype.onConfigure = function (newConfig) {
	if (newConfig.value !== undefined) {
		...
		LogicLayerjs_writeValue(this.logicInstance, LogicNodeConstVec3.outportVec, new mathVector3_Vector3js(this.x, this.y, this.z));
	}
};
 ...
 * @private
 */
export { LogicNodeConstVec3_LogicNodeConstVec3 as LogicNodeConstVec3 };