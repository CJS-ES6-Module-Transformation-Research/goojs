var mod_LogicNodeVec3 = LogicNodeVec3;
...
LogicNodeVec3.prototype = Object.create(LogicNode_LogicNode.prototype);
LogicNodeVec3.editorName = 'Vec3';

LogicNodeVec3.prototype.onInputChanged = function (instDesc) {
	var x = LogicLayer_LogicLayer.readPort(instDesc, LogicNodeVec3.inportX);
	var y = LogicLayer_LogicLayer.readPort(instDesc, LogicNodeVec3.inportY);
	var z = LogicLayer_LogicLayer.readPort(instDesc, LogicNodeVec3.inportZ);
	var xyz = LogicLayer_LogicLayer.readPort(instDesc, LogicNodeVec3.inportVec3);
	if (xyz !== null) {
		x = xyz.x;
		y = xyz.y;
		z = xyz.z;
	...
	LogicLayer_LogicLayer.writeValue(this.logicInstance, LogicNodeVec3.outportVec3, new Vector3_Vector3(x, y, z));
	LogicLayer_LogicLayer.writeValue(this.logicInstance, LogicNodeVec3.outportX, x);
	LogicLayer_LogicLayer.writeValue(this.logicInstance, LogicNodeVec3.outportY, y);
	LogicLayer_LogicLayer.writeValue(this.logicInstance, LogicNodeVec3.outportZ, z);
};

LogicNodeVec3.logicInterface = new LogicInterface_LogicInterface();
...
LogicNodes_LogicNodes.registerType('LogicNodeVec3', LogicNodeVec3);

/**
 * Logic node that provides a Vec3.
 * @private
 */
export { mod_LogicNodeVec3 as LogicNodeVec3 };