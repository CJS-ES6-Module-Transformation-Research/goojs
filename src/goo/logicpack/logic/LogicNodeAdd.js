...
LogicNodeAdd.prototype.onInputChanged = function (instDesc) {
	var out = _LogicLayer.LogicLayer.readPort(instDesc, LogicNodeAdd_inportX) + _LogicLayer.LogicLayer.readPort(instDesc, LogicNodeAdd_inportY);

	_LogicLayer.LogicLayer.writeValue(this.logicInstance, LogicNodeAdd_outportSum, out);
};
