...
LogicNodeAdd.prototype.onInputChanged = function (instDesc) {
	var out = LogicLayer_LogicLayerjs.readPort(instDesc, LogicNodeAdd_inportX) +
		LogicLayer_LogicLayerjs.readPort(instDesc, LogicNodeAdd_inportY);

	LogicLayer_LogicLayerjs.writeValue(this.logicInstance, LogicNodeAdd_outportSum, out);
};
