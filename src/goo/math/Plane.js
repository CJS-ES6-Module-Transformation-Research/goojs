...
function Plane(normal, constant) {
  this.normal = normal ? normal.clone() : Vector3js_UNIT_Y.clone();
...
Plane.XZ = new Plane(Vector3js_UNIT_Y, 0);
Plane.XY = new Plane(Vector3js_UNIT_Z, 0);
Plane.YZ = new Plane(Vector3js_UNIT_X, 0);
