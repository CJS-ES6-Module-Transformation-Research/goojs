...
function Plane(normal, constant) {
  this.normal = normal ? normal.clone() : _Vector2.default.UNIT_Y.clone();
...
Plane.XZ = new Plane(_Vector2.default.UNIT_Y, 0);
Plane.XY = new Plane(_Vector2.default.UNIT_Z, 0);
Plane.YZ = new Plane(_Vector2.default.UNIT_X, 0);
...
Plane.prototype.setPlanePoints = function (pointA, pointB, pointC) {
  ...
  this.normal.cross(new _Vector2.default(pointC.x - pointA.x, pointC.y - pointA.y, pointC.z - pointA.z)).normalize();
...
Plane.prototype.reflectVector = function (unitVector, store) {
  ...
  result.set(unitVector).sub(new _Vector2.default(this.normal.x * dotProd, this.normal.y * dotProd, this.normal.z * dotProd));
  return result;
};

var p0 = new _Vector2.default();
