...
Vector4.prototype.equals = function (rhs) {
	return Math.abs(this.x - rhs.x) <= _MathUtils.EPSILON && Math.abs(this.y - rhs.y) <= _MathUtils.EPSILON && Math.abs(this.z - rhs.z) <= _MathUtils.EPSILON && Math.abs(this.w - rhs.w) <= _MathUtils.EPSILON;
};
...
Vector4.prototype.equalsDirect = function (x, y, z, w) {
	return Math.abs(this.x - x) <= _MathUtils.EPSILON && Math.abs(this.y - y) <= _MathUtils.EPSILON && Math.abs(this.z - z) <= _MathUtils.EPSILON && Math.abs(this.w - w) <= _MathUtils.EPSILON;
};
