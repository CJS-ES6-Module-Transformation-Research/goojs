...
// @ifdef DEBUG
Vectorjs.setupAliases(Vector4.prototype, [['x'], ['y'], ['z'], ['w']]);
Vectorjs.setupIndices(Vector4.prototype, 4);
// @endif

Vectorjs.setupAliases(Vector4.prototype, [['r'], ['g'], ['b'], ['a']]);
...
// @ifdef DEBUG
Vectorjs.addReturnChecks(Vector4.prototype, [
	'dot', 'dotDirect',
