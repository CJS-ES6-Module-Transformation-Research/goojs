 ...
 */
function Matrix4() {
	_Matrix2.default.call(this, 4, 4);
...
Matrix4.prototype = Object.create(_Matrix2.default.prototype);
Matrix4.prototype.constructor = Matrix4;

_Matrix2.default.setupAliases(Matrix4.prototype, [['e00'], ['e10'], ['e20'], ['e30'], ['e01'], ['e11'], ['e21'], ['e31'], ['e02'], ['e12'], ['e22'], ['e32'], ['e03'], ['e13'], ['e23'], ['e33']]);
...
Matrix4.prototype.isOrthogonal = function () {
	...
	if (Math.abs(dot) > _MathUtils2.default.EPSILON) {
		return false;
	}
...
Matrix4.prototype.isNormal = function () {
	...
	if (Math.abs(l - 1.0) > _MathUtils2.default.EPSILON) {
		return false;
	}
...
Matrix4.prototype.equals = function (rhs, epsilon) {
	var thisData = this.data;
	var rhsData = rhs.data;
	var eps = epsilon === undefined ? _MathUtils2.default.EPSILON : epsilon;
 ...
 * @deprecated
 */
Matrix4.add = _ObjectUtils2.default.warnOnce('Matrix4.add is deprecated, use Matrix4.prototype.add instead', function (lhs, rhs, target) {
	if (!target) {
		target = new Matrix4();
	}
 ...
 * @deprecated
 */
Matrix4.sub = _ObjectUtils2.default.warnOnce('Matrix4.sub is deprecated', function (lhs, rhs, target) {
	if (!target) {
		target = new Matrix4();
	}
 ...
 * @deprecated
 */
Matrix4.mul = _ObjectUtils2.default.warnOnce('Matrix4.mul is deprecated, use Matrix4.prototype.mul instead', function (lhs, rhs, target) {
	if (!target) {
		target = new Matrix4();
	}
 ...
 * @deprecated
 */
Matrix4.div = _ObjectUtils2.default.warnOnce('Matrix4.div is deprecated', function (lhs, rhs, target) {
	if (!target) {
		target = new Matrix4();
	}
 ...
 * @deprecated
 */
Matrix4.prototype.div = _ObjectUtils2.default.warnOnce('Matrix4.prototype.div is deprecated', function (rhs) {
 ...
 * @deprecated
 */
Matrix4.combine = _ObjectUtils2.default.warnOnce('Matrix4.combine is deprecated, use Matrix4.prototype.mul instead', function (lhs, rhs, target) {
	if (!target) {
		target = new Matrix4();
	}
 ...
 * @deprecated
 */
Matrix4.prototype.combine = _ObjectUtils2.default.warnOnce('Matrix4.prototype.combine is deprecated, use Matrix4.prototype.mul instead', function (rhs) {
 ...
 * @deprecated
 */
Matrix4.transpose = _ObjectUtils2.default.warnOnce('Matrix4.transpose is deprecated, use Matrix4.prototype.transpose instead', function (source, target) {
	if (!target) {
		target = new Matrix4();
	}
 ...
 * @deprecated
 */
Matrix4.prototype.applyPre = _ObjectUtils2.default.warnOnce('Matrix4.prototype.applyPre is deprecated, use Vector4.prototype.applyPre instead', function (rhs) {
	var x = rhs.x;
	var y = rhs.y;
	var z = rhs.z;
	var w = rhs.w;
 ...
 * @deprecated
 */
Matrix4.prototype.applyPost = _ObjectUtils2.default.warnOnce('Matrix4.prototype.applyPost is deprecated, use Vector4.prototype.applyPost instead', function (rhs) {
	var x = rhs.x;
	var y = rhs.y;
	var z = rhs.z;
	var w = rhs.w;
 ...
 * @deprecated
 */
Matrix4.prototype.applyPostPoint = _ObjectUtils2.default.warnOnce('Matrix4.prototype.applyPostPoint is deprecated, use Vector4.prototype.applyPostPoint instead', function (rhs) {
 ...
 * @deprecated
 */
Matrix4.prototype.applyPostVector = _ObjectUtils2.default.warnOnce('Matrix4.prototype.applyPostVector is deprecated, use Vector4.prototype.applyPostVector instead', function (rhs) {
	var x = rhs.x;
	var y = rhs.y;
	var z = rhs.z;
...
// @ifdef DEBUG
_Matrix2.default.addPostChecks(Matrix4.prototype, ['add', 'sub', 'scale', 'transpose', 'invert', 'isOrthogonal', 'determinant', 'copy']);
