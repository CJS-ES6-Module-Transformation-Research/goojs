 ...
 * @deprecated
 */
Matrix4.add = ObjectUtils.warnOnce('Matrix4.add is deprecated, use Matrix4.prototype.add instead', function (lhs, rhs, target) {
	if (!target) {
		target = new Matrix4();
	}
 ...
 * @deprecated
 */
Matrix4.sub = ObjectUtils.warnOnce('Matrix4.sub is deprecated', function (lhs, rhs, target) {
	if (!target) {
		target = new Matrix4();
	}
 ...
 * @deprecated
 */
Matrix4.mul = ObjectUtils.warnOnce('Matrix4.mul is deprecated, use Matrix4.prototype.mul instead', function (lhs, rhs, target) {
	if (!target) {
		target = new Matrix4();
	}
 ...
 * @deprecated
 */
Matrix4.div = ObjectUtils.warnOnce('Matrix4.div is deprecated', function (lhs, rhs, target) {
	if (!target) {
		target = new Matrix4();
	}
 ...
 * @deprecated
 */
Matrix4.prototype.div = ObjectUtils.warnOnce('Matrix4.prototype.div is deprecated', function (rhs) {
 ...
 * @deprecated
 */
Matrix4.combine = ObjectUtils.warnOnce('Matrix4.combine is deprecated, use Matrix4.prototype.mul instead', function (lhs, rhs, target) {
	if (!target) {
		target = new Matrix4();
	}
 ...
 * @deprecated
 */
Matrix4.prototype.combine = ObjectUtils.warnOnce('Matrix4.prototype.combine is deprecated, use Matrix4.prototype.mul instead', function (rhs) {
 ...
 * @deprecated
 */
Matrix4.transpose = ObjectUtils.warnOnce('Matrix4.transpose is deprecated, use Matrix4.prototype.transpose instead', function (source, target) {
	if (!target) {
		target = new Matrix4();
	}
 ...
 * @deprecated
 */
Matrix4.prototype.applyPre = ObjectUtils.warnOnce('Matrix4.prototype.applyPre is deprecated, use Vector4.prototype.applyPre instead', function (rhs) {
	var x = rhs.x;
	var y = rhs.y;
	var z = rhs.z;
	var w = rhs.w;
 ...
 * @deprecated
 */
Matrix4.prototype.applyPost = ObjectUtils.warnOnce('Matrix4.prototype.applyPost is deprecated, use Vector4.prototype.applyPost instead', function (rhs) {
	var x = rhs.x;
	var y = rhs.y;
	var z = rhs.z;
	var w = rhs.w;
 ...
 * @deprecated
 */
Matrix4.prototype.applyPostPoint = ObjectUtils.warnOnce('Matrix4.prototype.applyPostPoint is deprecated, use Vector4.prototype.applyPostPoint instead', function (rhs) {
 ...
 * @deprecated
 */
Matrix4.prototype.applyPostVector = ObjectUtils.warnOnce('Matrix4.prototype.applyPostVector is deprecated, use Vector4.prototype.applyPostVector instead', function (rhs) {
	var x = rhs.x;
	var y = rhs.y;
	var z = rhs.z;
