...
Quaternion.prototype.toAngleAxis = function (axisStore) {
	...
	var angle;
	if (Math.abs(sqrLength) <= MathUtils_MathUtilsjs.EPSILON) { // length is ~0
		angle = 0.0;
		if (axisStore !== null) {
			axisStore.x = 1.0;
			axisStore.y = 0.0;
...
Object.defineProperty(Quaternion.prototype, 'data', {
	get: ObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Quaternion.add = ObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Quaternion.div = ObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Quaternion.mul = Quaternion.mul2 = ObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Quaternion.sub = ObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Quaternion.prototype.add = ObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Quaternion.prototype.div = ObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Quaternion.prototype.magnitude = ObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Quaternion.prototype.magnitudeSquared = ObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Quaternion.scalarAdd = ObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Quaternion.scalarDiv = ObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Quaternion.scalarMul = ObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Quaternion.scalarSub = ObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Quaternion.prototype.setVector = ObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Quaternion.prototype.sub = ObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Quaternion.prototype.scalarAdd = ObjectUtils_ObjectUtilsjs.warnOnce(
	'Quaternion.prototype.scalarAdd is deprecated.',
	function (rhs) {
 ...
 * @deprecated
 */
Quaternion.prototype.scalarSub = ObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Quaternion.prototype.scalarMul = ObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Quaternion.prototype.scalarDiv = ObjectUtils_ObjectUtilsjs.warnOnce(
