...
Object.defineProperty(Quaternion.prototype, 'data', {
	get: (0, _ObjectUtils.warnOnce)('The .data property of Quaternion was removed. Please use the .x, .y, .z and .w properties instead.', function () {
		var data = [];
		var that = this;
 ...
 * @deprecated
 */
Quaternion.add = (0, _ObjectUtils.warnOnce)('Quaternion.add is deprecated.', function (lhs, rhs, target) {
	if (!target) {
 ...
 * @deprecated
 */
Quaternion.div = (0, _ObjectUtils.warnOnce)('Quaternion.div is deprecated', function (lhs, rhs, target) {
	if (!target) {
		target = new Quaternion();
	}
 ...
 * @deprecated
 */
Quaternion.mul = Quaternion.mul2 = (0, _ObjectUtils.warnOnce)('Quaternion.mul is deprecated.', function (a, b, out) {
	var ax = a.x,
	    ay = a.y,
	    az = a.z,
	    aw = a.w,
 ...
 * @deprecated
 */
Quaternion.sub = (0, _ObjectUtils.warnOnce)('Quaternion.sub is deprecated.', function (lhs, rhs, target) {
	if (!target) {
		target = new Quaternion();
	}
 ...
 * @deprecated
 */
Quaternion.prototype.add = (0, _ObjectUtils.warnOnce)('Quaternion.prototype.add is deprecated.', function (rhs) {
 ...
 * @deprecated
 */
Quaternion.prototype.div = (0, _ObjectUtils.warnOnce)('Quaternion.prototype.div is deprecated.', function (rhs) {
 ...
 * @deprecated
 */
Quaternion.prototype.magnitude = (0, _ObjectUtils.warnOnce)('Quaternion.prototype.magnitude is deprecated.', function () {
 ...
 * @deprecated
 */
Quaternion.prototype.magnitudeSquared = (0, _ObjectUtils.warnOnce)('Quaternion.prototype.magnitudeSquared is deprecated.', function () {
 ...
 * @deprecated
 */
Quaternion.scalarAdd = (0, _ObjectUtils.warnOnce)('Quaternion.prototype.scalarAdd is deprecated.', function (lhs, rhs, target) {
	if (!target) {
		target = new Quaternion();
	}
 ...
 * @deprecated
 */
Quaternion.scalarDiv = (0, _ObjectUtils.warnOnce)('Quaternion.scalarDiv is deprecated.', function (lhs, rhs, target) {
	if (!target) {
		target = new Quaternion();
	}
 ...
 * @deprecated
 */
Quaternion.scalarMul = (0, _ObjectUtils.warnOnce)('Quaternion.scalarMul is deprecated.', function (lhs, rhs, target) {
	if (!target) {
		target = new Quaternion();
	}
 ...
 * @deprecated
 */
Quaternion.scalarSub = (0, _ObjectUtils.warnOnce)('Quaternion.scalarSub is deprecated.', function (lhs, rhs, target) {
	if (!target) {
		target = new Quaternion();
	}
 ...
 * @deprecated
 */
Quaternion.prototype.setVector = (0, _ObjectUtils.warnOnce)('Quaternion.prototype.setVector is deprecated.', function (quat) {
	this.x = quat.x;
	this.y = quat.y;
	this.z = quat.z;
	this.w = quat.w;
 ...
 * @deprecated
 */
Quaternion.prototype.sub = (0, _ObjectUtils.warnOnce)('Quaternion.prototype.sub is deprecated.', function (rhs) {
 ...
 * @deprecated
 */
Quaternion.prototype.scalarAdd = (0, _ObjectUtils.warnOnce)('Quaternion.prototype.scalarAdd is deprecated.', function (rhs) {
 ...
 * @deprecated
 */
Quaternion.prototype.scalarSub = (0, _ObjectUtils.warnOnce)('Quaternion.prototype.scalarSub is deprecated.', function (rhs) {
 ...
 * @deprecated
 */
Quaternion.prototype.scalarMul = (0, _ObjectUtils.warnOnce)('Quaternion.prototype.scalarMul is deprecated.', function (rhs) {
 ...
 * @deprecated
 */
Quaternion.prototype.scalarDiv = (0, _ObjectUtils.warnOnce)('Quaternion.prototype.scalarDiv is deprecated.', function (rhs) {
