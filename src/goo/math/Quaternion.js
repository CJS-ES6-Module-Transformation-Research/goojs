...
// @ifdef DEBUG
Vectorjs_setupAliases(Quaternion.prototype, [['x'], ['y'], ['z'], ['w']]);
// @endif
...
// @ifdef DEBUG
Vectorjs_addReturnChecks(Quaternion.prototype, ['dot', 'dotDirect', 'length', 'lengthSquared', 'distance', 'distanceSquared']);
// @endif
