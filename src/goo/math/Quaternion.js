...
Quaternion.prototype.toAngleAxis = function (axisStore) {
	...
	var angle;
	if (Math.abs(sqrLength) <= MathUtils.EPSILON) {
		// length is ~0
		angle = 0.0;
		if (axisStore !== null) {
			axisStore.x = 1.0;
...
Object.defineProperty(Quaternion.prototype, 'data', {
	get: ObjectUtils.warnOnce('The .data property of Quaternion was removed. Please use the .x, .y, .z and .w properties instead.', function () {
		var data = [];
		var that = this;
 ...
 * @deprecated
 */
Quaternion.add = ObjectUtils.warnOnce('Quaternion.add is deprecated.', function (lhs, rhs, target) {
	if (!target) {
 ...
 * @deprecated
 */
Quaternion.div = ObjectUtils.warnOnce('Quaternion.div is deprecated', function (lhs, rhs, target) {
	if (!target) {
		target = new Quaternion();
	}
 ...
 * @deprecated
 */
Quaternion.mul = Quaternion.mul2 = ObjectUtils.warnOnce('Quaternion.mul is deprecated.', function (a, b, out) {
	var ax = a.x,
	    ay = a.y,
	    az = a.z,
	    aw = a.w,
 ...
 * @deprecated
 */
Quaternion.sub = ObjectUtils.warnOnce('Quaternion.sub is deprecated.', function (lhs, rhs, target) {
	if (!target) {
		target = new Quaternion();
	}
 ...
 * @deprecated
 */
Quaternion.prototype.add = ObjectUtils.warnOnce('Quaternion.prototype.add is deprecated.', function (rhs) {
 ...
 * @deprecated
 */
Quaternion.prototype.div = ObjectUtils.warnOnce('Quaternion.prototype.div is deprecated.', function (rhs) {
 ...
 * @deprecated
 */
Quaternion.prototype.magnitude = ObjectUtils.warnOnce('Quaternion.prototype.magnitude is deprecated.', function () {
 ...
 * @deprecated
 */
Quaternion.prototype.magnitudeSquared = ObjectUtils.warnOnce('Quaternion.prototype.magnitudeSquared is deprecated.', function () {
 ...
 * @deprecated
 */
Quaternion.scalarAdd = ObjectUtils.warnOnce('Quaternion.prototype.scalarAdd is deprecated.', function (lhs, rhs, target) {
	if (!target) {
		target = new Quaternion();
	}
 ...
 * @deprecated
 */
Quaternion.scalarDiv = ObjectUtils.warnOnce('Quaternion.scalarDiv is deprecated.', function (lhs, rhs, target) {
	if (!target) {
		target = new Quaternion();
	}
 ...
 * @deprecated
 */
Quaternion.scalarMul = ObjectUtils.warnOnce('Quaternion.scalarMul is deprecated.', function (lhs, rhs, target) {
	if (!target) {
		target = new Quaternion();
	}
 ...
 * @deprecated
 */
Quaternion.scalarSub = ObjectUtils.warnOnce('Quaternion.scalarSub is deprecated.', function (lhs, rhs, target) {
	if (!target) {
		target = new Quaternion();
	}
 ...
 * @deprecated
 */
Quaternion.prototype.setVector = ObjectUtils.warnOnce('Quaternion.prototype.setVector is deprecated.', function (quat) {
	this.x = quat.x;
	this.y = quat.y;
	this.z = quat.z;
	this.w = quat.w;
 ...
 * @deprecated
 */
Quaternion.prototype.sub = ObjectUtils.warnOnce('Quaternion.prototype.sub is deprecated.', function (rhs) {
 ...
 * @deprecated
 */
Quaternion.prototype.scalarAdd = ObjectUtils.warnOnce('Quaternion.prototype.scalarAdd is deprecated.', function (rhs) {
 ...
 * @deprecated
 */
Quaternion.prototype.scalarSub = ObjectUtils.warnOnce('Quaternion.prototype.scalarSub is deprecated.', function (rhs) {
 ...
 * @deprecated
 */
Quaternion.prototype.scalarMul = ObjectUtils.warnOnce('Quaternion.prototype.scalarMul is deprecated.', function (rhs) {
 ...
 * @deprecated
 */
Quaternion.prototype.scalarDiv = ObjectUtils.warnOnce('Quaternion.prototype.scalarDiv is deprecated.', function (rhs) {
