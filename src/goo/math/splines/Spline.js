var Spline_Spline = Spline;
import { Vector2 as Vector2_Vector2js } from "../Vector2";
...
(function () {
	...
	var term0_v4 = new Vector4_Vector4js();
	var term1_v4 = new Vector4_Vector4js();
	var term2_v4 = new Vector4_Vector4js();

	var term0_v3 = new Vector3_Vector3js();
	var term1_v3 = new Vector3_Vector3js();
	var term2_v3 = new Vector3_Vector3js();

	var term0_v2 = new Vector2_Vector2js();
	var term1_v2 = new Vector2_Vector2js();
	var term2_v2 = new Vector2_Vector2js();
	...
	Spline.quadraticInterpolation = function (p0, p1, p2, t, store) {
		...
		if (store instanceof Vector4_Vector4js) {
			p0.copyTo(term0_v4);
			term0_v4.scale(it2);
		...
		} else if (store instanceof Vector3_Vector3js) {
			p0.copyTo(term0_v3);
			term0_v3.scale(it2);
		...
		} else if (store instanceof Vector2_Vector2js) {
			p0.copyTo(term0_v2);
			term0_v2.scale(it2);
...
(function () {
	...
	var term1_v4 = new Vector4_Vector4js();
	var term2_v4 = new Vector4_Vector4js();
	var term3_v4 = new Vector4_Vector4js();

	var term0_v3 = new Vector3_Vector3js();
	var term1_v3 = new Vector3_Vector3js();
	var term2_v3 = new Vector3_Vector3js();
	var term3_v3 = new Vector3_Vector3js();

	var term0_v2 = new Vector2_Vector2js();
	var term1_v2 = new Vector2_Vector2js();
	var term2_v2 = new Vector2_Vector2js();
	var term3_v2 = new Vector2_Vector2js();
 ...
 */
export { Spline_Spline as Spline };
