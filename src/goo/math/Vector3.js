...
Object.defineProperty(Vector3.prototype, 'data', {
	get: ObjectUtilsjs.warnOnce('The .data property of Vector3 was removed. Please use the .x, .y and .z properties instead.', function () {
		var data = [];
		var that = this;
 ...
 * @deprecated
 */
Vector3.prototype.setVector = ObjectUtilsjs.warnOnce('The setVector method of Vector3 is deprecated. Please use the set method instead.', function (rhs) {
	return this.set(rhs);
});
 ...
 * @deprecated
 */
Vector3.add = ObjectUtilsjs.warnOnce('Vector3.add is deprecated. Use Vector3.prototype.add instead.', function (lhs, rhs, target) {
 ...
 * @deprecated
 */
Vector3.cross = ObjectUtilsjs.warnOnce('Vector3.cross is deprecated. Use Vector3.prototype.cross instead.', function (lhs, rhs, target) {
	if (!target) {
		target = new Vector3();
	}
 ...
 * @deprecated
 */
Vector3.distance = ObjectUtilsjs.warnOnce('Vector3.distance is deprecated. Use Vector3.prototype.distance instead.', function (lhs, rhs) {
 ...
 * @deprecated
 */
Vector3.distanceSquared = ObjectUtilsjs.warnOnce('Vector3.distanceSquared is deprecated. Use Vector3.prototype.distanceSquared instead.', function (lhs, rhs) {
	var x = lhs.x - rhs.x,
		y = lhs.y - rhs.y,
		z = lhs.z - rhs.z;
	return x * x + y * y + z * z;
 ...
 * @deprecated
 */
Vector3.div = ObjectUtilsjs.warnOnce('Vector3.div is deprecated. Use Vector3.prototype.div instead.', function (lhs, rhs, target) {
	if (!target) {
		target = new Vector3();
	}
 ...
 * @deprecated
 */
Vector3.dot = ObjectUtilsjs.warnOnce('Vector3.dot is deprecated. Use Vector3.prototype.dot instead.', function (lhs, rhs) {
	if (typeof lhs === 'number') {
		lhs = [lhs, lhs, lhs];
	}
 ...
 * @deprecated
 */
Vector3.mul = ObjectUtilsjs.warnOnce('Vector3.mul is deprecated. Use Vector3.prototype.mul instead.', function (lhs, rhs, target) {
	if (!target) {
		target = new Vector3();
	}
 ...
 * @deprecated
 */
Vector3.prototype.addVector = ObjectUtilsjs.warnOnce('Vector3.prototype.addVector is deprecated. Use Vector3.prototype.add instead.', function (vector) {
	this.x += vector.x;
	this.y += vector.y;
	this.z += vector.z;
 ...
 * @deprecated
 */
Vector3.prototype.mulVector = ObjectUtilsjs.warnOnce('Vector3.prototype.mulVector is deprecated. Use .mul instead.', function (vec3) {
	this.x *= vec3.x;
	this.y *= vec3.y;
	this.z *= vec3.z;
 ...
 * @deprecated
 */
Vector3.prototype.dotVector = ObjectUtilsjs.warnOnce('Vector3.prototype.dotVector is deprecated. Use .dot instead.', function (rhs) {
	var ldata = this.data;
	var rdata = rhs.data;
 ...
 * @deprecated
 */
Vector3.prototype.invert = ObjectUtilsjs.warnOnce('Vector3.prototype.invert is deprecated. Use .negate instead.', function () {
	this.x = 0.0 - this.x;
	this.y = 0.0 - this.y;
	this.z = 0.0 - this.z;
 ...
 * @deprecated
 */
Vector3.prototype.subVector = ObjectUtilsjs.warnOnce('Vector3.prototype.subVector is deprecated. Use .sub instead.', function (vector) {
	this.x -= vector.x;
	this.y -= vector.y;
	this.z -= vector.z;
 ...
 * @deprecated
 */
Vector3.sub = ObjectUtilsjs.warnOnce('Vector3.sub is deprecated. Use Vector3.prototype.sub instead.', function (lhs, rhs, target) {
	if (typeof lhs === 'number') {
		lhs = [lhs, lhs, lhs];
	}
