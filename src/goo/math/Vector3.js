...
// @ifdef DEBUG
Vectorjs_setupAliases(Vector3.prototype, [['x'], ['y'], ['z']]);
Vectorjs_setupIndices(Vector3.prototype, 3);
// @endif

Vectorjs_setupAliases(Vector3.prototype, [['u', 'r'], ['v', 'g'], ['w', 'b']]);
...
// @ifdef DEBUG
Vectorjs_addReturnChecks(Vector3.prototype, [
	'dot', 'dotDirect',
