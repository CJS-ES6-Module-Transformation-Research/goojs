...
Vector3.prototype = Object.create(Vectorjs.prototype);
Vector3.prototype.constructor = Vector3;

// @ifdef DEBUG
Vectorjs.setupAliases(Vector3.prototype, [['x'], ['y'], ['z']]);
Vectorjs.setupIndices(Vector3.prototype, 3);
// @endif

Vectorjs.setupAliases(Vector3.prototype, [['u', 'r'], ['v', 'g'], ['w', 'b']]);
...
Vector3.prototype.add = function (rhs) {
	if (rhs instanceof Vector3) {
		...
		this.y += rhs.y;
		this.z += rhs.z;
	} else if (rhs instanceof Vector4js) {
...
Vector3.prototype.set = function (rhs) {
	if (rhs instanceof Vector3 || rhs instanceof Vector4js) {
		this.x = rhs.x;
		this.y = rhs.y;
		this.z = rhs.z;
	} else {
...
Object.defineProperty(Vector3.prototype, 'data', {
	get: ObjectUtilsjs_warnOnce('The .data property of Vector3 was removed. Please use the .x, .y and .z properties instead.', function () {
		var data = [];
		var that = this;
 ...
 * @deprecated
 */
Vector3.prototype.setVector = ObjectUtilsjs_warnOnce('The setVector method of Vector3 is deprecated. Please use the set method instead.', function (rhs) {
	return this.set(rhs);
});
 ...
 * @deprecated
 */
Vector3.add = ObjectUtilsjs_warnOnce('Vector3.add is deprecated. Use Vector3.prototype.add instead.', function (lhs, rhs, target) {
 ...
 * @deprecated
 */
Vector3.cross = ObjectUtilsjs_warnOnce('Vector3.cross is deprecated. Use Vector3.prototype.cross instead.', function (lhs, rhs, target) {
	if (!target) {
		target = new Vector3();
	}
 ...
 * @deprecated
 */
Vector3.distance = ObjectUtilsjs_warnOnce('Vector3.distance is deprecated. Use Vector3.prototype.distance instead.', function (lhs, rhs) {
 ...
 * @deprecated
 */
Vector3.distanceSquared = ObjectUtilsjs_warnOnce('Vector3.distanceSquared is deprecated. Use Vector3.prototype.distanceSquared instead.', function (lhs, rhs) {
	var x = lhs.x - rhs.x,
		y = lhs.y - rhs.y,
		z = lhs.z - rhs.z;
	return x * x + y * y + z * z;
 ...
 * @deprecated
 */
Vector3.div = ObjectUtilsjs_warnOnce('Vector3.div is deprecated. Use Vector3.prototype.div instead.', function (lhs, rhs, target) {
	if (!target) {
		target = new Vector3();
	}
 ...
 * @deprecated
 */
Vector3.dot = ObjectUtilsjs_warnOnce('Vector3.dot is deprecated. Use Vector3.prototype.dot instead.', function (lhs, rhs) {
	if (typeof lhs === 'number') {
		lhs = [lhs, lhs, lhs];
	}
 ...
 * @deprecated
 */
Vector3.mul = ObjectUtilsjs_warnOnce('Vector3.mul is deprecated. Use Vector3.prototype.mul instead.', function (lhs, rhs, target) {
	if (!target) {
		target = new Vector3();
	}
 ...
 * @deprecated
 */
Vector3.prototype.addVector = ObjectUtilsjs_warnOnce('Vector3.prototype.addVector is deprecated. Use Vector3.prototype.add instead.', function (vector) {
	this.x += vector.x;
	this.y += vector.y;
	this.z += vector.z;
 ...
 * @deprecated
 */
Vector3.prototype.mulVector = ObjectUtilsjs_warnOnce('Vector3.prototype.mulVector is deprecated. Use .mul instead.', function (vec3) {
	this.x *= vec3.x;
	this.y *= vec3.y;
	this.z *= vec3.z;
 ...
 * @deprecated
 */
Vector3.prototype.dotVector = ObjectUtilsjs_warnOnce('Vector3.prototype.dotVector is deprecated. Use .dot instead.', function (rhs) {
	var ldata = this.data;
	var rdata = rhs.data;
 ...
 * @deprecated
 */
Vector3.prototype.invert = ObjectUtilsjs_warnOnce('Vector3.prototype.invert is deprecated. Use .negate instead.', function () {
	this.x = 0.0 - this.x;
	this.y = 0.0 - this.y;
	this.z = 0.0 - this.z;
 ...
 * @deprecated
 */
Vector3.prototype.subVector = ObjectUtilsjs_warnOnce('Vector3.prototype.subVector is deprecated. Use .sub instead.', function (vector) {
	this.x -= vector.x;
	this.y -= vector.y;
	this.z -= vector.z;
 ...
 * @deprecated
 */
Vector3.sub = ObjectUtilsjs_warnOnce('Vector3.sub is deprecated. Use Vector3.prototype.sub instead.', function (lhs, rhs, target) {
	if (typeof lhs === 'number') {
		lhs = [lhs, lhs, lhs];
	}
...
// @ifdef DEBUG
Vectorjs.addReturnChecks(Vector3.prototype, [
	'dot', 'dotDirect',
