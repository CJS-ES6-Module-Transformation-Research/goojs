...
Matrix3._tempX = new Vector3_Vector3js();
Matrix3._tempY = new Vector3_Vector3js();
Matrix3._tempZ = new Vector3_Vector3js();

Matrix3.prototype = Object.create(Matrix_Matrixjs.prototype);
Matrix3.prototype.constructor = Matrix3;

Matrix_Matrixjs.setupAliases(Matrix3.prototype, [['e00'], ['e10'], ['e20'], ['e01'], ['e11'], ['e21'], ['e02'], ['e12'], ['e22']]);
...
Matrix3.invert = function (source, target) {
	...
	if (Math.abs(det) < MathUtilsjs_EPSILON) {
		return target;
	}
...
Matrix3.prototype.isOrthogonal = function () {
	...
	if (Math.abs(dot) > MathUtilsjs_EPSILON) {
		return false;
	}
...
Matrix3.prototype.isNormal = function () {
	...
	if (Math.abs(l - 1.0) > MathUtilsjs_EPSILON) {
		return false;
	}
...
Matrix3.prototype.toAngles = function (store) {
	...
	var d = this.data;
	if (d[3] > 1 - MathUtilsjs_EPSILON) { // singularity at north pole
		result.y = Math.atan2(d[2], d[8]);
		result.z = Math.PI / 2;
		result.x = 0;
	} else if (d[3] < -1 + MathUtilsjs_EPSILON) { // singularity at south pole
		result.y = Math.atan2(d[2], d[8]);
		result.z = -Math.PI / 2;
		result.x = 0;
	} else {
...
Matrix3.prototype.lookAt = function (direction, up) {
	...
	if (x.equals(Vector3_Vector3js.ZERO)) {
		if (z.x !== 0.0) {
...
Matrix3.prototype.equals = function (rhs) {
	...
	return (Math.abs(thisData[0] - rhsData[0]) <= MathUtilsjs_EPSILON) &&
		(Math.abs(thisData[1] - rhsData[1]) <= MathUtilsjs_EPSILON) &&
		(Math.abs(thisData[2] - rhsData[2]) <= MathUtilsjs_EPSILON) &&
		(Math.abs(thisData[3] - rhsData[3]) <= MathUtilsjs_EPSILON) &&
		(Math.abs(thisData[4] - rhsData[4]) <= MathUtilsjs_EPSILON) &&
		(Math.abs(thisData[5] - rhsData[5]) <= MathUtilsjs_EPSILON) &&
		(Math.abs(thisData[6] - rhsData[6]) <= MathUtilsjs_EPSILON) &&
		(Math.abs(thisData[7] - rhsData[7]) <= MathUtilsjs_EPSILON) &&
		(Math.abs(thisData[8] - rhsData[8]) <= MathUtilsjs_EPSILON);
};
 ...
 * @deprecated
 */
Matrix3.add = utilObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Matrix3.sub = utilObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Matrix3.mul = utilObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Matrix3.div = utilObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Matrix3.prototype.div = utilObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Matrix3.combine = utilObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Matrix3.prototype.combine = utilObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Matrix3.transpose = utilObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Matrix3.prototype.applyPost = utilObjectUtils_ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Matrix3.prototype.applyPre = utilObjectUtils_ObjectUtilsjs.warnOnce(
...
// @ifdef DEBUG
Matrix_Matrixjs.addPostChecks(Matrix3.prototype, [
 ...
 */
export { Matrix3_Matrix3 as Matrix3 };
