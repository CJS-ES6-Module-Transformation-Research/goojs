...
Matrix3.prototype.equals = function (rhs) {
	...
	return Math.abs(thisData[0] - rhsData[0]) <= MathUtils.EPSILON && Math.abs(thisData[1] - rhsData[1]) <= MathUtils.EPSILON && Math.abs(thisData[2] - rhsData[2]) <= MathUtils.EPSILON && Math.abs(thisData[3] - rhsData[3]) <= MathUtils.EPSILON && Math.abs(thisData[4] - rhsData[4]) <= MathUtils.EPSILON && Math.abs(thisData[5] - rhsData[5]) <= MathUtils.EPSILON && Math.abs(thisData[6] - rhsData[6]) <= MathUtils.EPSILON && Math.abs(thisData[7] - rhsData[7]) <= MathUtils.EPSILON && Math.abs(thisData[8] - rhsData[8]) <= MathUtils.EPSILON;
};
 ...
 * @deprecated
 */
Matrix3.add = ObjectUtils.warnOnce('Matrix3.add is deprecated - use Matrix3.prototype.add instead.', function (lhs, rhs, target) {
	if (!target) {
		target = new Matrix3();
	}
 ...
 * @deprecated
 */
Matrix3.sub = ObjectUtils.warnOnce('Matrix3.sub is deprecated - use Matrix3.prototype.sub instead.', function (lhs, rhs, target) {
	if (!target) {
		target = new Matrix3();
	}
 ...
 * @deprecated
 */
Matrix3.mul = ObjectUtils.warnOnce('Matrix3.mul is deprecated - use Matrix3.prototype.mul instead.', function (lhs, rhs, target) {
	if (!target) {
		target = new Matrix3();
	}
 ...
 * @deprecated
 */
Matrix3.div = ObjectUtils.warnOnce('Matrix3.div is deprecated - use Matrix3.prototype.div instead.', function (lhs, rhs, target) {
	if (!target) {
		target = new Matrix3();
	}
 ...
 * @deprecated
 */
Matrix3.prototype.div = ObjectUtils.warnOnce('Matrix3.prototype.div is deprecated.', function (rhs) {
 ...
 * @deprecated
 */
Matrix3.combine = ObjectUtils.warnOnce('Matrix3.combine is deprecated - use Matrix3.prototype.mul or .mul2 instead.', function (lhs, rhs, target) {
	if (!target) {
		target = new Matrix3();
	}
 ...
 * @deprecated
 */
Matrix3.prototype.combine = ObjectUtils.warnOnce('Matrix3.prototype.combine is deprecated - use Matrix3.prototype.mul or .mul2 instead.', function (rhs) {
 ...
 * @deprecated
 */
Matrix3.transpose = ObjectUtils.warnOnce('Matrix3.transpose is deprecated - use Matrix3.prototype.transpose instead.', function (source, target) {
	if (!target) {
		target = new Matrix3();
	}
 ...
 * @deprecated
 */
Matrix3.prototype.applyPost = ObjectUtils.warnOnce('Matrix3.prototype.applyPost is deprecated - use Vector3.prototype.applyPost instead.', function (rhs) {
 ...
 * @deprecated
 */
Matrix3.prototype.applyPre = ObjectUtils.warnOnce('Matrix3.prototype.applyPre is deprecated - use Vector3.prototype.applyPre instead.', function (rhs) {
	var source = this.data;
