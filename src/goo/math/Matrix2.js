...
Matrixjs.setupAliases(Matrix2.prototype, [['e00'], ['e10'], ['e01'], ['e11']]);
...
// @ifdef DEBUG
Matrixjs.addPostChecks(Matrix2.prototype, [
 ...
 * @deprecated
 */
Matrix2.add = ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Matrix2.combine = ObjectUtilsjs.warnOnce(
	...
	function (lhs, rhs, target) {
		...
		if (target === lhs || target === rhs) {
			return Matrixjs.copy(Matrix2.combine(lhs, rhs), target);
		}
 ...
 * @deprecated
 */
Matrix2.div = ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Matrix2.mul = ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Matrix2.transpose = ObjectUtilsjs.warnOnce(
	...
	function (source, target) {
		...
		if (target === source) {
			return Matrixjs.copy(Matrix2.transpose(source), target);
		}
 ...
 * @deprecated
 */
Matrix2.sub = ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Matrix2.prototype.combine = ObjectUtilsjs.warnOnce(
 ...
 * @deprecated
 */
Matrix2.prototype.div = ObjectUtilsjs.warnOnce(
