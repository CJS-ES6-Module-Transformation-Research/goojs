...
Matrix2.prototype = Object.create(Matrix_Matrix.prototype);
Matrix2.prototype.constructor = Matrix2;

Matrix_Matrix.setupAliases(Matrix2.prototype, [['e00'], ['e10'], ['e01'], ['e11']]);
...
// @ifdef DEBUG
Matrix_Matrix.addPostChecks(Matrix2.prototype, [
 ...
 * @deprecated
 */
Matrix2.add = ObjectUtils_ObjectUtils.warnOnce(
 ...
 * @deprecated
 */
Matrix2.combine = ObjectUtils_ObjectUtils.warnOnce(
	...
	function (lhs, rhs, target) {
		...
		if (target === lhs || target === rhs) {
			return Matrix_Matrix.copy(Matrix2.combine(lhs, rhs), target);
		}
 ...
 * @deprecated
 */
Matrix2.div = ObjectUtils_ObjectUtils.warnOnce(
 ...
 * @deprecated
 */
Matrix2.mul = ObjectUtils_ObjectUtils.warnOnce(
 ...
 * @deprecated
 */
Matrix2.transpose = ObjectUtils_ObjectUtils.warnOnce(
	...
	function (source, target) {
		...
		if (target === source) {
			return Matrix_Matrix.copy(Matrix2.transpose(source), target);
		}
 ...
 * @deprecated
 */
Matrix2.sub = ObjectUtils_ObjectUtils.warnOnce(
 ...
 * @deprecated
 */
Matrix2.prototype.combine = ObjectUtils_ObjectUtils.warnOnce(
 ...
 * @deprecated
 */
Matrix2.prototype.div = ObjectUtils_ObjectUtils.warnOnce(
