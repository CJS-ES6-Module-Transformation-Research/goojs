...
Matrix2.prototype.equals = function (rhs) {
	...
	return Math.abs(thisData[0] - rhsData[0]) <= _MathUtils.EPSILON && Math.abs(thisData[1] - rhsData[1]) <= _MathUtils.EPSILON && Math.abs(thisData[2] - rhsData[2]) <= _MathUtils.EPSILON && Math.abs(thisData[3] - rhsData[3]) <= _MathUtils.EPSILON;
};
