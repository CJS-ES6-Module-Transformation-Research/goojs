 ...
 * @deprecated
 */
Matrix2.add = _ObjectUtils.ObjectUtils.warnOnce('Matrix2.add is deprecated. Use Matrix2.prototype.add instead.', function (lhs, rhs, target) {
	if (!target) {
		target = new Matrix2();
	}
 ...
 * @deprecated
 */
Matrix2.combine = _ObjectUtils.ObjectUtils.warnOnce('Matrix2.combine is deprecated. Use Matrix2.prototype.multiply instead.', function (lhs, rhs, target) {
	if (!target) {
		target = new Matrix2();
	}
 ...
 * @deprecated
 */
Matrix2.div = _ObjectUtils.ObjectUtils.warnOnce('Matrix2.div is deprecated. Use Matrix2.prototype.div instead.', function (lhs, rhs, target) {
	if (!target) {
		target = new Matrix2();
	}
 ...
 * @deprecated
 */
Matrix2.mul = _ObjectUtils.ObjectUtils.warnOnce('Matrix2.mul is deprecated. Use Matrix2.prototype.mul instead.', function (lhs, rhs, target) {
	if (!target) {
		target = new Matrix2();
	}
 ...
 * @deprecated
 */
Matrix2.transpose = _ObjectUtils.ObjectUtils.warnOnce('Matrix2.transpose is deprecated. Use Matrix2.prototype.transpose instead.', function (source, target) {
	if (!target) {
		target = new Matrix2();
	}
 ...
 * @deprecated
 */
Matrix2.sub = _ObjectUtils.ObjectUtils.warnOnce('Matrix2.sub is deprecated. Use Matrix2.prototype.sub instead.', function (lhs, rhs, target) {
	if (!target) {
		target = new Matrix2();
	}
 ...
 * @deprecated
 */
Matrix2.prototype.combine = _ObjectUtils.ObjectUtils.warnOnce('Matrix2.prototype.combine is deprecated. Use Matrix2.prototype.mul or Matrix2.prototype.mul2 instead.', function (rhs) {
 ...
 * @deprecated
 */
Matrix2.prototype.div = _ObjectUtils.ObjectUtils.warnOnce('Matrix2.prototype.div is deprecated.', function (rhs) {
 ...
 */
exports.Matrix2 = Matrix2_Matrix2;