...
// @ifdef DEBUG
Vectorjs.setupAliases(Vector2.prototype, [['x'], ['y']]);
Vectorjs.setupIndices(Vector2.prototype, 2);
// @endif

Vectorjs.setupAliases(Vector2.prototype, [['u'], ['v']]);
...
// @ifdef DEBUG
Vectorjs.addReturnChecks(Vector2.prototype, [
	'dot', 'dotDirect',
...
Object.defineProperty(Vector2.prototype, 'data', {
	get: ObjectUtilsjs.warnOnce('The .data property of Vector2 was removed. Please use the .x and .y properties instead.', function () {
		var data = [];
		var that = this;
...
Vector2.prototype.setVector = ObjectUtilsjs.warnOnce('The setVector method of Vector2 was removed. Please use the set method instead.', function (rhs) {
	return this.set(rhs);
});
 ...
 * @deprecated
 */
Vector2.add = ObjectUtilsjs.warnOnce('Vector2.add is deprecated.', function (lhs, rhs, target) {
 ...
 * @deprecated
 */
Vector2.sub = ObjectUtilsjs.warnOnce('Vector2.sub is deprecated.', function (lhs, rhs, target) {
	if (typeof lhs === 'number') {
		lhs = [lhs, lhs];
	}
 ...
 * @deprecated
 */
Vector2.mul = ObjectUtilsjs.warnOnce('Vector2.mul is deprecated.', function (lhs, rhs, target) {
	if (typeof lhs === 'number') {
		lhs = [lhs, lhs];
	}
 ...
 * @deprecated
 */
Vector2.div = ObjectUtilsjs.warnOnce('Vector2.div is deprecated.', function (lhs, rhs, target) {
	if (typeof lhs === 'number') {
		lhs = [lhs, lhs];
	}
 ...
 * @deprecated
 */
Vector2.dot = ObjectUtilsjs.warnOnce('Vector2.dot is deprecated.', function (lhs, rhs) {
	if (typeof lhs === 'number') {
		lhs = [lhs, lhs];
	}
 ...
 * @deprecated
 */
Vector2.prototype.dotVector = ObjectUtilsjs.warnOnce('Vector2.prototype.dotVector is deprecated.', function (rhs) {
	var ldata = this.data;
	var rdata = rhs.data;
 ...
 * @deprecated
 */
Vector2.prototype.addVector = ObjectUtilsjs.warnOnce('Vector2.prototype.addVector is deprecated.', function (vector) {
 ...
 * @deprecated
 */
Vector2.prototype.mulVector = ObjectUtilsjs.warnOnce('Vector2.prototype.mulVector is deprecated.', function (vector) {
	this.data[0] *= vector.data[0];
	this.data[1] *= vector.data[1];
 ...
 * @deprecated
 */
Vector2.prototype.subVector = ObjectUtilsjs.warnOnce('Vector2.prototype.subVector is deprecated.', function (vector) {
	this.data[0] -= vector.data[0];
	this.data[1] -= vector.data[1];
