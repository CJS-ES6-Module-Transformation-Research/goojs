...
Object.defineProperty(Vector2.prototype, 'data', {
	get: ObjectUtils_ObjectUtilsjs.warnOnce('The .data property of Vector2 was removed. Please use the .x and .y properties instead.', function () {
		var data = [];
		var that = this;
...
Vector2.prototype.setVector = ObjectUtils_ObjectUtilsjs.warnOnce('The setVector method of Vector2 was removed. Please use the set method instead.', function (rhs) {
	return this.set(rhs);
});
 ...
 * @deprecated
 */
Vector2.add = ObjectUtils_ObjectUtilsjs.warnOnce('Vector2.add is deprecated.', function (lhs, rhs, target) {
 ...
 * @deprecated
 */
Vector2.sub = ObjectUtils_ObjectUtilsjs.warnOnce('Vector2.sub is deprecated.', function (lhs, rhs, target) {
	if (typeof lhs === 'number') {
		lhs = [lhs, lhs];
	}
 ...
 * @deprecated
 */
Vector2.mul = ObjectUtils_ObjectUtilsjs.warnOnce('Vector2.mul is deprecated.', function (lhs, rhs, target) {
	if (typeof lhs === 'number') {
		lhs = [lhs, lhs];
	}
 ...
 * @deprecated
 */
Vector2.div = ObjectUtils_ObjectUtilsjs.warnOnce('Vector2.div is deprecated.', function (lhs, rhs, target) {
	if (typeof lhs === 'number') {
		lhs = [lhs, lhs];
	}
 ...
 * @deprecated
 */
Vector2.dot = ObjectUtils_ObjectUtilsjs.warnOnce('Vector2.dot is deprecated.', function (lhs, rhs) {
	if (typeof lhs === 'number') {
		lhs = [lhs, lhs];
	}
 ...
 * @deprecated
 */
Vector2.prototype.dotVector = ObjectUtils_ObjectUtilsjs.warnOnce('Vector2.prototype.dotVector is deprecated.', function (rhs) {
	var ldata = this.data;
	var rdata = rhs.data;
 ...
 * @deprecated
 */
Vector2.prototype.addVector = ObjectUtils_ObjectUtilsjs.warnOnce('Vector2.prototype.addVector is deprecated.', function (vector) {
 ...
 * @deprecated
 */
Vector2.prototype.mulVector = ObjectUtils_ObjectUtilsjs.warnOnce('Vector2.prototype.mulVector is deprecated.', function (vector) {
	this.data[0] *= vector.data[0];
	this.data[1] *= vector.data[1];
 ...
 * @deprecated
 */
Vector2.prototype.subVector = ObjectUtils_ObjectUtilsjs.warnOnce('Vector2.prototype.subVector is deprecated.', function (vector) {
	this.data[0] -= vector.data[0];
	this.data[1] -= vector.data[1];
