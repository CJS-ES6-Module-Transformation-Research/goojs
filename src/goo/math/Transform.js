...
function Transform() {
	 ...
	 * @type {Matrix4}
	 */
	this.matrix = new Matrix4js();
	this.normalMatrix = new Matrix3js();

	/** @type {Vector3} */
	this.translation = new Vector3js();
	/** @type {Matrix3} */
	this.rotation = new Matrix3js();
	/** @type {Vector3} */
	this.scale = new Vector3js(1, 1, 1);
