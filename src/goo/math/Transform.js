...
Transform.prototype.setIdentity = function () {
	...
	this.translation.set(Vector3js.ZERO);
	this.rotation.setIdentity();
	this.scale.set(Vector3js.ONE);
...
Transform.prototype.lookAt = function (position, up) {
	...
	if (tmpVec.lengthSquared() > MathUtilsjs.EPSILON) { // should be epsilon^2 but it hopefully doesn't matter
		tmpVec.normalize();
...
Transform.prototype.invert = function (store) {
	...
	result.scale.set(Vector3js.ONE).div(this.scale);
