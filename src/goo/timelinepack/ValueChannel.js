...
ValueChannel.prototype.update = function (time) {
	...
	if (time <= this.keyframes[0].time) {
		...
		newValue = (0, _MathUtils.lerp)(progressValue, newEntry.value, nextEntry.value);
	}
...
ValueChannel.getRotationTweener = function (angleIndex, entityId, resolver, rotation) {
	...
	var func = function func(time, value) {
		...
		if (entity) {
			...
			rotation[angleIndex] = value * _MathUtils.DEG_TO_RAD;
...
exports.ValueChannel = mod_ValueChannel;