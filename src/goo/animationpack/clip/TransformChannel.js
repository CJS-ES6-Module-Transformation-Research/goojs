...
var tmpQuat2 = new Quaternion_Quaternionjs();

TransformChannel.prototype = Object.create(AbstractAnimationChannel_AbstractAnimationChanneljs.prototype);
...
TransformChannel.prototype.createStateDataObject = function () {
	return new TransformData_TransformDatajs();
};
...
TransformChannel.prototype.setCurrentSample = function (sampleIndex, fraction, applyTo) {
	...
	if (!transformData._rotation.equals(tmpQuat)) {
		Quaternion_Quaternionjs.slerp(transformData._rotation, tmpQuat, fraction, tmpQuat2);
...
TransformChannel.prototype.getData = function (index, store) {
	var rVal = store ? store : new TransformData_TransformDatajs();
	this.setCurrentSample(index, 0.0, rVal);
	return rVal;
};

var exported_TransformChannel = TransformChannel;
