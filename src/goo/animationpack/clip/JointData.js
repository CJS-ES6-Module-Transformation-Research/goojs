...
function JointData(source) {
	TransformDatajs.call(this, source);
	this._jointIndex = source ? source._jointIndex : 0;
}

JointData.prototype = Object.create(TransformDatajs.prototype);
...
JointData.prototype.set = function (jointData) {
	TransformDatajs.prototype.set.call(this, jointData);
...
JointData.prototype.blend = function (blendTo, blendWeight, store) {
	...
	return TransformDatajs.prototype.blend.call(this, blendTo, blendWeight, rVal);
};
