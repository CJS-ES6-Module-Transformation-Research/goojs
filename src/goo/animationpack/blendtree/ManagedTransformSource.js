var ManagedTransformSource_ManagedTransformSource = ManagedTransformSource;
...
ManagedTransformSource.prototype = Object.create(animationpackblendtreeSource_Sourcejs.prototype);
...
ManagedTransformSource.prototype.setTranslation = function (channelName, translation) {
	...
	if (channel instanceof animationpackclipTransformData_TransformDatajs) {
...
ManagedTransformSource.prototype.getTranslation = function (channelName, store) {
	var channel = this._data[channelName];
	if (channel instanceof animationpackclipTransformData_TransformDatajs) {
		store = store || new mathVector3_Vector3js();
...
ManagedTransformSource.prototype.getRotation = function (channelName, store) {
	var channel = this._data[channelName];
	if (channel instanceof animationpackclipTransformData_TransformDatajs) {
		store = store || new mathQuaternion_Quaternionjs();
 ...
 * @extends Source
 */
export { ManagedTransformSource_ManagedTransformSource as ManagedTransformSource };