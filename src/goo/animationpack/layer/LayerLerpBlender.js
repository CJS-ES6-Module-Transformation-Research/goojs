var mod_LayerLerpBlender = LayerLerpBlender;
...
LayerLerpBlender.prototype.getBlendedSourceData = function () {
	...
	return BinaryLerpSource_BinaryLerpSource.combineSourceData(sourceAData, sourceBData, this._blendWeight);
};

/**
 * A layer blender that uses linear interpolation to merge the results of two layers.
 */
export { mod_LayerLerpBlender as LayerLerpBlender };