...
AbstractTransitionState.prototype = Object.create(AbstractStatejs.prototype);
...
AbstractTransitionState.prototype.update = function (globalTime) {
	...
	switch (this._blendType) {
		case AbstractTransitionState.BLENDTYPES.CUBIC:
			this._percent = MathUtilsjs.scurve3(percent);
			break;
		case AbstractTransitionState.BLENDTYPES.QUINTIC:
			this._percent = MathUtilsjs.scurve5(percent);
			break;
		default:
...
AbstractTransitionState.prototype.getCurrentSourceData = function () {
	...
	return BinaryLerpSourcejs.combineSourceData(sourceAData, sourceBData, this._percent, this._sourceData);
};
...
AbstractTransitionState.prototype.resetClips = function (globalTime) {
	AbstractStatejs.prototype.resetClips.call(this, globalTime);
	//this._sourceData = {};
	this._percent = 0.0;
};
