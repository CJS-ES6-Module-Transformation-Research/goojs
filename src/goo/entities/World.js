...
import {
    Component as Component_Componentjs,
    applyEntitySelectionAPI as Componentjs_applyEntitySelectionAPI,
...
Object.defineProperties(World, {
	time: {
		get: ObjectUtilsjs_warnOnce('World.time is deprecated, use world.time instead.', function () {
	...
	tpf: {
		get: ObjectUtilsjs_warnOnce('World.tpf is deprecated, use world.tpf instead.', function () {
...
World.prototype.registerComponent = function (componentConstructor) {
	if (this._components.indexOf(componentConstructor) === -1) {
		...
		Componentjs_applyEntitySelectionAPI(componentConstructor.entitySelectionAPI, componentConstructor.type);
	}
	return this;
};
