...
Object.defineProperties(World, {
	time: {
		get: (0, _ObjectUtils.warnOnce)('World.time is deprecated, use world.time instead.', function () {
	...
	tpf: {
		get: (0, _ObjectUtils.warnOnce)('World.tpf is deprecated, use world.tpf instead.', function () {
...
World.prototype.registerComponent = function (componentConstructor) {
	if (this._components.indexOf(componentConstructor) === -1) {
		...
		(0, _Component.applyEntitySelectionAPI)(componentConstructor.entitySelectionAPI, componentConstructor.type);
	}
	return this;
};
