...
function TransformComponent() {
  ...
  * @type {Transform}
  */
	this.worldTransform = new _Transform2.default();
...
TransformComponent.prototype = Object.create(_Component2.default.prototype);
...
TransformComponent.prototype.api = {
  ...
  */
	children: function children() {
		return new _EntitySelection2.default(this).children();
	},
  ...
  */
	parent: function parent() {
		return new _EntitySelection2.default(this).parent();
	},
...
TransformComponent.prototype.setTranslation = function () {
	this.transform.translation.set(_Vector2.default.fromAny.apply(null, arguments));
	this.setUpdated();
	return this;
};
...
TransformComponent.prototype.addTranslation = function () {
	this.transform.translation.add(_Vector2.default.fromAny.apply(null, arguments));
	this.setUpdated();
	return this;
};
...
TransformComponent.prototype.setScale = function () {
	this.transform.scale.set(_Vector2.default.fromAny.apply(null, arguments));
	this.setUpdated();
	return this;
};
...
TransformComponent.prototype.getRotation = function (target) {
	target = target || new _Vector2.default();
...
TransformComponent.prototype.addRotation = function () {
	...
	if (arguments.length === 1 && _typeof(arguments[0]) === 'object') {
		...
		if (arg0 instanceof _Vector2.default) {
...
TransformComponent.prototype.lookAt = function (position, up) {
	if (arguments.length === 3) {
		this.transform.lookAt(new _Vector2.default(arguments[0], arguments[1], arguments[2]));
		...
		if (Array.isArray(position)) {
			position = _Vector2.default.fromArray(position);
		}
		if (Array.isArray(up)) {
			up = _Vector2.default.fromArray(up);
		}
...
TransformComponent.prototype.move = function () {
	var moveWorldDirection = new _Vector2.default();
	return function () {
		var moveLocalDirection = _Vector2.default.fromAny.apply(null, arguments);
...
TransformComponent.applyOnEntity = function (obj, entity) {
	...
	if (Array.isArray(obj) && obj.length === 3) {
		...
		matched = true;
	} else if (obj instanceof _Vector2.default) {
		...
		transformComponent.transform.translation.setDirect(obj.x, obj.y, obj.z);
		matched = true;
	} else if (obj instanceof _Transform2.default) {
