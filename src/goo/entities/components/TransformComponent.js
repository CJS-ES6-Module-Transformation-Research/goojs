...
TransformComponent.prototype.setTranslation = function () {
	this.transform.translation.set(Vector3js_fromAny.apply(null, arguments));
	this.setUpdated();
	return this;
};
...
TransformComponent.prototype.addTranslation = function () {
	this.transform.translation.add(Vector3js_fromAny.apply(null, arguments));
	this.setUpdated();
	return this;
};
...
TransformComponent.prototype.setScale = function () {
	this.transform.scale.set(Vector3js_fromAny.apply(null, arguments));
	this.setUpdated();
	return this;
};
...
TransformComponent.prototype.lookAt = function (position, up) {
	if (arguments.length === 3) {
		...
		if (Array.isArray(position)) {
			position = Vector3js_fromArray(position);
		}
		if (Array.isArray(up)) {
			up = Vector3js_fromArray(up);
		}
...
TransformComponent.prototype.move = (function () {
	...
	return function () {
		var moveLocalDirection = Vector3js_fromAny.apply(null, arguments);
