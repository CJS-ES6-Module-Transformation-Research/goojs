...
ScriptComponent.prototype.setup = function (entity) {
	...
	_ObjectUtils.ObjectUtils.extend(componentContext, {
		entity: entity,
		entityData: {}
	});
...
ScriptComponent.prototype._handleError = function (script, error, phase) {
	...
	_SystemBus.SystemBusjs.emit('goo.scriptError', err);
};
 ...
 * @extends Component
 */
exports.ScriptComponent = ScriptComponent_ScriptComponent;