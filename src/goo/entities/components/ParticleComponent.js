...
ParticleComponent.prototype.generateMeshData = function () {
	var attributeMap = MeshDatajs_defaultMap([MeshDatajs_POSITION, MeshDatajs_COLOR, MeshDatajs_TEXCOORD0]);
	...
	var uvBuffer = this.meshData.getAttributeBuffer(MeshDatajs_TEXCOORD0);
