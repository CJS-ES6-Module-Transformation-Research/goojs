import { Manager as Manager_Managerjs } from "../../entities/managers/Manager";
...
function EntityManager() {
	...
	EntityManager_api = {
        id: function() {
            ...
            return new EntitySelection_EntitySelectionjs(ret);
        }.bind(this),
...
EntityManager.prototype = Object.create(Manager_Managerjs.prototype);
