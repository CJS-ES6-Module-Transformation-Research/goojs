...
import { Grid as Grid_Gridjs } from "../../shapes/Grid";
function GridRenderSystem() {
	System_Systemjs.call(this, 'GridRenderSystem', []);
	...
	this.camera = null;
	this.lights = [];
	this.transform1 = new Transform_Transformjs();
	...
	this.transform2 = new Transform_Transformjs();
	...
	var col = 0.2;
	var gridMaterial1 = new Material_Materialjs(gridShaderDef, 'Grid Material');
	...
	var gridMaterial2 = new Material_Materialjs(gridShaderDef, 'Grid Material');
	...
	var gridMesh = new Grid_Gridjs(this.count, this.count);
	this.grid1 = {
		meshData: gridMesh,
...
GridRenderSystem.prototype = Object.create(System_Systemjs.prototype);
...
var gridShaderDef = {
	...
	uniforms: {
		...
		fogNear: Shader_Shaderjs.NEAR_PLANE,
		fogFar: Shader_Shaderjs.FAR_PLANE,
		opacity: 1,
		scale: 1
	},
	vshader: [
