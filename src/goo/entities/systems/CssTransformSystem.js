...
function CssTransformSystem(renderer) {
	Systemjs.call(this, 'CssTransformSystem', ['TransformComponent', 'CssTransformComponent']);
...
CssTransformSystem.prototype = Object.create(Systemjs.prototype);
...
CssTransformSystem.prototype.process = function (entities) {
	...
	var fov = 0.5 / Math.tan(MathUtilsjs.DEG_TO_RAD * camera.fov * 0.5) * this.renderer.domElement.offsetHeight;
