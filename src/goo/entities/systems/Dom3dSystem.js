...
function Dom3dSystem(renderer) {
	Systemjs.call(this, 'Dom3dSystem', ['TransformComponent', 'Dom3dComponent']);
	...
	var frontMaterial = new Materialjs(ShaderLibjs.simple);
	...
	var backMaterial = new Materialjs(ShaderLibjs.uber);
...
Dom3dSystem.prototype = Object.create(Systemjs.prototype);
...
Dom3dSystem.prototype.cleanup = function () {
	Systemjs.prototype.cleanup.apply(this, arguments);
