...
function Dom3dSystem(renderer) {
	...
	var frontMaterial = new rendererMaterial_Materialjs(ShaderLibjs_simple);
	...
	var backMaterial = new rendererMaterial_Materialjs(ShaderLibjs_uber);
 ...
 */
export { Dom3dSystem_Dom3dSystem as Dom3dSystem };
