...
import { GlobalTranslationGizmo as GlobalTranslationGizmo_GlobalTranslationGizmojs } from "../../util/gizmopack/GlobalTranslationGizmo";
import { RotationGizmo as RotationGizmo_RotationGizmojs } from "../../util/gizmopack/RotationGizmo";
import { GlobalRotationGizmo as GlobalRotationGizmo_GlobalRotationGizmojs } from "../../util/gizmopack/GlobalRotationGizmo";
import { ScaleGizmo as ScaleGizmo_ScaleGizmojs } from "../../util/gizmopack/ScaleGizmo";
function GizmoRenderSystem(callbacks) {
	...
	this.gizmos = [
		new TranslationGizmo_TranslationGizmojs(),
		new GlobalTranslationGizmo_GlobalTranslationGizmojs(),
		new RotationGizmo_RotationGizmojs(),
		new GlobalRotationGizmo_GlobalRotationGizmojs(),
		new ScaleGizmo_ScaleGizmojs()
	];
	...
	this.pickingMaterial = Material_Materialjs.createEmptyMaterial(customPickingShader, 'pickingMaterial');
	...
	this._mouseState = new Vector2_Vector2js();
	this._oldMouseState = new Vector2_Vector2js();
...
GizmoRenderSystem.prototype.activate = function (id, x, y) {
	this.active = true;
	var handle = Gizmo_Gizmojs.getHandle(id);
...
GizmoRenderSystem.prototype.setupCallbacks = function (callbacks) {
	...
	var inverseRotation = new Matrix3_Matrix3js();
	var inverseTransformation = new Matrix4_Matrix4js();
