...
var functionObject_createQuad = function(options, oldMeshData) {
    var width = 1, height = 1, tileX = 1, tileY = 1;
...
var functionObject_createBox = function(options, oldMeshData) {
    options = options || {};
    ObjectUtil.defaults(options, {
        textureMode: "Uniform"
    });
...
var functionObject_createSphere = function(options, oldMeshData) {
    options = options || {};
    ObjectUtil.defaults(options, {
        zSamples: 8,
        radialSamples: 8,
...
var functionObject_createCylinder = function(options, oldMeshData) {
    options = options || {};
    ObjectUtil.defaults(options, {
        radialSamples: 8,
        radius: 1
...
var functionObject_createTorus = function(options, oldMeshData) {
    options = options || {};
    ObjectUtil.defaults(options, {
        radialSamples: 8,
        circleSamples: 12,
...
var functionObject_createDisk = function(options, oldMeshData) {
    options = options || {};
    ObjectUtil.defaults(options, {
        radialSamples: 8,
        pointiness: 0,
...
var functionObject_createCone = function(options, oldMeshData) {
    options = options || {};
    ObjectUtil.defaults(options, {
        radialSamples: 8,
        height: 0,
...
var functionObject_clearCache = function(context) {
    if (context) {
        _cacheMap.forEach(function(value) {
            value.destroy(context);
        });
...
export { functionObject_clearCache as clearCache };