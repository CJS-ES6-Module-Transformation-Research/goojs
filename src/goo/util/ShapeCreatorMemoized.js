...
exports.ShapeCreatorMemoized = exports.clearCache = undefined;
...
ShapeCreatorMemoized_createQuad = function ShapeCreatorMemoized_createQuad(options, oldMeshData) {
    var width = 1,
        height = 1,
        tileX = 1,
        tileY = 1;
...
ShapeCreatorMemoized_createBox = function ShapeCreatorMemoized_createBox(options, oldMeshData) {
    options = options || {};
...
ShapeCreatorMemoized_createSphere = function ShapeCreatorMemoized_createSphere(options, oldMeshData) {
    options = options || {};
    _ObjectUtil.ObjectUtils.defaults(options, {
        zSamples: 8,
        radialSamples: 8,
...
ShapeCreatorMemoized_createCylinder = function ShapeCreatorMemoized_createCylinder(options, oldMeshData) {
    options = options || {};
    _ObjectUtil.ObjectUtils.defaults(options, {
        radialSamples: 8,
        radius: 1
...
ShapeCreatorMemoized_createTorus = function ShapeCreatorMemoized_createTorus(options, oldMeshData) {
    options = options || {};
    _ObjectUtil.ObjectUtils.defaults(options, {
        radialSamples: 8,
        circleSamples: 12,
...
ShapeCreatorMemoized_createDisk = function ShapeCreatorMemoized_createDisk(options, oldMeshData) {
    options = options || {};
    _ObjectUtil.ObjectUtils.defaults(options, {
        radialSamples: 8,
        pointiness: 0,
...
ShapeCreatorMemoized_createCone = function ShapeCreatorMemoized_createCone(options, oldMeshData) {
    options = options || {};
    _ObjectUtil.ObjectUtils.defaults(options, {
        radialSamples: 8,
        height: 0,
...
exports.clearCache = ShapeCreatorMemoized_clearCache = function ShapeCreatorMemoized_clearCache(context) {
    if (context) {
...
exports.clearCache = ShapeCreatorMemoized_clearCache;
exports.ShapeCreatorMemoized = ShapeCreatorMemoized;
