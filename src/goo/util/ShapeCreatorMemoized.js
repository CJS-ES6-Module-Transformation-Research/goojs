...
functionObject_createQuad = function(options, oldMeshData) {
...
functionObject_createBox = function(options, oldMeshData) {
    options = options || {};
...
functionObject_createSphere = function(options, oldMeshData) {
    options = options || {};
    ObjectUtil.defaults(options, {
        zSamples: 8,
        radialSamples: 8,
...
functionObject_createCylinder = function(options, oldMeshData) {
    options = options || {};
    ObjectUtil.defaults(options, {
        radialSamples: 8,
        radius: 1
...
functionObject_createTorus = function(options, oldMeshData) {
    options = options || {};
    ObjectUtil.defaults(options, {
        radialSamples: 8,
        circleSamples: 12,
...
functionObject_createDisk = function(options, oldMeshData) {
    options = options || {};
    ObjectUtil.defaults(options, {
        radialSamples: 8,
        pointiness: 0,
...
functionObject_createCone = function(options, oldMeshData) {
    options = options || {};
    ObjectUtil.defaults(options, {
        radialSamples: 8,
        height: 0,
...
functionObject_clearCache = function(context) {
    if (context) {
