...
function Snow(gooRunner) {
	...
	this.particleCloudEntity = ParticleSystemUtilsjs_createParticleSystemEntity(
		...
		ParticleLibjs_getSnow({
			getEmissionPoint: function (vec3) {
				...
				// camera
				vec3.copy(Rendererjs_mainCamera ? Rendererjs_mainCamera.translation : new Vector3_Vector3());
	...
	this.particleCloudEntity.transformComponent.transform.translation.copy(Rendererjs_mainCamera ? Rendererjs_mainCamera.translation : new Vector3_Vector3());
