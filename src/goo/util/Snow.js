...
function Snow(gooRunner) {
	...
	this.particleCloudEntity = (0, _ParticleSystemUtils.createParticleSystemEntity)(gooRunner.world, (0, _ParticleLib.getSnow)({
		getEmissionPoint: function getEmissionPoint(vec3) {
			...
			// camera
			vec3.copy(_Renderer.mainCamera ? _Renderer.mainCamera.translation : new _Vector.Vector3());
	...
	this.particleCloudEntity.transformComponent.transform.translation.copy(_Renderer.mainCamera ? _Renderer.mainCamera.translation : new _Vector.Vector3());
