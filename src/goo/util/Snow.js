...
function Snow(gooRunner) {
	...
	this.material = new Materialjs(ShaderLibjs.particles);
	var texture = ParticleSystemUtilsjs.createFlareTexture(64); //Snowflake
	...
	// and this too
	this.particleCloudEntity = ParticleSystemUtilsjs.createParticleSystemEntity(
		gooRunner.world,
		ParticleLibjs.getSnow({
