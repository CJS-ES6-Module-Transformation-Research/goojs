...
function Snow(gooRunner) {
	...
	this.material = new rendererMaterial_Materialjs(ShaderLibjs_particles);
	...
	this.particleCloudEntity = ParticleSystemUtilsjs_createParticleSystemEntity(
		...
		ParticleLibjs_getSnow({
			getEmissionPoint: function (vec3) {
				...
				// camera
				vec3.copy(Rendererjs_mainCamera ? Rendererjs_mainCamera.translation : new mathVector3_Vector3js());
	...
	this.particleCloudEntity.transformComponent.transform.translation.copy(Rendererjs_mainCamera ? Rendererjs_mainCamera.translation : new mathVector3_Vector3js());
