...
functionObject_loadCanvasFromPath = function(canvasPath, callback) {
    var options = {};
...
functionObject_renderSvgToCanvas = function(svgSource, options, callback) {
    var url = "data:image/svg+xml;base64," + btoa(svgSource);

    functionObject_loadCanvasFromPath(url, options, callback);
};

functionObject_getMatrixFromCanvas = function(canvas) {
    var context = canvas.getContext("2d");
...
functionObject_svgDataToImage = function(data) {
