...
var functionObject_requestFullScreen = function() {
    if (!document.fullscreenElement && document.documentElement.requestFullScreen) {
        document.documentElement.requestFullScreen();
    }
};
...
var functionObject_exitFullScreen = function() {
    if (document.fullscreenElement && document.cancelFullScreen) {
        document.cancelFullScreen();
    }
};
...
var functionObject_toggleFullScreen = function() {
    if (!document.fullscreenElement) {
        if (document.documentElement.requestFullScreen) {
            document.documentElement.requestFullScreen();
        }
...
var functionObject_requestPointerLock = function(optionalTarget) {
    var target = optionalTarget || document.documentElement;
    if (target.requestPointerLock) {
        target.requestPointerLock();
    }
...
var functionObject_exitPointerLock = function() {
    if (document.exitPointerLock) {
        document.exitPointerLock();
    }
};
...
var functionObject_togglePointerLock = function(optionalTarget) {
    if (!document.pointerLockElement) {
...
var functionObject_addVisibilityChangeListener = function(callback) {
    if (typeof callback !== "function") {
        return;
    }
...
var functionObject_clearVisibilityChangeListeners = function() {
    visibilityChangeListeners.forEach(function(listener) {
        document.removeEventListener(listener.eventName, listener.eventListener);
    });
    visibilityChangeListeners = [];
...
var functionObject_initAllShims = function(global) {
...
var functionObject_initWebGLShims = function() {
    window.Uint8ClampedArray = window.Uint8ClampedArray || window.Uint8Array;
};
...
var functionObject_initAnimationShims = function() {
    var lastTime = 0;
    var vendors = ["ms", "moz", "webkit", "o"];
...
GameUtils.initFullscreenShims = function (global) {
	...
	if (!document.hasOwnProperty('fullscreenEnabled')) {
		var getter = (function () {
            ...
            var functionObject_fullscreen = false;
...
var functionObject_initFullscreenShims = function(global) {
    global = global || window;
    var elementPrototype = (global.HTMLElement || global.Element).prototype;
...
GameUtils.initPointerLockShims = function (global) {
	...
	if (!elementPrototype.requestPointerLock) {
		elementPrototype.requestPointerLock = (function () {
            ...
            var functionObject_pointerLock = false;
...
var functionObject_initPointerLockShims = function(global) {
    global = global || window;
    var elementPrototype = (global.HTMLElement || global.Element).prototype;
