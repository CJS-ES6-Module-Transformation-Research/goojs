...
var functionObject_createParticleSystemEntity = function(world, particleParameters, material) {
    // Create the particle cloud entity
    var particleSystemEntity = world.createEntity();
...
var functionObject_createFlareTexture = function(size, options) {
    size = size || 64;
...
var functionObject_createSplashTexture = function(size, options) {
    size = size || 64;
...
var functionObject_createPlanktonTexture = function(size, options) {
    size = size || 64;
...
var functionObject_createSnowflakeTexture = function(size, options) {
    size = size || 64;
