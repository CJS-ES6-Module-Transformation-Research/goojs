...
function DogPass(settings) {
	...
	this.convolutionShader1 = ObjectUtilsjs.deepClone(ShaderLibjs.convolution);
	this.convolutionShader2 = ObjectUtilsjs.deepClone(ShaderLibjs.convolution);

	this.differenceShader = ObjectUtilsjs.deepClone(ShaderLibExtrajs.differenceOfGaussians);
...
DogPass.prototype = Object.create(Passjs.prototype);
...
DogPass.prototype.render = function (renderer, writeBuffer, readBuffer) {
	...
	renderer.render(this.renderable, FullscreenUtilsjs.camera, [], this.renderTargetX, true);
	...
	renderer.render(this.renderable, FullscreenUtilsjs.camera, [], this.gaussian1, true);
	...
	renderer.render(this.renderable, FullscreenUtilsjs.camera, [], this.gaussian2, true);
	...
	if (this.target !== null) {
		renderer.render(this.renderable, FullscreenUtilsjs.camera, [], this.target, this.clear);
	} else {
