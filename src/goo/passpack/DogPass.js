...
function DogPass(settings) {
	...
	this.convolutionShader1 = utilObjectUtils_ObjectUtilsjs.deepClone(ShaderLibjs_convolution);
	this.convolutionShader2 = utilObjectUtils_ObjectUtilsjs.deepClone(ShaderLibjs_convolution);

	this.differenceShader = utilObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtrajs_differenceOfGaussians);
...
*/
export { DogPass_DogPass as DogPass };