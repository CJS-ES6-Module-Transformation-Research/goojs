...
import {
    methods as ShaderFragmentjs_methods,
    blendmodes as ShaderFragmentjs_blendmodes,
} from "../renderer/shaders/ShaderFragment";
...
ShaderLibExtra_showDepth = {
    ...
    uniforms: {
        ...
        far: rendererShader_Shaderjs.FAR_PLANE
    },
...
ShaderLibExtra_bokehShader = {
    ...
    uniforms: {
        ...
        projectionMatrix: rendererShader_Shaderjs.PROJECTION_MATRIX,
        worldMatrix: rendererShader_Shaderjs.WORLD_MATRIX,
        tColor: rendererShader_Shaderjs.DIFFUSE_MAP,
        tDepth: rendererShader_Shaderjs.DEPTH_MAP,
        focus: 1.0,
        aspect: 1.0,
        aperture: 0.025,
        maxblur: 1.0
...
ShaderLibExtra_film = {
    attributes: ShaderLibjs_copy.attributes,
    ...
    vshader: ShaderLibjs_copy.vshader,
...
ShaderLibExtra_noise = {
    ...
    uniforms: {
        ...
        time: function() {
            return entitiesWorld_Worldjs.time;
        },
...
ShaderLibExtra_ssao = {
    ...
    uniforms: {
        ...
        tDepth: rendererShader_Shaderjs.DEPTH_MAP,
        size: [512, 512],
        cameraNear: rendererShader_Shaderjs.MAIN_NEAR_PLANE,
        cameraFar: rendererShader_Shaderjs.MAIN_FAR_PLANE,
        fogNear: rendererShader_Shaderjs.MAIN_NEAR_PLANE,
        fogFar: rendererShader_Shaderjs.MAIN_FAR_PLANE,
        fogEnabled: 0,
        onlyAO: 0,
        aoClamp: 0.3,
        lumInfluence: 0.0
...
ShaderLibExtra_brightnesscontrast = {
    attributes: {
        vertexPosition: rendererMeshData_MeshDatajs.POSITION,
        vertexUV0: rendererMeshData_MeshDatajs.TEXCOORD0
    },
...
ShaderLibExtra_toon = {
    ...
    uniforms: {
        ...
        lightPosition: rendererShader_Shaderjs.LIGHT0,
 ...
 */
ShaderLibExtra_differenceOfGaussians = {
    attributes: {
        vertexPosition: rendererMeshData_MeshDatajs.POSITION,
        vertexUV0: rendererMeshData_MeshDatajs.TEXCOORD0
    },
...
ShaderLibExtra_radial = {
    ...
    uniforms: {
        ...
        worldMatrix: rendererShader_Shaderjs.WORLD_MATRIX,
        tDiffuse: rendererShader_Shaderjs.DIFFUSE_MAP,
        frameBufSize: rendererShader_Shaderjs.RESOLUTION,
        offset: 0.5,
        multiplier: -0.75
    },
...
export { ShaderLibExtra_sepia as sepia, ShaderLibExtra_dotscreen as dotscreen, ShaderLibExtra_vignette as vignette, ShaderLibExtra_film as film, ShaderLibExtra_noise as noise, ShaderLibExtra_bleachbypass as bleachbypass, ShaderLibExtra_colorify as colorify, ShaderLibExtra_hatch as hatch, ShaderLibExtra_ssao as ssao, ShaderLibExtra_rgbshift as rgbshift, ShaderLibExtra_brightnesscontrast as brightnesscontrast, ShaderLibExtra_hsb as hsb, ShaderLibExtra_differenceOfGaussians as differenceOfGaussians, ShaderLibExtra_overlay as overlay, ShaderLibExtra_levels as levels, ShaderLibExtra_radial as radial, ShaderLibExtra_antialias as antialias, ShaderLibExtra };