...
functionObject_brightnesscontrast = {
    attributes: {
        vertexPosition: MeshData.POSITION,
        vertexUV0: MeshData.TEXCOORD0
    },
...
functionObject_toon = {
    ...
    uniforms: {
        ...
        HighlightColor: [0.9, 0.8, 0.7, 1],
        MidColor: [0.65, 0.55, 0.45, 1],
        ShadowColor: [0.4, 0.3, 0.2, 1],
        HighlightSize: 0.2,
        ShadowSize: 0.01,
        OutlineWidth: 0.15
    },
...
functionObject_differenceOfGaussians = {
    attributes: {
        vertexPosition: MeshData.POSITION,
        vertexUV0: MeshData.TEXCOORD0
    },
...
export { functionObject_sepia as sepia, functionObject_dotscreen as dotscreen, functionObject_vignette as vignette, functionObject_film as film, functionObject_noise as noise, functionObject_bleachbypass as bleachbypass, functionObject_colorify as colorify, functionObject_hatch as hatch, functionObject_ssao as ssao, functionObject_rgbshift as rgbshift, functionObject_brightnesscontrast as brightnesscontrast, functionObject_hsb as hsb, functionObject_differenceOfGaussians as differenceOfGaussians, functionObject_overlay as overlay, functionObject_levels as levels, functionObject_radial as radial, functionObject_antialias as antialias };