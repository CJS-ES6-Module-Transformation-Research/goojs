...
exports.default = ShaderLibExtra;
...
ShaderLibExtra.showDepth = {
		...
		uniforms: {
				...
				far: _Shader2.default.FAR_PLANE
		},
...
ShaderLibExtra.bokehShader = {
		...
		uniforms: {
				...
				projectionMatrix: _Shader2.default.PROJECTION_MATRIX,
				worldMatrix: _Shader2.default.WORLD_MATRIX,
				tColor: _Shader2.default.DIFFUSE_MAP,
				tDepth: _Shader2.default.DEPTH_MAP,
				focus: 1.0,
				aspect: 1.0,
				aperture: 0.025,
				maxblur: 1.0
...
ShaderLibExtra.film = {
		attributes: _ShaderLib2.default.copy.attributes,
		uniforms: {
				tDiffuse: _Shader2.default.DIFFUSE_MAP,
		...
		vshader: _ShaderLib2.default.copy.vshader,
...
ShaderLibExtra.ssao = {
		...
		uniforms: {
				...
				tDepth: _Shader2.default.DEPTH_MAP,
				size: [512, 512],
				cameraNear: _Shader2.default.MAIN_NEAR_PLANE,
				cameraFar: _Shader2.default.MAIN_FAR_PLANE,
				fogNear: _Shader2.default.MAIN_NEAR_PLANE,
				fogFar: _Shader2.default.MAIN_FAR_PLANE,
				fogEnabled: 0,
				onlyAO: 0,
				aoClamp: 0.3,
				lumInfluence: 0.0
...
ShaderLibExtra.toon = {
		...
		uniforms: {
				...
				lightPosition: _Shader2.default.LIGHT0,
...
ShaderLibExtra.levels = {
		...
		vshader: ['attribute vec3 vertexPosition;', 'attribute vec2 vertexUV0;', 'uniform mat4 viewMatrix;', 'uniform mat4 projectionMatrix;', 'uniform mat4 worldMatrix;', 'varying vec2 vUv;', 'void main() {', 'vUv = vertexUV0;', 'gl_Position = projectionMatrix * viewMatrix * worldMatrix * vec4( vertexPosition, 1.0 );', '}'].join('\n'),
		fshader: [_ShaderFragment2.default.blendmodes, 'uniform sampler2D tDiffuse;', 'uniform float gamma;', 'uniform float minInput;', 'uniform float maxInput;', 'uniform float minOutput;', 'uniform float maxOutput;', 'varying vec2 vUv;', 'void main() {', 'gl_FragColor = texture2D( tDiffuse, vUv );', 'gl_FragColor.rgb = LevelsControl(gl_FragColor.rgb, minInput, gamma, maxInput, minOutput, maxOutput);', '}'].join('\n')
};
...
ShaderLibExtra.radial = {
		...
		uniforms: {
				...
				worldMatrix: _Shader2.default.WORLD_MATRIX,
				tDiffuse: _Shader2.default.DIFFUSE_MAP,
				frameBufSize: _Shader2.default.RESOLUTION,
				offset: 0.5,
				multiplier: -0.75
		},
...
ShaderLibExtra.packDepth = {
		...
		fshader: ['uniform float farPlane;', _ShaderFragment2.default.methods.packDepth, 'varying vec4 vPosition;', 'void main(void)', '{', 'float linearDepth = min(length(vPosition), farPlane) / farPlane;', 'gl_FragColor = packDepth(linearDepth);', '}'].join('\n')
};
