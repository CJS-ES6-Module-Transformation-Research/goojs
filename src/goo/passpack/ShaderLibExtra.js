...
exports.antialias = exports.radial = exports.levels = exports.overlay = exports.differenceOfGaussians = exports.hsb = exports.brightnesscontrast = exports.rgbshift = exports.ssao = exports.hatch = exports.colorify = exports.bleachbypass = exports.noise = exports.film = exports.vignette = exports.dotscreen = exports.sepia = undefined;
...
var functionObject_antialias;
var functionObject_packDepth;
var functionObject_radial;
var functionObject_boxfilter;
var functionObject_levels;
var functionObject_overlay;
var functionObject_differenceOfGaussians;
var functionObject_toon;
var functionObject_luminosity;
var functionObject_hsb;
var functionObject_brightnesscontrast;
var functionObject_rgbshift;
var functionObject_skinning;
var functionObject_ssao;
var functionObject_hatch;
var functionObject_colorify;
var functionObject_horizontalTiltShift;
var functionObject_bleachbypass;
var functionObject_noise;
var functionObject_film;
var functionObject_vignette;
var functionObject_dotscreen;
var functionObject_sepia;
var functionObject_bokehShader;
var functionObject_showDepth;
var functionObject_billboard;
...
exports.sepia = functionObject_sepia = {
    attributes: {
        vertexPosition: _MeshData.MeshData.POSITION,
        vertexUV0: _MeshData.MeshData.TEXCOORD0
    },
...
exports.dotscreen = functionObject_dotscreen = {
    attributes: {
        vertexPosition: _MeshData.MeshData.POSITION,
        vertexUV0: _MeshData.MeshData.TEXCOORD0
    },
...
exports.vignette = functionObject_vignette = {
    attributes: {
        vertexPosition: _MeshData.MeshData.POSITION,
        vertexUV0: _MeshData.MeshData.TEXCOORD0
    },
...
exports.film = functionObject_film = {
...
exports.noise = functionObject_noise = {
    attributes: ShaderLib.copy.attributes,
...
exports.bleachbypass = functionObject_bleachbypass = {
    attributes: {
        vertexPosition: _MeshData.MeshData.POSITION,
        vertexUV0: _MeshData.MeshData.TEXCOORD0
    },
...
functionObject_horizontalTiltShift = {
    attributes: {
        vertexPosition: _MeshData.MeshData.POSITION,
        vertexUV0: _MeshData.MeshData.TEXCOORD0
    },
...
exports.colorify = functionObject_colorify = {
    attributes: {
        vertexPosition: _MeshData.MeshData.POSITION,
        vertexUV0: _MeshData.MeshData.TEXCOORD0
    },
...
exports.hatch = functionObject_hatch = {
    attributes: {
        vertexPosition: _MeshData.MeshData.POSITION,
        vertexUV0: _MeshData.MeshData.TEXCOORD0
    },
...
exports.ssao = functionObject_ssao = {
    attributes: {
        vertexPosition: _MeshData.MeshData.POSITION,
        vertexUV0: _MeshData.MeshData.TEXCOORD0
    },
...
exports.rgbshift = functionObject_rgbshift = {
    attributes: {
        vertexPosition: _MeshData.MeshData.POSITION,
        vertexUV0: _MeshData.MeshData.TEXCOORD0
    },
...
exports.brightnesscontrast = functionObject_brightnesscontrast = {
    attributes: {
        vertexPosition: _MeshData.MeshData.POSITION,
        vertexUV0: _MeshData.MeshData.TEXCOORD0
    },
...
exports.hsb = functionObject_hsb = {
    attributes: {
        vertexPosition: _MeshData.MeshData.POSITION,
        vertexUV0: _MeshData.MeshData.TEXCOORD0
    },
...
exports.differenceOfGaussians = functionObject_differenceOfGaussians = {
    attributes: {
        vertexPosition: _MeshData.MeshData.POSITION,
        vertexUV0: _MeshData.MeshData.TEXCOORD0
    },
...
exports.overlay = functionObject_overlay = {
    defines: {
        OVERLAY_TYPE: 0
    },
...
exports.levels = functionObject_levels = {
    ...
    fshader: [ShaderFragment.blendmodes, "uniform sampler2D tDiffuse;", "uniform float gamma;", "uniform float minInput;", "uniform float maxInput;", "uniform float minOutput;", "uniform float maxOutput;", "varying vec2 vUv;", "void main() {", "gl_FragColor = texture2D( tDiffuse, vUv );", "gl_FragColor.rgb = LevelsControl(gl_FragColor.rgb, minInput, gamma, maxInput, minOutput, maxOutput);", "}"].join("\n")
};

functionObject_boxfilter = {
    attributes: {
        vertexPosition: _MeshData.MeshData.POSITION,
        vertexUV0: _MeshData.MeshData.TEXCOORD0
    },
...
exports.radial = functionObject_radial = {
    attributes: {
        vertexPosition: _MeshData.MeshData.POSITION,
        vertexUV0: _MeshData.MeshData.TEXCOORD0
    },
...
functionObject_packDepth = {
    ...
    fshader: ["uniform float farPlane;", ShaderFragment.methods.packDepth, "varying vec4 vPosition;", "void main(void)", "{", "float linearDepth = min(length(vPosition), farPlane) / farPlane;", "gl_FragColor = packDepth(linearDepth);", "}"].join("\n")
};

exports.antialias = functionObject_antialias = {
    attributes: {
        vertexPosition: _MeshData.MeshData.POSITION,
        vertexUV0: _MeshData.MeshData.TEXCOORD0
    },
