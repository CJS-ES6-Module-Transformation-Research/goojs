...
ShaderLibExtra.film = {
	attributes: renderershadersShaderLib_ShaderLibjs.copy.attributes,
	uniforms: {
		tDiffuse: rendererShader_Shaderjs.DIFFUSE_MAP,
	...
	vshader: renderershadersShaderLib_ShaderLibjs.copy.vshader,
	fshader: [
		'uniform float time;',
...
ShaderLibExtra.hsb = {
	...
	fshader: [
		...
		renderershadersShaderFragment_ShaderFragmentjs.methods.hsv,
...
ShaderLibExtra.overlay = {
	...
	fshader: [
		renderershadersShaderFragment_ShaderFragmentjs.blendmodes,
 ...
 */
export { ShaderLibExtra_ShaderLibExtra as ShaderLibExtra };