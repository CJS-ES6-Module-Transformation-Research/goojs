...
ShaderLibExtra_bokehShader = {
    ...
    uniforms: {
        ...
        projectionMatrix: _Shader.Shader.PROJECTION_MATRIX,
        worldMatrix: _Shader.Shader.WORLD_MATRIX,
        tColor: _Shader.Shader.DIFFUSE_MAP,
        tDepth: _Shader.Shader.DEPTH_MAP,
        focus: 1.0,
        aspect: 1.0,
        aperture: 0.025,
        maxblur: 1.0
...
exports.ssao = ShaderLibExtra_ssao = {
    ...
    uniforms: {
        ...
        tDepth: _Shader.Shader.DEPTH_MAP,
        size: [512, 512],
        cameraNear: _Shader.Shader.MAIN_NEAR_PLANE,
        cameraFar: _Shader.Shader.MAIN_FAR_PLANE,
        fogNear: _Shader.Shader.MAIN_NEAR_PLANE,
        fogFar: _Shader.Shader.MAIN_FAR_PLANE,
        fogEnabled: 0,
        onlyAO: 0,
        aoClamp: 0.3,
        lumInfluence: 0.0
...
exports.radial = ShaderLibExtra_radial = {
    ...
    uniforms: {
        ...
        worldMatrix: _Shader.Shader.WORLD_MATRIX,
        tDiffuse: _Shader.Shader.DIFFUSE_MAP,
        frameBufSize: _Shader.Shader.RESOLUTION,
        offset: 0.5,
        multiplier: -0.75
    },
