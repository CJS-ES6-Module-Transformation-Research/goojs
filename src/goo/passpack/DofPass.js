...
function DofPass(renderList, outShader) {
	...
	var size = MathUtilsjs.nearestPowerOfTwo(Math.max(width, height));
...
DofPass.prototype = Object.create(Passjs.prototype);
...
DofPass.prototype.render = function (renderer, writeBuffer, readBuffer, delta) {
	...
	this.outPass.material.setTexture(Shaderjs.DIFFUSE_MAP, this.regularTarget);
