...
function BloomPass(settings) {
	...
	this.bcMaterial = new Material_Material(ShaderLibExtra_ShaderLibExtra.brightnesscontrast);
...
BloomPass.prototype = Object.create(Pass_Pass.prototype);
 ...
 * </pre>
 */
export { mod_BloomPass as BloomPass };