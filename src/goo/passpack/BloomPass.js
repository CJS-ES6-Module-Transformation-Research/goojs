...
function BloomPass(settings) {
	...
	this.copyMaterial = new rendererMaterial_Materialjs(ShaderLibjs_copyPure);
	this.copyMaterial.uniforms.opacity = strength;
	this.copyMaterial.blendState.blending = 'AdditiveBlending';

	this.convolutionShader = utilObjectUtils_ObjectUtilsjs.deepClone(ShaderLibjs_convolution);
	...
	this.bcMaterial = new rendererMaterial_Materialjs(ShaderLibExtrajs_brightnesscontrast);
