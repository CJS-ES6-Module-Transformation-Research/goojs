...
function Bloom(id) {
	_BloomPass2.default.call(this);
	this.id = id;
}

Bloom.prototype = Object.create(_BloomPass2.default.prototype);
...
function DiffOfGaussians(id) {
	_DogPass2.default.call(this, arguments);
	this.id = id;
}

//! AT: we use both "DiffOfGaussians" and "DoG"
DiffOfGaussians.prototype = Object.create(_DogPass2.default.prototype);
...
function Blur(id) {
	_BlurPass2.default.call(this, arguments);
	this.id = id;
}
Blur.prototype = Object.create(_BlurPass2.default.prototype);
...
function Vignette(id) {
	_FullscreenPass2.default.call(this, _ObjectUtils2.default.deepClone(_ShaderLibExtra2.default.vignette));
	this.id = id;
}
Vignette.prototype = Object.create(_FullscreenPass2.default.prototype);
...
function Sepia(id) {
	_FullscreenPass2.default.call(this, _ObjectUtils2.default.deepClone(_ShaderLibExtra2.default.sepia));
	this.id = id;
}
Sepia.prototype = Object.create(_FullscreenPass2.default.prototype);
...
function Grain(id) {
	_FullscreenPass2.default.call(this, _ObjectUtils2.default.deepClone(_ShaderLibExtra2.default.film));
	this.id = id;
}
Grain.prototype = Object.create(_FullscreenPass2.default.prototype);
...
function Noise(id) {
	_FullscreenPass2.default.call(this, _ObjectUtils2.default.deepClone(_ShaderLibExtra2.default.noise));
	this.id = id;
}
Noise.prototype = Object.create(_FullscreenPass2.default.prototype);
...
function RgbShift(id) {
	_FullscreenPass2.default.call(this, _ObjectUtils2.default.deepClone(_ShaderLibExtra2.default.rgbshift));
	this.id = id;
}
RgbShift.prototype = Object.create(_FullscreenPass2.default.prototype);
...
function Bleach(id) {
	_FullscreenPass2.default.call(this, _ObjectUtils2.default.deepClone(_ShaderLibExtra2.default.bleachbypass));
	this.id = id;
}
Bleach.prototype = Object.create(_FullscreenPass2.default.prototype);
...
function HSB(id) {
	_FullscreenPass2.default.call(this, _ObjectUtils2.default.deepClone(_ShaderLibExtra2.default.hsb));
	this.id = id;
}
HSB.prototype = Object.create(_FullscreenPass2.default.prototype);
...
function Colorify(id) {
	_FullscreenPass2.default.call(this, _ObjectUtils2.default.deepClone(_ShaderLibExtra2.default.colorify));
	this.id = id;
}
Colorify.prototype = Object.create(_FullscreenPass2.default.prototype);
...
function Hatch(id) {
	_FullscreenPass2.default.call(this, _ObjectUtils2.default.deepClone(_ShaderLibExtra2.default.hatch));
	this.id = id;
}
Hatch.prototype = Object.create(_FullscreenPass2.default.prototype);
...
function Dot(id) {
	_FullscreenPass2.default.call(this, _ObjectUtils2.default.deepClone(_ShaderLibExtra2.default.dotscreen));
	this.id = id;
}
Dot.prototype = Object.create(_FullscreenPass2.default.prototype);
...
function Contrast(id) {
	_FullscreenPass2.default.call(this, _ObjectUtils2.default.deepClone(_ShaderLibExtra2.default.brightnesscontrast));
	this.id = id;
}
Contrast.prototype = Object.create(_FullscreenPass2.default.prototype);
...
function MotionBlur(id) {
	_MotionBlurPass2.default.call(this);
	this.id = id;
}
MotionBlur.prototype = Object.create(_MotionBlurPass2.default.prototype);
...
function Antialias(id) {
	_FullscreenPass2.default.call(this, _ObjectUtils2.default.deepClone(_ShaderLibExtra2.default.antialias));
	this.id = id;
}
Antialias.prototype = Object.create(_FullscreenPass2.default.prototype);
...
function Radial(id) {
	_FullscreenPass2.default.call(this, _ObjectUtils2.default.deepClone(_ShaderLibExtra2.default.radial));
	this.id = id;
}
Radial.prototype = Object.create(_FullscreenPass2.default.prototype);
...
function Overlay(id) {
	_FullscreenPass2.default.call(this, _ObjectUtils2.default.deepClone(_ShaderLibExtra2.default.overlay));
	this.id = id;
}
Overlay.prototype = Object.create(_FullscreenPass2.default.prototype);
...
function Levels(id) {
	_FullscreenPass2.default.call(this, _ObjectUtils2.default.deepClone(_ShaderLibExtra2.default.levels));
	this.id = id;
}
Levels.prototype = Object.create(_FullscreenPass2.default.prototype);
