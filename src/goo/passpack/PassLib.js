...
function Vignette(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtrajs_vignette));
	this.id = id;
}
...
function Sepia(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtrajs_sepia));
	this.id = id;
}
...
function Grain(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtrajs_film));
	this.id = id;
}
...
function Noise(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtrajs_noise));
	this.id = id;
}
...
function RgbShift(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtrajs_rgbshift));
	this.id = id;
}
...
function Bleach(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtrajs_bleachbypass));
	this.id = id;
}
...
function HSB(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtrajs_hsb));
	this.id = id;
}
...
function Colorify(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtrajs_colorify));
	this.id = id;
}
...
function Hatch(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtrajs_hatch));
	this.id = id;
}
...
function Dot(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtrajs_dotscreen));
	this.id = id;
}
...
function Contrast(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtrajs_brightnesscontrast));
	this.id = id;
}
...
function Antialias(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtrajs_antialias));
	this.id = id;
}
...
function Radial(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtrajs_radial));
	this.id = id;
}
...
function Overlay(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtrajs_overlay));
	this.id = id;
}
...
function Levels(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtrajs_levels));
	this.id = id;
}
