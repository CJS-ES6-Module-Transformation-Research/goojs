...
function Vignette(id) {
	_FullscreenPass.FullscreenPass.call(this, _ObjectUtils.ObjectUtils.deepClone(_ShaderLibExtra.ShaderLibExtra.vignette));
	this.id = id;
}
...
function Sepia(id) {
	_FullscreenPass.FullscreenPass.call(this, _ObjectUtils.ObjectUtils.deepClone(_ShaderLibExtra.ShaderLibExtra.sepia));
	this.id = id;
}
...
function Grain(id) {
	_FullscreenPass.FullscreenPass.call(this, _ObjectUtils.ObjectUtils.deepClone(_ShaderLibExtra.ShaderLibExtra.film));
	this.id = id;
}
...
function Noise(id) {
	_FullscreenPass.FullscreenPass.call(this, _ObjectUtils.ObjectUtils.deepClone(_ShaderLibExtra.ShaderLibExtra.noise));
	this.id = id;
}
...
function RgbShift(id) {
	_FullscreenPass.FullscreenPass.call(this, _ObjectUtils.ObjectUtils.deepClone(_ShaderLibExtra.ShaderLibExtra.rgbshift));
	this.id = id;
}
...
function Bleach(id) {
	_FullscreenPass.FullscreenPass.call(this, _ObjectUtils.ObjectUtils.deepClone(_ShaderLibExtra.ShaderLibExtra.bleachbypass));
	this.id = id;
}
...
function HSB(id) {
	_FullscreenPass.FullscreenPass.call(this, _ObjectUtils.ObjectUtils.deepClone(_ShaderLibExtra.ShaderLibExtra.hsb));
	this.id = id;
}
...
function Colorify(id) {
	_FullscreenPass.FullscreenPass.call(this, _ObjectUtils.ObjectUtils.deepClone(_ShaderLibExtra.ShaderLibExtra.colorify));
	this.id = id;
}
...
function Hatch(id) {
	_FullscreenPass.FullscreenPass.call(this, _ObjectUtils.ObjectUtils.deepClone(_ShaderLibExtra.ShaderLibExtra.hatch));
	this.id = id;
}
...
function Dot(id) {
	_FullscreenPass.FullscreenPass.call(this, _ObjectUtils.ObjectUtils.deepClone(_ShaderLibExtra.ShaderLibExtra.dotscreen));
	this.id = id;
}
...
function Contrast(id) {
	_FullscreenPass.FullscreenPass.call(this, _ObjectUtils.ObjectUtils.deepClone(_ShaderLibExtra.ShaderLibExtra.brightnesscontrast));
	this.id = id;
}
...
function Antialias(id) {
	_FullscreenPass.FullscreenPass.call(this, _ObjectUtils.ObjectUtils.deepClone(_ShaderLibExtra.ShaderLibExtra.antialias));
	this.id = id;
}
...
function Radial(id) {
	_FullscreenPass.FullscreenPass.call(this, _ObjectUtils.ObjectUtils.deepClone(_ShaderLibExtra.ShaderLibExtra.radial));
	this.id = id;
}
...
function Overlay(id) {
	_FullscreenPass.FullscreenPass.call(this, _ObjectUtils.ObjectUtils.deepClone(_ShaderLibExtra.ShaderLibExtra.overlay));
	this.id = id;
}
...
function Levels(id) {
	_FullscreenPass.FullscreenPass.call(this, _ObjectUtils.ObjectUtils.deepClone(_ShaderLibExtra.ShaderLibExtra.levels));
	this.id = id;
}
...
exports.PassLibjs = PassLibjs_PassLibjs;
