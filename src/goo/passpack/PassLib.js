...
import { BloomPass as BloomPass_BloomPass } from "../passpack/BloomPass";
import { BlurPass as BlurPass_BlurPass } from "../passpack/BlurPass";
import { DogPass as DogPass_DogPass } from "../passpack/DogPass";
import { MotionBlurPass as MotionBlurPass_MotionBlurPass } from "../passpack/MotionBlurPass";
import { ObjectUtils as ObjectUtils_ObjectUtils } from "../util/ObjectUtils";

function Bloom(id) {
	BloomPass_BloomPass.call(this);
	this.id = id;
}

Bloom.prototype = Object.create(BloomPass_BloomPass.prototype);
...
function DiffOfGaussians(id) {
	DogPass_DogPass.call(this, arguments);
	this.id = id;
}

//! AT: we use both "DiffOfGaussians" and "DoG"
DiffOfGaussians.prototype = Object.create(DogPass_DogPass.prototype);
...
function Blur(id) {
	BlurPass_BlurPass.call(this, arguments);
	this.id = id;
}
Blur.prototype = Object.create(BlurPass_BlurPass.prototype);
...
function Vignette(id) {
	FullscreenPass_FullscreenPass.call(this, ObjectUtils_ObjectUtils.deepClone(ShaderLibExtra_ShaderLibExtra.vignette));
	this.id = id;
}
Vignette.prototype = Object.create(FullscreenPass_FullscreenPass.prototype);
...
function Sepia(id) {
	FullscreenPass_FullscreenPass.call(this, ObjectUtils_ObjectUtils.deepClone(ShaderLibExtra_ShaderLibExtra.sepia));
	this.id = id;
}
Sepia.prototype = Object.create(FullscreenPass_FullscreenPass.prototype);
...
function Grain(id) {
	FullscreenPass_FullscreenPass.call(this, ObjectUtils_ObjectUtils.deepClone(ShaderLibExtra_ShaderLibExtra.film));
	this.id = id;
}
Grain.prototype = Object.create(FullscreenPass_FullscreenPass.prototype);
...
function Noise(id) {
	FullscreenPass_FullscreenPass.call(this, ObjectUtils_ObjectUtils.deepClone(ShaderLibExtra_ShaderLibExtra.noise));
	this.id = id;
}
Noise.prototype = Object.create(FullscreenPass_FullscreenPass.prototype);
...
function RgbShift(id) {
	FullscreenPass_FullscreenPass.call(this, ObjectUtils_ObjectUtils.deepClone(ShaderLibExtra_ShaderLibExtra.rgbshift));
	this.id = id;
}
RgbShift.prototype = Object.create(FullscreenPass_FullscreenPass.prototype);
...
function Bleach(id) {
	FullscreenPass_FullscreenPass.call(this, ObjectUtils_ObjectUtils.deepClone(ShaderLibExtra_ShaderLibExtra.bleachbypass));
	this.id = id;
}
Bleach.prototype = Object.create(FullscreenPass_FullscreenPass.prototype);
...
function HSB(id) {
	FullscreenPass_FullscreenPass.call(this, ObjectUtils_ObjectUtils.deepClone(ShaderLibExtra_ShaderLibExtra.hsb));
	this.id = id;
}
HSB.prototype = Object.create(FullscreenPass_FullscreenPass.prototype);
...
function Colorify(id) {
	FullscreenPass_FullscreenPass.call(this, ObjectUtils_ObjectUtils.deepClone(ShaderLibExtra_ShaderLibExtra.colorify));
	this.id = id;
}
Colorify.prototype = Object.create(FullscreenPass_FullscreenPass.prototype);
...
function Hatch(id) {
	FullscreenPass_FullscreenPass.call(this, ObjectUtils_ObjectUtils.deepClone(ShaderLibExtra_ShaderLibExtra.hatch));
	this.id = id;
}
Hatch.prototype = Object.create(FullscreenPass_FullscreenPass.prototype);
...
function Dot(id) {
	FullscreenPass_FullscreenPass.call(this, ObjectUtils_ObjectUtils.deepClone(ShaderLibExtra_ShaderLibExtra.dotscreen));
	this.id = id;
}
Dot.prototype = Object.create(FullscreenPass_FullscreenPass.prototype);
...
function Contrast(id) {
	FullscreenPass_FullscreenPass.call(this, ObjectUtils_ObjectUtils.deepClone(ShaderLibExtra_ShaderLibExtra.brightnesscontrast));
	this.id = id;
}
Contrast.prototype = Object.create(FullscreenPass_FullscreenPass.prototype);
...
function MotionBlur(id) {
	MotionBlurPass_MotionBlurPass.call(this);
	this.id = id;
}
MotionBlur.prototype = Object.create(MotionBlurPass_MotionBlurPass.prototype);
...
function Antialias(id) {
	FullscreenPass_FullscreenPass.call(this, ObjectUtils_ObjectUtils.deepClone(ShaderLibExtra_ShaderLibExtra.antialias));
	this.id = id;
}
Antialias.prototype = Object.create(FullscreenPass_FullscreenPass.prototype);
...
function Radial(id) {
	FullscreenPass_FullscreenPass.call(this, ObjectUtils_ObjectUtils.deepClone(ShaderLibExtra_ShaderLibExtra.radial));
	this.id = id;
}
Radial.prototype = Object.create(FullscreenPass_FullscreenPass.prototype);
...
function Overlay(id) {
	FullscreenPass_FullscreenPass.call(this, ObjectUtils_ObjectUtils.deepClone(ShaderLibExtra_ShaderLibExtra.overlay));
	this.id = id;
}
Overlay.prototype = Object.create(FullscreenPass_FullscreenPass.prototype);
...
function Levels(id) {
	FullscreenPass_FullscreenPass.call(this, ObjectUtils_ObjectUtils.deepClone(ShaderLibExtra_ShaderLibExtra.levels));
	this.id = id;
}
Levels.prototype = Object.create(FullscreenPass_FullscreenPass.prototype);
...
var mod_PassLibjs;
export { mod_PassLibjs as PassLibjs };