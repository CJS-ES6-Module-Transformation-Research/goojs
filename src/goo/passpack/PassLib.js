...
import { BloomPass as BloomPass_BloomPassjs } from "../passpack/BloomPass";
import { BlurPass as BlurPass_BlurPassjs } from "../passpack/BlurPass";
import { DogPass as DogPass_DogPassjs } from "../passpack/DogPass";
import { MotionBlurPass as MotionBlurPass_MotionBlurPassjs } from "../passpack/MotionBlurPass";
import { ObjectUtils as ObjectUtils_ObjectUtilsjs } from "../util/ObjectUtils";

function Bloom(id) {
	BloomPass_BloomPassjs.call(this);
	this.id = id;
}

Bloom.prototype = Object.create(BloomPass_BloomPassjs.prototype);
...
function DiffOfGaussians(id) {
	DogPass_DogPassjs.call(this, arguments);
	this.id = id;
}

//! AT: we use both "DiffOfGaussians" and "DoG"
DiffOfGaussians.prototype = Object.create(DogPass_DogPassjs.prototype);
...
function Blur(id) {
	BlurPass_BlurPassjs.call(this, arguments);
	this.id = id;
}
Blur.prototype = Object.create(BlurPass_BlurPassjs.prototype);
...
function Vignette(id) {
	FullscreenPass_FullscreenPassjs.call(this, ObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtra_ShaderLibExtrajs.vignette));
	this.id = id;
}
Vignette.prototype = Object.create(FullscreenPass_FullscreenPassjs.prototype);
...
function Sepia(id) {
	FullscreenPass_FullscreenPassjs.call(this, ObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtra_ShaderLibExtrajs.sepia));
	this.id = id;
}
Sepia.prototype = Object.create(FullscreenPass_FullscreenPassjs.prototype);
...
function Grain(id) {
	FullscreenPass_FullscreenPassjs.call(this, ObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtra_ShaderLibExtrajs.film));
	this.id = id;
}
Grain.prototype = Object.create(FullscreenPass_FullscreenPassjs.prototype);
...
function Noise(id) {
	FullscreenPass_FullscreenPassjs.call(this, ObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtra_ShaderLibExtrajs.noise));
	this.id = id;
}
Noise.prototype = Object.create(FullscreenPass_FullscreenPassjs.prototype);
...
function RgbShift(id) {
	FullscreenPass_FullscreenPassjs.call(this, ObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtra_ShaderLibExtrajs.rgbshift));
	this.id = id;
}
RgbShift.prototype = Object.create(FullscreenPass_FullscreenPassjs.prototype);
...
function Bleach(id) {
	FullscreenPass_FullscreenPassjs.call(this, ObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtra_ShaderLibExtrajs.bleachbypass));
	this.id = id;
}
Bleach.prototype = Object.create(FullscreenPass_FullscreenPassjs.prototype);
...
function HSB(id) {
	FullscreenPass_FullscreenPassjs.call(this, ObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtra_ShaderLibExtrajs.hsb));
	this.id = id;
}
HSB.prototype = Object.create(FullscreenPass_FullscreenPassjs.prototype);
...
function Colorify(id) {
	FullscreenPass_FullscreenPassjs.call(this, ObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtra_ShaderLibExtrajs.colorify));
	this.id = id;
}
Colorify.prototype = Object.create(FullscreenPass_FullscreenPassjs.prototype);
...
function Hatch(id) {
	FullscreenPass_FullscreenPassjs.call(this, ObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtra_ShaderLibExtrajs.hatch));
	this.id = id;
}
Hatch.prototype = Object.create(FullscreenPass_FullscreenPassjs.prototype);
...
function Dot(id) {
	FullscreenPass_FullscreenPassjs.call(this, ObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtra_ShaderLibExtrajs.dotscreen));
	this.id = id;
}
Dot.prototype = Object.create(FullscreenPass_FullscreenPassjs.prototype);
...
function Contrast(id) {
	FullscreenPass_FullscreenPassjs.call(this, ObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtra_ShaderLibExtrajs.brightnesscontrast));
	this.id = id;
}
Contrast.prototype = Object.create(FullscreenPass_FullscreenPassjs.prototype);
...
function MotionBlur(id) {
	MotionBlurPass_MotionBlurPassjs.call(this);
	this.id = id;
}
MotionBlur.prototype = Object.create(MotionBlurPass_MotionBlurPassjs.prototype);
...
function Antialias(id) {
	FullscreenPass_FullscreenPassjs.call(this, ObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtra_ShaderLibExtrajs.antialias));
	this.id = id;
}
Antialias.prototype = Object.create(FullscreenPass_FullscreenPassjs.prototype);
...
function Radial(id) {
	FullscreenPass_FullscreenPassjs.call(this, ObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtra_ShaderLibExtrajs.radial));
	this.id = id;
}
Radial.prototype = Object.create(FullscreenPass_FullscreenPassjs.prototype);
...
function Overlay(id) {
	FullscreenPass_FullscreenPassjs.call(this, ObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtra_ShaderLibExtrajs.overlay));
	this.id = id;
}
Overlay.prototype = Object.create(FullscreenPass_FullscreenPassjs.prototype);
...
function Levels(id) {
	FullscreenPass_FullscreenPassjs.call(this, ObjectUtils_ObjectUtilsjs.deepClone(ShaderLibExtra_ShaderLibExtrajs.levels));
	this.id = id;
}
Levels.prototype = Object.create(FullscreenPass_FullscreenPassjs.prototype);
