...
function Vignette(id) {
	_FullscreenPass.FullscreenPass.call(this, (0, _ObjectUtils.deepClone)(_ShaderLibExtra.vignette));
	this.id = id;
}
...
function Sepia(id) {
	_FullscreenPass.FullscreenPass.call(this, (0, _ObjectUtils.deepClone)(_ShaderLibExtra.sepia));
	this.id = id;
}
...
function Grain(id) {
	_FullscreenPass.FullscreenPass.call(this, (0, _ObjectUtils.deepClone)(_ShaderLibExtra.film));
	this.id = id;
}
...
function Noise(id) {
	_FullscreenPass.FullscreenPass.call(this, (0, _ObjectUtils.deepClone)(_ShaderLibExtra.noise));
	this.id = id;
}
...
function RgbShift(id) {
	_FullscreenPass.FullscreenPass.call(this, (0, _ObjectUtils.deepClone)(_ShaderLibExtra.rgbshift));
	this.id = id;
}
...
function Bleach(id) {
	_FullscreenPass.FullscreenPass.call(this, (0, _ObjectUtils.deepClone)(_ShaderLibExtra.bleachbypass));
	this.id = id;
}
...
function HSB(id) {
	_FullscreenPass.FullscreenPass.call(this, (0, _ObjectUtils.deepClone)(_ShaderLibExtra.hsb));
	this.id = id;
}
...
function Colorify(id) {
	_FullscreenPass.FullscreenPass.call(this, (0, _ObjectUtils.deepClone)(_ShaderLibExtra.colorify));
	this.id = id;
}
...
function Hatch(id) {
	_FullscreenPass.FullscreenPass.call(this, (0, _ObjectUtils.deepClone)(_ShaderLibExtra.hatch));
	this.id = id;
}
...
function Dot(id) {
	_FullscreenPass.FullscreenPass.call(this, (0, _ObjectUtils.deepClone)(_ShaderLibExtra.dotscreen));
	this.id = id;
}
...
function Contrast(id) {
	_FullscreenPass.FullscreenPass.call(this, (0, _ObjectUtils.deepClone)(_ShaderLibExtra.brightnesscontrast));
	this.id = id;
}
...
function Antialias(id) {
	_FullscreenPass.FullscreenPass.call(this, (0, _ObjectUtils.deepClone)(_ShaderLibExtra.antialias));
	this.id = id;
}
...
function Radial(id) {
	_FullscreenPass.FullscreenPass.call(this, (0, _ObjectUtils.deepClone)(_ShaderLibExtra.radial));
	this.id = id;
}
...
function Overlay(id) {
	_FullscreenPass.FullscreenPass.call(this, (0, _ObjectUtils.deepClone)(_ShaderLibExtra.overlay));
	this.id = id;
}
...
function Levels(id) {
	_FullscreenPass.FullscreenPass.call(this, (0, _ObjectUtils.deepClone)(_ShaderLibExtra.levels));
	this.id = id;
}
