...
import { BloomPass as passpackBloomPass_BloomPassjs } from "../passpack/BloomPass";
import { BlurPass as passpackBlurPass_BlurPassjs } from "../passpack/BlurPass";
import { DogPass as passpackDogPass_DogPassjs } from "../passpack/DogPass";
import { MotionBlurPass as passpackMotionBlurPass_MotionBlurPassjs } from "../passpack/MotionBlurPass";
import { ObjectUtils as utilObjectUtils_ObjectUtilsjs } from "../util/ObjectUtils";

function Bloom(id) {
	passpackBloomPass_BloomPassjs.call(this);
	this.id = id;
}

Bloom.prototype = Object.create(passpackBloomPass_BloomPassjs.prototype);
...
function DiffOfGaussians(id) {
	passpackDogPass_DogPassjs.call(this, arguments);
	this.id = id;
}

//! AT: we use both "DiffOfGaussians" and "DoG"
DiffOfGaussians.prototype = Object.create(passpackDogPass_DogPassjs.prototype);
...
function Blur(id) {
	passpackBlurPass_BlurPassjs.call(this, arguments);
	this.id = id;
}
Blur.prototype = Object.create(passpackBlurPass_BlurPassjs.prototype);
...
function Vignette(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(passpackShaderLibExtra_ShaderLibExtrajs.vignette));
	this.id = id;
}
Vignette.prototype = Object.create(rendererpassFullscreenPass_FullscreenPassjs.prototype);
...
function Sepia(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(passpackShaderLibExtra_ShaderLibExtrajs.sepia));
	this.id = id;
}
Sepia.prototype = Object.create(rendererpassFullscreenPass_FullscreenPassjs.prototype);
...
function Grain(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(passpackShaderLibExtra_ShaderLibExtrajs.film));
	this.id = id;
}
Grain.prototype = Object.create(rendererpassFullscreenPass_FullscreenPassjs.prototype);
...
function Noise(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(passpackShaderLibExtra_ShaderLibExtrajs.noise));
	this.id = id;
}
Noise.prototype = Object.create(rendererpassFullscreenPass_FullscreenPassjs.prototype);
...
function RgbShift(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(passpackShaderLibExtra_ShaderLibExtrajs.rgbshift));
	this.id = id;
}
RgbShift.prototype = Object.create(rendererpassFullscreenPass_FullscreenPassjs.prototype);
...
function Bleach(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(passpackShaderLibExtra_ShaderLibExtrajs.bleachbypass));
	this.id = id;
}
Bleach.prototype = Object.create(rendererpassFullscreenPass_FullscreenPassjs.prototype);
...
function HSB(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(passpackShaderLibExtra_ShaderLibExtrajs.hsb));
	this.id = id;
}
HSB.prototype = Object.create(rendererpassFullscreenPass_FullscreenPassjs.prototype);
...
function Colorify(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(passpackShaderLibExtra_ShaderLibExtrajs.colorify));
	this.id = id;
}
Colorify.prototype = Object.create(rendererpassFullscreenPass_FullscreenPassjs.prototype);
...
function Hatch(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(passpackShaderLibExtra_ShaderLibExtrajs.hatch));
	this.id = id;
}
Hatch.prototype = Object.create(rendererpassFullscreenPass_FullscreenPassjs.prototype);
...
function Dot(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(passpackShaderLibExtra_ShaderLibExtrajs.dotscreen));
	this.id = id;
}
Dot.prototype = Object.create(rendererpassFullscreenPass_FullscreenPassjs.prototype);
...
function Contrast(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(passpackShaderLibExtra_ShaderLibExtrajs.brightnesscontrast));
	this.id = id;
}
Contrast.prototype = Object.create(rendererpassFullscreenPass_FullscreenPassjs.prototype);
...
function MotionBlur(id) {
	passpackMotionBlurPass_MotionBlurPassjs.call(this);
	this.id = id;
}
MotionBlur.prototype = Object.create(passpackMotionBlurPass_MotionBlurPassjs.prototype);
...
function Antialias(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(passpackShaderLibExtra_ShaderLibExtrajs.antialias));
	this.id = id;
}
Antialias.prototype = Object.create(rendererpassFullscreenPass_FullscreenPassjs.prototype);
...
function Radial(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(passpackShaderLibExtra_ShaderLibExtrajs.radial));
	this.id = id;
}
Radial.prototype = Object.create(rendererpassFullscreenPass_FullscreenPassjs.prototype);
...
function Overlay(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(passpackShaderLibExtra_ShaderLibExtrajs.overlay));
	this.id = id;
}
Overlay.prototype = Object.create(rendererpassFullscreenPass_FullscreenPassjs.prototype);
...
function Levels(id) {
	rendererpassFullscreenPass_FullscreenPassjs.call(this, utilObjectUtils_ObjectUtilsjs.deepClone(passpackShaderLibExtra_ShaderLibExtrajs.levels));
	this.id = id;
}
Levels.prototype = Object.create(rendererpassFullscreenPass_FullscreenPassjs.prototype);
...
var PassLibjs_PassLibjs;
export { PassLibjs_PassLibjs as PassLibjs };