var MotionBlurPass_MotionBlurPass = MotionBlurPass;
import { Shader as rendererShader_Shaderjs } from "../renderer/Shader";
import { copyPure as ShaderLibjs_copyPure } from "../renderer/shaders/ShaderLib";
...
function MotionBlurPass() {
	...
	this.outPass = new rendererpassFullscreenPass_FullscreenPassjs(ShaderLibjs_copyPure);
...
export { MotionBlurPass_MotionBlurPass as MotionBlurPass };