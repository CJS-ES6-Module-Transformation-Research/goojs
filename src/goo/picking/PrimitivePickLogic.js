import { BoundingTree as BoundingTree_BoundingTreejs } from "../picking/BoundingTree";
import { Ray as Ray_Rayjs } from "../math/Ray";
import { Matrix4 as Matrix4_Matrix4js } from "../math/Matrix4";
function PrimitivePickLogic() {
	this.invRay = new Ray_Rayjs();
	this.invMatrix = new Matrix4_Matrix4js();
}
...
PrimitivePickLogic.prototype.rebuild = function (entity) {
	// build bounding tree
	entity.meshDataComponent.meshData.__boundingTree = new BoundingTree_BoundingTreejs();
