var LineRenderer_LineRenderer = LineRenderer;
...
function LineRenderer(world) {
	...
	LineRenderer__material = new rendererMaterial_Materialjs(LineRenderer_COLORED_LINE_SHADER);;

	LineRenderer__meshData = new rendererMeshData_MeshDatajs(LineRenderer_ATTRIBUTE_MAP, LineRenderer_MAX_NUM_LINES * 2);;
...
LineRenderer_ATTRIBUTE_MAP = {
    POSITION: rendererMeshData_MeshDatajs.createAttribute(3, "Float"),
    RGB_COLOR: rendererMeshData_MeshDatajs.createAttribute(3, "Float")
};;
 ...
 */
export { LineRenderer_LineRenderer as LineRenderer };
