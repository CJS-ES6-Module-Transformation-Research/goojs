...
function ProjectedGridWaterRenderer(settings) {
	...
	this.fullscreenPass = new FullscreenPassjs(ShaderLibjs.normalmap);
	...
	if (settings.normalsTexture) {
		...
		new TextureCreatorjs().loadTexture2D(normalsTextureUrl).then(function (texture) {
