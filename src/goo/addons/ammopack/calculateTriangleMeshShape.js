...
var mod_anonymus = function mod_anonymus(entity, scale) {
	scale = scale || [1, 1, 1];
	var floatByteSize = 4;
...
exports.calculateTriangleMeshShape = mod_anonymus = function mod_anonymus(entity, scale) {
	scale = scale || [1, 1, 1];
	var floatByteSize = 4;
	var use32bitIndices = true;
	var intByteSize = use32bitIndices ? 4 : 2;
...
exports.calculateTriangleMeshShape = mod_anonymus;