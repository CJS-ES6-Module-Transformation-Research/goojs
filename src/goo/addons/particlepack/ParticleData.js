...
function ParticleData(particleComponent) {
	 ...
	 * @type {Vector3}
	 */
	this.startPosition = new Vector3_Vector3js();

	/**
	 * @type {Vector3}
	 */
	this.startDirection = new Vector3_Vector3js();
...
var dirDelta = new Vector3_Vector3js();
var gravityDelta = new Vector3_Vector3js();
var localVelocityDelta = new Vector3_Vector3js();
var worldVelocityDelta = new Vector3_Vector3js();
