...
LerpCurve.prototype = Object.create(Curvejs.prototype);
...
LerpCurve.prototype.getValueAt = function (t, lerpValue) {
	return MathUtilsjs.lerp(lerpValue, this.curveA.getValueAt(t, lerpValue), this.curveB.getValueAt(t, lerpValue));
};

LerpCurve.prototype.getIntegralValueAt = function (t, lerpValue) {
	return MathUtilsjs.lerp(lerpValue, this.curveA.getIntegralValueAt(t, lerpValue), this.curveB.getIntegralValueAt(t, lerpValue));
};
