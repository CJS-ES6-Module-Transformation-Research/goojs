...
LinearCurve.prototype.toGLSL = function (timeVariableName /*, lerpValueVariableName*/) {
	return '(' + (0, _Curve.numberToGLSL)(this.k) + '*' + timeVariableName + '+' + (0, _Curve.numberToGLSL)(this.m) + ')';
};

LinearCurve.prototype.integralToGLSL = function (timeVariableName /*, lerpValueVariableName*/) {
	var k = (0, _Curve.numberToGLSL)(this.k);
	var m = (0, _Curve.numberToGLSL)(this.m);
 ...
 */
exports.LinearCurve = exported_LinearCurve;
