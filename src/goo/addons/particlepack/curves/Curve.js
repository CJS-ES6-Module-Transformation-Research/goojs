 ...
 * @returns {string}
 */
exports.numberToGLSL = Curve_numberToGLSL = function Curve_numberToGLSL(n) {
...
Curve.prototype = {
   ...
   * @returns {string}
   */
  toGLSL: function toGLSL() /*timeVariableName, lerpVariableName*/{
    return '0.0';
  },
   ...
   * @param {Vector4} store
   */
  getVec4ValueAt: function getVec4ValueAt() /*t, lerpValue, store*/{},
   ...
   * @param {Vector4} store
   */
  getVec4IntegralValueAt: function getVec4IntegralValueAt() /*t, lerpValue, store*/{},
...
exports.numberToGLSL = Curve_numberToGLSL;
