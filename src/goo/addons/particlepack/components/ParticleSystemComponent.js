...
ParticleSystemComponent.prototype._sortParticles = function () {
	...
	while (l--) {
		...
		particle.sortValue = -particle.getWorldPosition(tmpWorldPos).dot(_Renderer.mainCamera._direction);
	}
 ...
 * var entity = world.createEntity([0, 0, 0], particleComponent).addToWorld();
 */
exports.ParticleSystemComponent = mod_ParticleSystemComponent;