...
exports.default = ParticleSystemComponent;
...
function ParticleSystemComponent(options) {
	...
	this.material = new _Material2.default({
		defines: _ObjectUtils2.default.clone(defines),
		processors: [_ShaderBuilder2.default.uber.fog],
		attributes: {
	...
	_ObjectUtils2.default.extend(this.material.uniforms, {
		textureTileInfo: [1, 1, 1, 0],
		invWorldRotation: [1, 0, 0, 0, 1, 0, 0, 0, 1],
		worldRotation: [1, 0, 0, 0, 1, 0, 0, 0, 1],
		gravity: [0, 0, 0],
	...
	this._localGravity = new _Vector2.default();
	this._lastTime = this.time;
	this._worldToLocalRotation = new _Matrix2.default();
	this._localToWorldRotation = new _Matrix2.default();
  ...
  * @type {Vector3}
  */
	this.gravity = options.gravity ? options.gravity.clone() : new _Vector2.default();
  ...
  * @readonly
  */
	this.boxExtents = options.boxExtents ? options.boxExtents.clone() : new _Vector2.default(1, 1, 1);
  ...
  */
	this.startColorScale = options.startColorScale ? options.startColorScale.clone() : new _Vector4.default(1, 1, 1, 1);

	this.emissionRate = options.emissionRate ? options.emissionRate.clone() : new _ConstantCurve2.default({ value: 10 });
	...
	this.startSpeed = options.startSpeed ? options.startSpeed.clone() : new _ConstantCurve2.default({ value: 5 });
	...
	this.startLifetime = options.startLifetime ? options.startLifetime.clone() : new _ConstantCurve2.default({ value: 5 });
	...
	this.mesh = options.mesh ? options.mesh : new _Quad2.default();
...
ParticleSystemComponent.prototype = Object.create(_Component2.default.prototype);
...
ParticleSystemComponent.prototype._syncParticleDataArrays = function () {
	...
	while (particles.length < maxParticles) {
		var particle = new _ParticleData2.default(this);
...
ParticleSystemComponent.prototype._updateVertexData = function () {
	...
	var offset = meshData.getAttributeBuffer(_MeshData2.default.TEXCOORD0);
	var pos = meshData.getAttributeBuffer(_MeshData2.default.POSITION);
	var indices = meshData.getIndexBuffer();

	var mesh = this.mesh;
	var meshIndices = mesh.getIndexBuffer();
	var meshPos = mesh.getAttributeBuffer(_MeshData2.default.POSITION);
	var meshUV = mesh.getAttributeBuffer(_MeshData2.default.TEXCOORD0);
	var meshVertexCount = mesh.vertexCount;
	...
	meshData.setAttributeDataUpdated(_MeshData2.default.TEXCOORD0);
	meshData.setAttributeDataUpdated(_MeshData2.default.POSITION);
...
var tmpWorldPos = new _Vector2.default();
...
ParticleSystemComponent.prototype._sortParticles = function () {
	...
	while (l--) {
		...
		particle.sortValue = -particle.getWorldPosition(tmpWorldPos).dot(_Renderer2.default.mainCamera._direction);
	}
...
var tmpPos = new _Vector2.default();
var tmpDir = new _Vector2.default();
...
ParticleSystemComponent.prototype.attached = function (entity) {
	...
	attributeMap.TIME_INFO = _MeshData2.default.createAttribute(4, 'Float');
	attributeMap.START_POS = _MeshData2.default.createAttribute(4, 'Float');
	attributeMap.START_DIR = _MeshData2.default.createAttribute(4, 'Float');

	var maxParticles = this.maxParticles;
	var meshData = new _MeshData2.default(attributeMap, maxParticles * this.mesh.vertexCount, maxParticles * this.mesh.indexCount);
	meshData.vertexData.setDataUsage('DynamicDraw');
	this.meshData = meshData;

	var meshRendererComponent = new _MeshRendererComponent2.default(this.material);
