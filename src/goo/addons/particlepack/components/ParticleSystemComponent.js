...
ParticleSystemComponent.prototype._updateVertexData = function () {
	...
	var offset = meshData.getAttributeBuffer(MeshDatajs_TEXCOORD0);
	var pos = meshData.getAttributeBuffer(MeshDatajs_POSITION);
	var indices = meshData.getIndexBuffer();

	var mesh = this.mesh;
	var meshIndices = mesh.getIndexBuffer();
	var meshPos = mesh.getAttributeBuffer(MeshDatajs_POSITION);
	var meshUV = mesh.getAttributeBuffer(MeshDatajs_TEXCOORD0);
	var meshVertexCount = mesh.vertexCount;
	...
	meshData.setAttributeDataUpdated(MeshDatajs_TEXCOORD0);
	meshData.setAttributeDataUpdated(MeshDatajs_POSITION);
