...
function ParticleSystemSystem() {
	System_Systemjs.call(this, 'ParticleSystemSystem', ['ParticleSystemComponent', 'TransformComponent']);
	this.priority = 1;
}
ParticleSystemSystem.prototype = Object.create(System_Systemjs.prototype);
