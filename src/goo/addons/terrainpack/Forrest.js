...
var MathUtilsjs_randomSeed_binding = _MathUtils.randomSeed;
...
Forrest.prototype.update = function (x, z) {
	...
	for (var x = 0; x < this.gridSize; x++) {
		for (var z = 0; z < this.gridSize; z++) {
			...
			var modX = (0, _MathUtils.moduloPositive)(patchX, this.gridSize);
			var modZ = (0, _MathUtils.moduloPositive)(patchZ, this.gridSize);
...
Forrest.prototype.determineVegTypeAtPos = function (pos) {
	...
	return this.terrainQuery.getForrestType(pos[0], pos[2], slope, (0, _MathUtils.fastRandom)());
};

Forrest.prototype.fetchTreeMesh = function (vegetationType) {
	return (0, _EntityUtils.clone)(this.world, this.entityMap[vegetationType]);
};
...
Forrest.prototype.getPointInPatch = function (x, z, patchX, patchZ, patchSpacing) {
	var pos = [0, 0, 0];
	pos[0] = patchX + (x + (0, _MathUtils.fastRandom)() * 0.75) * patchSpacing;
	pos[2] = 0.5 + patchZ + (z + (0, _MathUtils.fastRandom)() * 0.75) * patchSpacing;
...
Forrest.prototype.addVegMeshToPatch = function (vegetationType, pos, meshBuilder, levelOfDetail, gridEntity) {
	...
	var size = (0, _MathUtils.fastRandom)() * 0.5 + 0.75;
...
Forrest.prototype.createForrestPatch = function (patchX, patchZ, levelOfDetail, gridEntity) {
	...
	MathUtilsjs_randomSeed_binding = patchX * 10000 + patchZ;
