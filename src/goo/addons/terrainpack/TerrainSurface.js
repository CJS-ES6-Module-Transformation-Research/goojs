...
exports.default = TerrainSurface;
...
TerrainSurface.prototype = Object.create(_MeshData2.default.prototype);
...
TerrainSurface.prototype.rebuild = function () {
	...
	for (var i = 0; i < nLines - 1; i++) {
		for (var j = 0; j < this.vertsPerLine - 1; j++) {
			...
			normals = _MathUtils2.default.getTriangleNormal(this.verts[upLeft * 3 + 0], this.verts[upLeft * 3 + 1], this.verts[upLeft * 3 + 2], this.verts[upRight * 3 + 0], this.verts[upRight * 3 + 1], this.verts[upRight * 3 + 2], this.verts[downLeft * 3 + 0], this.verts[downLeft * 3 + 1], this.verts[downLeft * 3 + 2]);
