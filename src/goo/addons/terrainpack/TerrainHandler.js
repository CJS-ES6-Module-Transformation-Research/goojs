	...
	return _rsvp.rsvpjs.all(promises).then(function (textures) {
		...
		var terrainQuery = this.terrainQuery = {
			getHeightAt: function (pos) {
				...
				col = (0, _MathUtils.moduloPositive)(col, terrainSize);
				row = (0, _MathUtils.moduloPositive)(row, terrainSize);
				col1 = (0, _MathUtils.moduloPositive)(col1, terrainSize);
				row1 = (0, _MathUtils.moduloPositive)(row1, terrainSize);
				...
				return (0, _MathUtils.lerp)(intOnZ, (0, _MathUtils.lerp)(intOnX, topLeft, topRight), (0, _MathUtils.lerp)(intOnX, bottomLeft, bottomRight));
			}.bind(this),
			...
			getVegetationType: function (xx, zz, slope) {
				...
				if ((0, _MathUtils.smoothstep)(0.82, 0.91, slope) < rand) {
					return null;
				}
			...
			getForrestType: function (xx, zz, slope, rand) {
				if ((0, _MathUtils.smoothstep)(0.8, 0.88, slope) < rand) {
					return null;
				}
			...
			getLightAt: function (pos) {
				...
				col = (0, _MathUtils.moduloPositive)(col, this.lightMapSize);
				row = (0, _MathUtils.moduloPositive)(row, this.lightMapSize);
				col1 = (0, _MathUtils.moduloPositive)(col1, this.lightMapSize);
				row1 = (0, _MathUtils.moduloPositive)(row1, this.lightMapSize);
				...
				return (0, _MathUtils.lerp)(intOnZ, (0, _MathUtils.lerp)(intOnX, topLeft, topRight), (0, _MathUtils.lerp)(intOnX, bottomLeft, bottomRight)) / 255.0;
			}.bind(this),
