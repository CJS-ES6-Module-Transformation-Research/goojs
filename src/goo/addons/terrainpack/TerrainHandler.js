...
TerrainHandler.prototype._textureLoad = function (url) {
	return new TextureCreatorjs().loadTexture2D(url, {
		anisotropy: 4
	});
};
...
TerrainHandler.prototype._load = function (terrainData, parentMipmap, splatMap, forrestLODEntityMap) {
	...
	return rsvp_rsvpjsjs.all(promises).then(function (textures) {
		...
		return new TextureCreatorjs().loadTexture2D(this.resourceFolder + terrainData.vegetationAtlas).then(function (vegetationAtlasTexture) {

			vegetationAtlasTexture.anisotropy = 4;
			var vegetationTypes = terrainData.vegetationTypes;

			return new TextureCreatorjs().loadTexture2D(this.resourceFolder + terrainData.forrestAtlas).then(function (forrestAtlasTexture) {

				forrestAtlasTexture.anisotropy = 4;

				return new TextureCreatorjs().loadTexture2D(this.resourceFolder + terrainData.forrestAtlasNormals).then(function (forrestAtlasNormals) {
