...
var inverseBodyTransform = new Transform_Transformjs();
var trans = new Transform_Transformjs();
var trans2 = new Transform_Transformjs();
...
AbstractRigidBodyComponent.prototype.traverseColliders = function (entity, callback) {
	...
	while (queue.length) {
		...
		if (collider) {
			...
			Transform_Transformjs.combine(inverseBodyTransform, trans, trans2);
