...
RigidBodyComponent.prototype.getInterpolatedPosition = function (targetVector) {
	...
	targetVector.setDirect(
		MathUtilsjs.lerp(t, prevPosition.x, currentPosition.x),
		MathUtilsjs.lerp(t, prevPosition.y, currentPosition.y),
		MathUtilsjs.lerp(t, prevPosition.z, currentPosition.z)
	);
};
...
RigidBodyComponent.prototype.getInterpolatedQuaternion = function (targetQuat) {
	...
	var t = this._system.world.interpolationTime;
	targetQuat.setDirect(
		MathUtilsjs.lerp(t, prevQuat.x, currentQuat.x),
		MathUtilsjs.lerp(t, prevQuat.y, currentQuat.y),
		MathUtilsjs.lerp(t, prevQuat.z, currentQuat.z),
		MathUtilsjs.lerp(t, prevQuat.w, currentQuat.w)
	);
};
...
RigidBodyComponent.prototype.addCollider = function (entity, position, quaternion) {
	...
	var cannonShape = colliderComponent.cannonShape = ColliderComponentjs.getCannonShape(collider);
