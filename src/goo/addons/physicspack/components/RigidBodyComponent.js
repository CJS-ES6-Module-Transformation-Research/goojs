...
RigidBodyComponent.prototype.getInterpolatedPosition = function (targetVector) {
	...
	targetVector.setDirect(MathUtils.lerp(t, prevPosition.x, currentPosition.x), MathUtils.lerp(t, prevPosition.y, currentPosition.y), MathUtils.lerp(t, prevPosition.z, currentPosition.z));
};
...
RigidBodyComponent.prototype.getInterpolatedQuaternion = function (targetQuat) {
	...
	var t = this._system.world.interpolationTime;
	targetQuat.setDirect(MathUtils.lerp(t, prevQuat.x, currentQuat.x), MathUtils.lerp(t, prevQuat.y, currentQuat.y), MathUtils.lerp(t, prevQuat.z, currentQuat.z), MathUtils.lerp(t, prevQuat.w, currentQuat.w));
};
