...
function BallJoint(settings) {
   ...
   * @type {Vector3}
   */
  this.localPivot = settings.localPivot ? Vector3js_fromAny(settings.localPivot) : new _Vector.Vector3(0, 0.5, 0);
   ...
   * @type {Vector3}
   */
  this.connectedLocalPivot = settings.connectedLocalPivot ? Vector3js_fromAny(settings.connectedLocalPivot) : new _Vector.Vector3(0, 0.5, 0);
}
