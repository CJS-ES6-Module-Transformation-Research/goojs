...
function BallJoint(settings) {
	 ...
	 * @type {Vector3}
	 */
	this.localPivot = settings.localPivot ? Vector3js.fromAny(settings.localPivot) : new Vector3js(0, 0.5, 0);
	 ...
	 * @type {Vector3}
	 */
	this.connectedLocalPivot = settings.connectedLocalPivot ? Vector3js.fromAny(settings.connectedLocalPivot) : new Vector3js(0, 0.5, 0);
}
