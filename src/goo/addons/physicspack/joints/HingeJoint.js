...
function HingeJoint(settings) {
	 ...
	 * @type {Vector3}
	 */
	this.localPivot = settings.localPivot ? new Vector3_Vector3js(settings.localPivot) : new Vector3_Vector3js(0, 0.5, 0);
	 ...
	 * @type {Vector3}
	 */
	this.connectedLocalPivot = settings.connectedLocalPivot ? new Vector3_Vector3js(settings.connectedLocalPivot) : new Vector3_Vector3js();

	/**
	 * @type {Vector3}
	 */
	this.localAxis = settings.localAxis ? new Vector3_Vector3js(settings.localAxis) : new Vector3_Vector3js(1, 0, 0);
}
