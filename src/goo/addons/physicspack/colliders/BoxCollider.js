...
function BoxCollider(settings) {
	 ...
	 * @type {Vector3}
	 */
	this.halfExtents = settings.halfExtents ? new Vector3_Vector3js(settings.halfExtents) : new Vector3_Vector3js(0.5, 0.5, 0.5);

	Collider_Colliderjs.call(this);
}
BoxCollider.prototype = Object.create(Collider_Colliderjs.prototype);
