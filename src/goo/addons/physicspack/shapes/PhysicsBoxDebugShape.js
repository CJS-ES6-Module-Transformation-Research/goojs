...
exports.default = PhysicsBoxDebugShape;
...
function PhysicsBoxDebugShape() {
	...
	_MeshData2.default.call(this, attributeMap, 3 * 8, 2 * 4 * 3);
	this.indexModes[0] = 'Lines';
	this.rebuild();
}

PhysicsBoxDebugShape.prototype = Object.create(_MeshData2.default.prototype);
