...
function PhysicsSphereDebugShape(numSegments) {
	...
	MeshData_MeshDatajs.call(this, attributeMap, 3 * 3 * numSegments, 3 * 2 * numSegments);
	this.indexModes[0] = 'Lines';
	this.rebuild();
}
PhysicsSphereDebugShape.prototype = Object.create(MeshData_MeshDatajs.prototype);
