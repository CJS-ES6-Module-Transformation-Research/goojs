...
function RaycastResult(settings) {
	 ...
	 * @type {Vector3}
	 */
	this.point = settings.point ? new Vector3_Vector3js(settings.point) : new Vector3_Vector3js();

	/**
	 * The normal of the surface the ray hit.
	 * @type {Vector3}
	 */
	this.normal = settings.normal ? new Vector3_Vector3js(settings.normal) : new Vector3_Vector3js();
