...
function CannonSystem(settings) {
	System_Systemjs.call(this, 'CannonSystem', ['CannonRigidbodyComponent', 'TransformComponent']);

	settings = settings || {};

	ObjectUtils_ObjectUtilsjs.defaults(settings, {
		gravity: new Vector3_Vector3js(0, -10, 0),
		stepFrequency: 60,
		broadphase: 'naive'
	});
...
CannonSystem.prototype = Object.create(System_Systemjs.prototype);
