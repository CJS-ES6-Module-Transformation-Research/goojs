...
function CannonSystem(settings) {
	Systemjs.call(this, 'CannonSystem', ['CannonRigidbodyComponent', 'TransformComponent']);

	settings = settings || {};

	ObjectUtilsjs.defaults(settings, {
		gravity: new Vector3js(0, -10, 0),
		stepFrequency: 60,
		broadphase: 'naive'
	});
...
CannonSystem.prototype = Object.create(Systemjs.prototype);
