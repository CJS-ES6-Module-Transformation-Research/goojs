...
MeshData.prototype.rebuildVertexData = function (vertexCount) {
	...
	if (this.vertexCount > 0) {
		...
		for (var i = 0; i < keys.length; i++) {
			...
			vertexByteSize += _RendererUtils2.default.getByteSize(attribute.type) * attribute.count;
		}
		this.vertexData = new _BufferData2.default(new ArrayBuffer(vertexByteSize * this.vertexCount), 'ArrayBuffer');
...
MeshData.prototype.rebuildIndexData = function (indexCount) {
	...
	if (this.indexCount > 0) {
		var indices = _BufferUtils2.default.createIndexBuffer(this.indexCount, this.vertexCount);
		this.indexData = new _BufferData2.default(indices, 'ElementArrayBuffer');
	} else {
		this.indexData = null;
		this.indexLengths = null;
		this.indexModes = ['Triangles'];
...
MeshData.prototype.generateAttributeData = function () {
	...
	for (var key in this.attributeMap) {
		...
		offset += length * _RendererUtils2.default.getByteSize(attribute.type);
...
MeshData.prototype.makeInterleavedData = function () {
	...
	for (var key in this.attributeMap) {
		...
		stride += attribute.count * _RendererUtils2.default.getByteSize(attribute.type);
	}

	var newVertexData = new _BufferData2.default(new ArrayBuffer(stride * this.vertexCount), this.vertexData.target);
	...
	for (var key in this.attributeMap) {
		...
		var size = _RendererUtils2.default.getByteSize(attribute.type);
...
MeshData.prototype.buildWireframeData = function () {
	var attributeMap = _ObjectUtils2.default.deepClone(this.attributeMap);
...
// Calculation helpers
var v1 = new _Vector4.default();
var v2 = new _Vector4.default();
var v3 = new _Vector4.default();
/**
...
MeshData.prototype.clone = function () {
	var attributeMapClone = _ObjectUtils2.default.deepClone(this.attributeMap);
...
function buildMap(types) {
	...
	for (var i = 0; i < types.length; i++) {
		...
		if (defaults[type] !== undefined) {
			map[type] = _ObjectUtils2.default.deepClone(defaults[type]);
		} else {
