...
function Texture(image, settings, width, height) {
	...
	ObjectUtils_ObjectUtilsjs.copyOptions(this, settings, {
		wrapS: 'Repeat',
		wrapT: 'Repeat',
		magFilter: 'Bilinear',
		minFilter: 'Trilinear',
	...
	this.offset = settings.offset ?	Vector2_Vector2js.fromAny(settings.offset) : new Vector2_Vector2js(0, 0);
	this.repeat = settings.repeat ? Vector2_Vector2js.fromAny(settings.repeat) : new Vector2_Vector2js(1, 1);
	 ...
	 * @type {Function}
	 */
	this.loadImage = PromiseUtils_PromiseUtilsjs.resolve.bind(null, this);
