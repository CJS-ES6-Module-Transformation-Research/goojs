...
function Texture(image, settings, width, height) {
  ...
  */
	...
	this.offset = settings.offset ? Vector2js_fromAny(settings.offset) : new _Vector.Vector2(0, 0);
	this.repeat = settings.repeat ? Vector2js_fromAny(settings.repeat) : new _Vector.Vector2(1, 1);
