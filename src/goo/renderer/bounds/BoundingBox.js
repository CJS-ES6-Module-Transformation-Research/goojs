...
BoundingBox.prototype.testStaticAABBAABB = function (bb, contact) {
	...
	// [X Axis]
	if (!this.testAxisStatic(Vector3js_UNIT_X, a.center.x - a.xExtent, a.center.x + a.xExtent, b.center.x - b.xExtent, b.center.x + b.xExtent, mtvInfo)) {
		return false;
	}

	// [Y Axis]
	if (!this.testAxisStatic(Vector3js_UNIT_Y, a.center.y - a.yExtent, a.center.y + a.yExtent, b.center.y - b.yExtent, b.center.y + b.yExtent, mtvInfo)) {
		return false;
	}

	// [Z Axis]
	if (!this.testAxisStatic(Vector3js_UNIT_Z, a.center.z - a.zExtent, a.center.z + a.zExtent, b.center.z - b.zExtent, b.center.z + b.zExtent, mtvInfo)) {
		return false;
	}
 ...
 */
exports.BoundingBox = exported_BoundingBox;
