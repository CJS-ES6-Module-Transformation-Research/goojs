...
TextureCreator.prototype.loadTexture2D = function (imageUrl, settings) {
	var id = (0, _StringUtils.createUniqueId)('texture');
	settings = settings || {};
...
exports.DEFAULT_TEXTURE_2D = TextureCreator_DEFAULT_TEXTURE_2D = new _Texture.Texture(colorInfo, null, 1, 1);;
exports.DEFAULT_TEXTURE_CUBE = TextureCreator_DEFAULT_TEXTURE_CUBE = new _Texture.Texture([colorInfo, colorInfo, colorInfo, colorInfo, colorInfo, colorInfo], null, 1, 1);;
TextureCreator_DEFAULT_TEXTURE_CUBE.variant = 'CUBE';

exports.DEFAULT_TEXTURE_2D = TextureCreator_DEFAULT_TEXTURE_2D;
exports.DEFAULT_TEXTURE_CUBE = TextureCreator_DEFAULT_TEXTURE_CUBE;
