...
function TextureCreator() {
	...
	this.textureHandler = new TextureHandler_TextureHandlerjs(
		{},
...
TextureCreator.prototype.loadTexture2D = function (imageUrl, settings) {
	var id = StringUtils_StringUtilsjs.createUniqueId('texture');
	settings = settings || {};
...
TextureCreator.prototype.loadTextureWebCam = function () {
	...
	return PromiseUtils_PromiseUtilsjs.createPromise(function (resolve, reject) {
		...
		var texture = new Texture_Texturejs(video, {
			wrapS: 'EdgeClamp',
			wrapT: 'EdgeClamp'
		});
...
TextureCreator.prototype.loadTextureCube = function (imageDataArray, settings) {
	var texture = new Texture_Texturejs(null, settings);
...
TextureCreator.DEFAULT_TEXTURE_2D = new Texture_Texturejs(colorInfo, null, 1, 1);
TextureCreator.DEFAULT_TEXTURE_CUBE = new Texture_Texturejs([colorInfo, colorInfo, colorInfo, colorInfo, colorInfo, colorInfo], null, 1, 1);
