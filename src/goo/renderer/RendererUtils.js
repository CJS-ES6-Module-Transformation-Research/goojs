...
var functionObject_getByteSize = function(type) {
    var byteSize;
...
var functionObject_checkGLError = function(gl) {
    var error = gl.getError();
    var wasError = false;
    while (error !== gl.NO_ERROR) {
        wasError = true;
...
var functionObject_isPowerOfTwo = MathUtils.isPowerOfTwo;
...
var functionObject_nearestPowerOfTwo = MathUtils.nearestPowerOfTwo;
...
var functionObject_clone = ObjectUtils.deepClone;
...
RendererUtils.getBlankImage = function (texture, color, width, height, maxSize, index) {
	...
	if (!canvas) {
        ...
        var functionObject_cacheKey = canvas;
    }
	if (index === undefined) {
...
var functionObject_getBlankImage = function(texture, color, width, height, maxSize, index) {
    var newWidth = MathUtils.nearestPowerOfTwo(width);
    var newHeight = MathUtils.nearestPowerOfTwo(height);
    newWidth = Math.min(newWidth, maxSize);
    newHeight = Math.min(newHeight, maxSize);
...
var functionObject_scaleImage = function(texture, image, width, height, maxSize, index) {
    var newWidth = MathUtils.nearestPowerOfTwo(width);
    var newHeight = MathUtils.nearestPowerOfTwo(height);
    newWidth = Math.min(newWidth, maxSize);
    newHeight = Math.min(newHeight, maxSize);
...
var functionObject_getGLType = function(context, type) {
    var glType;
...
var functionObject_getGLWrap = function(context, wrap) {
    var glWrap;
...
var functionObject_getGLInternalFormat = function(context, format) {
    var glInternalFormat;
...
var functionObject_getGLPixelDataType = function(context, type) {
...
var functionObject_getGLDataType = function(context, type) {
    var glDataType;
...
var functionObject_getFilterFallback = function(filter) {
    var filterFallback;
...
var functionObject_getGLMagFilter = function(context, filter) {
    var glMagFilter;
...
var functionObject_getGLMinFilter = function(context, filter) {
    var glMinFilter;
...
var functionObject_getGLBufferTarget = function(context, target) {
    if (target === "ElementArrayBuffer") {
        return context.ELEMENT_ARRAY_BUFFER;
    }
...
var functionObject_getGLArrayType = function(context, indices) {
    var glArrayType = null;
...
var functionObject_getGLByteSize = function(indices) {
    return indices.BYTES_PER_ELEMENT || 1;
};
...
var functionObject_getGLCubeMapFace = function(context, face) {
    var glCubeMapFace;
...
var functionObject_getGLBufferUsage = function(context, usage) {
    var glMode;
...
var functionObject_getGLIndexMode = function(context, indexMode) {
    var glMode;
...
var functionObject_getGLDepthFunc = function(context, depthFunc) {
    var glDepthFunc;
...
var functionObject_getGLBlendParam = function(context, param) {
    var glBlendParam;
