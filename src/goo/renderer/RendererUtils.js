 ...
 */
RendererUtils_isPowerOfTwo = _MathUtils.MathUtils.isPowerOfTwo;;
 ...
 */
RendererUtils_nearestPowerOfTwo = _MathUtils.MathUtils.nearestPowerOfTwo;;
 ...
 */
exports.clone = RendererUtils_clone = _ObjectUtils.deepClone;;
...
exports.getBlankImage = RendererUtils_getBlankImage = function RendererUtils_getBlankImage(texture, color, width, height, maxSize, index) {
    var newWidth = _MathUtils.MathUtils.nearestPowerOfTwo(width);
    var newHeight = _MathUtils.MathUtils.nearestPowerOfTwo(height);
...
exports.clone = RendererUtils_clone;
