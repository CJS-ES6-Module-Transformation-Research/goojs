 ...
 */
RendererUtils.isPowerOfTwo = MathUtils_MathUtilsjs.isPowerOfTwo;
 ...
 */
RendererUtils.nearestPowerOfTwo = MathUtils_MathUtilsjs.nearestPowerOfTwo;
 ...
 */
RendererUtils.clone = ObjectUtils_ObjectUtilsjs.deepClone;

RendererUtils._blankImages = {};
RendererUtils.getBlankImage = function (texture, color, width, height, maxSize, index) {
	var newWidth = MathUtils_MathUtilsjs.nearestPowerOfTwo(width);
	var newHeight = MathUtils_MathUtilsjs.nearestPowerOfTwo(height);
...
RendererUtils.getGLDataType = function (context, type) {
	...
	switch (type) {
		...
		case 'UnsignedShort5551':
			...
			break;
		case 'HalfFloat':
			glDataType = Capabilities_Capabilitiesjs.TextureHalfFloat.HALF_FLOAT_OES;
			break;
