...
var RendererUtils__blankImages;
var RendererUtils_clone;
var RendererUtils_nearestPowerOfTwo;
var RendererUtils_isPowerOfTwo;
 ...
 */
RendererUtils_isPowerOfTwo = MathUtilsjs.isPowerOfTwo;;
 ...
 */
RendererUtils_nearestPowerOfTwo = MathUtilsjs.nearestPowerOfTwo;;
 ...
 */
RendererUtils_clone = ObjectUtilsjs_deepClone;;

RendererUtils__blankImages = {};;
RendererUtils_getBlankImage = function(texture, color, width, height, maxSize, index) {
    var newWidth = MathUtilsjs.nearestPowerOfTwo(width);
    var newHeight = MathUtilsjs.nearestPowerOfTwo(height);
    ...
    var canvas = RendererUtils__blankImages[cacheKey];
    if (!canvas) {
        ...
        ctx.fill();
        RendererUtils__blankImages[cacheKey] = canvas;
    }
    if (index === undefined) {
...
RendererUtils_getGLDataType = function(context, type) {
    ...
    case "UnsignedShort5551":
        ...
        break;
    case "HalfFloat":
        glDataType = Capabilitiesjs.TextureHalfFloat.HALF_FLOAT_OES;
        break;
    default:
