var RenderPass_RenderPass = RenderPass;
...
function RenderPass(renderList, filter) {
	...
	this.clearColor = new mathVector4_Vector4js(0.0, 0.0, 0.0, 0.0);
	this.oldClearColor = new mathVector4_Vector4js();
...
RenderPass.prototype = Object.create(rendererpassPass_Passjs.prototype);
...
RenderPass.prototype.render = function (renderer, writeBuffer, readBuffer, delta, maskActive, camera, lights, clearColor) {
	camera = camera || rendererRenderer_Rendererjs.mainCamera;
 ...
 */
export { RenderPass_RenderPass as RenderPass };