...
function Light(color) {
	 ...
	 * @type {Vector3}
	 */
	this.translation = new mathVector3_Vector3js();

	/**
	 * The color of the light
	 * @type {Vector3}
	 */
	this.color = color ? color.clone() : new mathVector3_Vector3js(1, 1, 1);
	...
	this.shadowSettings = {
		...
		far: 1000,
		resolution: [512, 512],
		upVector: mathVector3_Vector3js.UNIT_Y.clone(),
		darkness: 1.0,
		shadowOffset: -0.001,
		shadowType: 'VSM'
	};
