...
ShaderLib_uber = {
    ...
    attributes: {
        ...
        vertexTangent: MeshDatajs_TANGENT,
        vertexColor: MeshDatajs_COLOR,
        vertexUV0: MeshDatajs_TEXCOORD0,
        vertexUV1: MeshDatajs_TEXCOORD1,
    ...
    uniforms: {
        ...
        specularMap: Shaderjs_SPECULAR_MAP,
        emissiveMap: Shaderjs_EMISSIVE_MAP,
        aoMap: Shaderjs_AO_MAP,
        lightMap: Shaderjs_LIGHT_MAP,
...
ShaderLib_lightDepth = {
    ...
    uniforms: {
        ...
        projectionMatrix: Shaderjs_PROJECTION_MATRIX,
        worldMatrix: Shaderjs_WORLD_MATRIX,
        cameraScale: Shaderjs_MAIN_DEPTH_SCALE
    },
