...
ShaderLib.uber = {
	processors: [
		ShaderBuilder_ShaderBuilder.uber.processor,
		ShaderBuilder_ShaderBuilder.light.processor,
		ShaderBuilder_ShaderBuilder.animation.processor
	],
	attributes: {
		vertexPosition: MeshData_MeshData.POSITION,
		vertexNormal: MeshData_MeshData.NORMAL,
		vertexTangent: MeshData_MeshData.TANGENT,
		vertexColor: MeshData_MeshData.COLOR,
		vertexUV0: MeshData_MeshData.TEXCOORD0,
		vertexUV1: MeshData_MeshData.TEXCOORD1,
		vertexJointIDs: MeshData_MeshData.JOINTIDS,
		vertexWeights: MeshData_MeshData.WEIGHTS
	},
	uniforms: {
		...
		specularMap: Shader_Shader.SPECULAR_MAP,
		emissiveMap: Shader_Shader.EMISSIVE_MAP,
		aoMap: Shader_Shader.AO_MAP,
		lightMap: Shader_Shader.LIGHT_MAP,
	...
	vshader: function () {
		...
		ShaderBuilder_ShaderBuilder.animation.prevertex,
		...
		'void main(void) {',
			...
			'#endif',
			ShaderBuilder_ShaderBuilder.animation.vertex,
...
ShaderLib.convolution = {
	...
	attributes: {
		position: MeshData_MeshData.POSITION,
		uv: MeshData_MeshData.TEXCOORD0
	},
	uniforms: {
		viewMatrix: Shader_Shader.VIEW_MATRIX,
		projectionMatrix: Shader_Shader.PROJECTION_MATRIX,
		worldMatrix: Shader_Shader.WORLD_MATRIX,
		tDiffuse: Shader_Shader.DIFFUSE_MAP,
...
ShaderLib.lightDepth = {
	...
	uniforms: {
		...
		projectionMatrix: Shader_Shader.PROJECTION_MATRIX,
		worldMatrix: Shader_Shader.WORLD_MATRIX,
		cameraScale: Shader_Shader.MAIN_DEPTH_SCALE
	},
	vshader: [
	'attribute vec3 vertexPosition;',
 ...
 * There are more special purpose shaders in {@link ShaderLibExtra}
 */
export { mod_ShaderLib as ShaderLib };
