...
import { TangentGenerator as TangentGeneratorjs } from "../../util/TangentGenerator";
...
ShaderBuilder.uber = {
	...
	normalTangents: function (shader, shaderInfo) {
		//TODO: Hacky?
		if (shader.hasDefine('NORMAL') && shader.hasDefine('NORMAL_MAP') && !shaderInfo.meshData.getAttributeBuffer(MeshDatajs.TANGENT)) {
			TangentGeneratorjs.addTangentBuffer(shaderInfo.meshData);
		}
	},
