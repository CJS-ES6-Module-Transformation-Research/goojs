...
function ShadowHandler() {
	this.depthMaterial = new rendererMaterial_Materialjs(ShaderLibjs_lightDepth, 'depthMaterial');
	...
	this.downsample = rendererMaterial_Materialjs.createShader(ShaderLibjs_downsample, 'downsample');

	var sigma = 2;
	this.blurfilter = rendererMaterial_Materialjs.createShader(ShaderLibjs_convolution, 'blurfilter');
