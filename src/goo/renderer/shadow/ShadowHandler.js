...
function ShadowHandler() {
	this.depthMaterial = new _Material.Material(ShaderLib.lightDepth, 'depthMaterial');
	...
	this.downsample = _Material.Material.createShader(ShaderLib.downsample, 'downsample');

	var sigma = 2;
	this.blurfilter = _Material.Material.createShader(ShaderLib.convolution, 'blurfilter');
