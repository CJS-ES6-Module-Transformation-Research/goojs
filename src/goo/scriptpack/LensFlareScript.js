...
function FlareQuad(lightColor, tx, displace, size, intensity, systemScale, edgeDampen, edgeScaling, textures, world) {
	...
	var material = new rendererMaterial_Materialjs(renderershadersShaderLib_ShaderLibjs.uber, 'flareShader');
...
var exported_LensFlareScript = LensFlareScript;

/**
 * This script makes an entity shine with some lensflare effect.
 */
export { exported_LensFlareScript as LensFlareScript };