...
function LensFlareScript() {
	...
	function generateTextures(txSize) {
		...
		textures.splash = (0, _ParticleSystemUtils.createSplashTexture)(512, { trailStartRadius: 25, trailEndRadius: 0 });
		textures.ring = (0, _ParticleSystemUtils.createFlareTexture)(txSize, { steps: textureShapes.ring, startRadius: txSize / 4, endRadius: txSize / 2 });
		textures.dot = (0, _ParticleSystemUtils.createFlareTexture)(txSize, { steps: textureShapes.dot, startRadius: 0, endRadius: txSize / 2 });
		textures.bell = (0, _ParticleSystemUtils.createFlareTexture)(txSize, { steps: textureShapes.bell, startRadius: 0, endRadius: txSize / 2 });
		textures['default'] = (0, _ParticleSystemUtils.createFlareTexture)(txSize, { steps: textureShapes.none, startRadius: 0, endRadius: txSize / 2 });
	}
...
function FlareQuad(lightColor, tx, displace, size, intensity, systemScale, edgeDampen, edgeScaling, textures, world) {
	...
	var material = new _Material.Material(_ShaderLib.uber, 'flareShader');
...
exports.LensFlareScript = LensFlareScript;
