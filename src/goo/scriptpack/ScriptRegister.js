...
for (var key in scriptsOrbitCamControlScript_OrbitCamControlScript) {
	scriptsScripts_Scriptsjs.register(scriptsOrbitCamControlScript_OrbitCamControlScript[key]);
}
