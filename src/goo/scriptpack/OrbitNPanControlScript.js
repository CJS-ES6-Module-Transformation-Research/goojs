...
import { PanCamScript as PanCamControlScriptjs } from "../scriptpack/PanCamScript";
import { ObjectUtils as ObjectUtilsjs } from "../util/ObjectUtils";
var OrbitNPanControlScript_externals;

function OrbitNPan() {
	var orbitScript = Scripts.create(OrbitCamControlScriptjs);
	var panScript = Scripts.create(PanCamControlScriptjs);
...
var orbitParams = OrbitCamControlScriptjs.externals.parameters;
var panParams = PanCamControlScriptjs.externals.parameters;

// Make sure we don't change parameters for the other scripts
var params = ObjectUtilsjs.deepClone(orbitParams.concat(panParams.slice(1)));
