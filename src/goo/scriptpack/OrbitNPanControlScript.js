...
function OrbitNPan() {
	var orbitScript = _Scripts.Scripts.create(_OrbitCamControlScript.OrbitCamControlScript);
	var panScript = _Scripts.Scripts.create(_PanCamScript.PanCamScript);
...
exports.OrbitNPan = exported_OrbitNPan;
