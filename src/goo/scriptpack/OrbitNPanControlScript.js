...
function OrbitNPan() {
	var orbitScript = Scriptsjs_create(scriptsOrbitCamControlScript_OrbitCamControlScriptjs);
	var panScript = Scriptsjs_create(scriptpackPanCamScript_PanCamScriptjs);
...
export { OrbitNPanControlScript_OrbitNPan as OrbitNPan };