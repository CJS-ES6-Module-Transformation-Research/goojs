...
function PanCamScript() {
	...
	function setup(parameters, environment) {
		...
		fwdVector = Vector3_Vector3js.UNIT_Y.clone();
		leftVector = Vector3_Vector3js.UNIT_X.clone().negate();
		calcVector = new Vector3_Vector3js();
		calcVector2 = new Vector3_Vector3js();
