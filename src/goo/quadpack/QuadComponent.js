...
function QuadComponent(image, settings) {
	...
	(0, _ObjectUtils.defaults)(settings, defaults); //! AT: this will mutate settings which is BAD!!!
  ...
  * @type {Material}
  */
	this.material = new _Material.Material(_ShaderLib.uber, 'QuadComponent default material');
