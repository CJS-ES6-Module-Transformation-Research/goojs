...
function QuadComponent(image, settings) {
	...
	ObjectUtilsjs_defaults(settings, defaults); //! AT: this will mutate settings which is BAD!!!
	 ...
	 * @type {Material}
	 */
	this.material = new Materialjs(ShaderLibjs_uber, 'QuadComponent default material');
