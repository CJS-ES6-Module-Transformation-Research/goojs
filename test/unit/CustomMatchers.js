...
var functionObject_toBeCloned;
var functionObject_toBeCloseToArray;
var functionObject_toBeCloseToMatrix;
var functionObject_toBeCloseToVector;
...
functionObject_toBeCloseToVector = function(util, customEqualityTesters) {
    return {
...
functionObject_toBeCloseToMatrix = function(util, customEqualityTesters) {
    return {
        compare: function(actual, expected) {
            var result = {};
...
functionObject_toBeCloseToArray = function(util, customEqualityTesters) {
    return {
        compare: function(actual, expected) {
            var result = {};
...
functionObject_toBeCloned = function(util, customEqualityTesters) {
    ...
    return {
        compare: function(actual, expected) {
            ...
            if (typeof expected === "object" && expected.hasOwnProperty("value") && expected.hasOwnProperty("excluded")) {
                excluded = new Set();
