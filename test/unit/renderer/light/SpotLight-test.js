...
describe('SpotLight', function () {
	...
	it('gets the color from the first parameter passed to the constructor', function () {
		...
		var light = new SpotLight_SpotLightjs(color);
	...
	describe('copy', function () {
		it('can copy everything from another point light', function () {
			var original = new SpotLight_SpotLightjs(new Vector3_Vector3js(11, 22, 33));
			var copy = new SpotLight_SpotLightjs(new Vector3_Vector3js(44, 55, 66));
			copy.copy(original);
