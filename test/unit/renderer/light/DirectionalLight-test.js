...
describe('DirectionalLight', function () {
	...
	it('gets the color from the first parameter passed to the constructor', function () {
		...
		var light = new DirectionalLightjs(color);
	...
	describe('copy', function () {
		it('can copy everything from another point light', function () {
			var original = new DirectionalLightjs(new Vector3js(11, 22, 33));
			var copy = new DirectionalLightjs(new Vector3js(44, 55, 66));
			copy.copy(original);
