...
describe('DirectionalLight', function () {
	...
	it('gets the color from the first parameter passed to the constructor', function () {
		...
		var light = new DirectionalLight_DirectionalLight(color);
	...
	describe('copy', function () {
		it('can copy everything from another point light', function () {
			var original = new DirectionalLight_DirectionalLight(new Vector3_Vector3(11, 22, 33));
			var copy = new DirectionalLight_DirectionalLight(new Vector3_Vector3(44, 55, 66));
			copy.copy(original);
