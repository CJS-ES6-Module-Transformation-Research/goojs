...
describe('MeshData', function () {
		...
		it('can translate vertices', function () {
				...
				transform.update();
				box.applyTransform(_MeshData.MeshData.POSITION, transform);
		...
		it('can apply a function on vertices', function () {
				...
				box.applyFunction(_MeshData.MeshData.POSITION, function (vert) {
		...
		it('can get attribute buffer', function () {
				...
				expect(getAttributeBuffer(_MeshData.MeshData.POSITION)).toBeDefined();
				expect(getAttributeBuffer(_MeshData.MeshData.NORMAL)).toBeDefined();
				expect(getAttributeBuffer(_MeshData.MeshData.COLOR)).toBeUndefined();
				expect(getAttributeBuffer(_MeshData.MeshData.TANGENT)).toBeUndefined();
				expect(getAttributeBuffer(_MeshData.MeshData.TEXCOORD0)).toBeDefined();
				expect(getAttributeBuffer(_MeshData.MeshData.TEXCOORD1)).toBeUndefined();
				expect(getAttributeBuffer(_MeshData.MeshData.TEXCOORD2)).toBeUndefined();
				expect(getAttributeBuffer(_MeshData.MeshData.TEXCOORD3)).toBeUndefined();
				expect(getAttributeBuffer(_MeshData.MeshData.WEIGHTS)).toBeUndefined();
				expect(getAttributeBuffer(_MeshData.MeshData.JOINTIDS)).toBeUndefined();
		});
});