import { TextureCreator as srcgoorendererTextureCreator_TextureCreatorjs } from "../../../src/goo/renderer/TextureCreator";
...
describe('TextureCreator', function () {
	...
	beforeEach(function () {
		textureCreator = new srcgoorendererTextureCreator_TextureCreatorjs();
		callbacks = {
