...
describe('ArrayUtils', function () {
			describe('fromKeys', function () {
						it('returns an empty array for an empty collection', function () {
									...
									var setKeys = (0, _ArrayUtils.fromKeys)(set_);
									var mapKeys = (0, _ArrayUtils.fromKeys)(map);
			...
			describe('fromValues', function () {
						it('returns an empty array for an empty collection', function () {
									...
									var setKeys = (0, _ArrayUtils.fromValues)(set_);
									var mapKeys = (0, _ArrayUtils.fromValues)(map);
