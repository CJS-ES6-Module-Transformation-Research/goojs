...
describe('ArrayUtils', function () {
	describe('fromKeys', function () {
		it('returns an empty array for an empty collection', function () {
			...
			var setKeys = ArrayUtils_ArrayUtilsjs.fromKeys(set_);
			var mapKeys = ArrayUtils_ArrayUtilsjs.fromKeys(map);
	...
	describe('fromValues', function () {
		it('returns an empty array for an empty collection', function () {
			...
			var setKeys = ArrayUtils_ArrayUtilsjs.fromValues(set_);
			var mapKeys = ArrayUtils_ArrayUtilsjs.fromValues(map);
