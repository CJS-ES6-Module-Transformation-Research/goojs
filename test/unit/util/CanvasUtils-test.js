import { CanvasUtils as srcgooutilCanvasUtils_CanvasUtilsjs } from "../../../src/goo/util/CanvasUtils";
...
describe('CanvasUtils', function () {
	describe('Rendering an SVG to canvas', function () {
		...
		it('should create an canvas element with the given dimensions', function (done) {
			...
			srcgooutilCanvasUtils_CanvasUtilsjs.renderSvgToCanvas(data, options, function (canvas) {
