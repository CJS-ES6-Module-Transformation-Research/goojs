...
describe('ObjectUtils', function () {
	...
	describe('defaults', function () {
		it('copies defaults onto an empty object', function () {
			...
			srcgooutilObjectUtils_ObjectUtilsjs.defaults(destination, source);
	...
	describe('copyOptions', function () {
		it('copies defaults onto an empty object', function () {
			...
			srcgooutilObjectUtils_ObjectUtilsjs.copyOptions(destination, options, defaults);
	...
	describe('extends', function () {
		it('copies properties onto an empty object', function () {
			...
			srcgooutilObjectUtils_ObjectUtilsjs.extend(destination, source);
	...
	describe('forEach', function () {
		it('iterates over objects\' keys', function () {
			...
			srcgooutilObjectUtils_ObjectUtilsjs.forEach(obj, spy, null, 'sortValue');
	...
	describe('cloneMap', function () {
		it('clones an empty map', function () {
			...
			var clonedMap = srcgooutilObjectUtils_ObjectUtilsjs.cloneMap(originalMap);
	...
	describe('cloneSet', function () {
		it('clones an empty set', function () {
			...
			var clonedSet = srcgooutilObjectUtils_ObjectUtilsjs.cloneSet(originalSet);
	...
	describe('deepClone', function () {
		var clone = srcgooutilObjectUtils_ObjectUtilsjs.deepClone;
