import { EventTarget as EventTarget_EventTarget } from "../../../src/goo/util/EventTarget";

function Test() {
	EventTarget_EventTarget.apply(this, arguments);
}
Test.prototype = Object.create(EventTarget_EventTarget.prototype);
