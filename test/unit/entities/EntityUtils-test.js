...
describe('EntityUtils', function () {
	...
	it('can get the root entity', function () {
		...
		expect(EntityUtilsjs.getRoot(e1)).toBe(e1);
		expect(EntityUtilsjs.getRoot(e2)).toBe(e1);
		expect(EntityUtilsjs.getRoot(e3)).toBe(e1);
	});
	...
	it('can get the total bounding box', function () {
		...
		var bb = EntityUtilsjs.getTotalBoundingBox(e1);
