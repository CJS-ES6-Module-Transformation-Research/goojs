...
describe('EntityUtils', function () {
	...
	it('can get the root entity', function () {
		...
		expect((0, _EntityUtils.getRoot)(e1)).toBe(e1);
		expect((0, _EntityUtils.getRoot)(e2)).toBe(e1);
		expect((0, _EntityUtils.getRoot)(e3)).toBe(e1);
	});
	...
	it('can get the total bounding box', function () {
		...
		var bb = (0, _EntityUtils.getTotalBoundingBox)(e1);
