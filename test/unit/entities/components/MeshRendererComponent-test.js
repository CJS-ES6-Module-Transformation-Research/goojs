...
} from "../../../../src/goo/renderer/shaders/ShaderLib";
...
describe('MeshRendererComponent', function () {
	...
	describe('.applyOnEntity', function () {
		it('sets a MeshRendererComponent when trying to add a Material', function () {
			...
			var material = new srcgoorendererMaterial_Materialjs(ShaderLibjs_simpleColored, '');
			entity.set(material);
	...
	describe('on-entity api', function () {
		...
		beforeEach(function () {
			meshRendererComponent = new srcgooentitiescomponentsMeshRendererComponent_MeshRendererComponentjs(ShaderLibjs_simpleLit);
