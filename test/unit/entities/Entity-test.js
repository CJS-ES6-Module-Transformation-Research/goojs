...
describe('Entity', function () {
	...
	it('setComponent', function () {
		var entity = world.createEntity();
		entity.setComponent(new MeshDataComponent_MeshDataComponentjs());
		expect(entity.meshDataComponent !== undefined).toBe(true);
	});

	it('cannot add the same component twice', function () {
		var entity = world.createEntity();
		var component = new MeshDataComponent_MeshDataComponentjs();
	...
	it('discards the second added component of the same type', function () {
		var entity = world.createEntity();
		var component1 = new MeshDataComponent_MeshDataComponentjs();
		var component2 = new MeshDataComponent_MeshDataComponentjs();
	...
	it('getComponent', function () {
		var entity = world.createEntity();
		var mdc = new MeshDataComponent_MeshDataComponentjs();
	...
	it('clears a component', function () {
		var entity = world.createEntity();
		entity.setComponent(new MeshDataComponent_MeshDataComponentjs());
		entity.setComponent(new MeshRendererComponent_MeshRendererComponentjs());
		world.process();
	...
	it('does not override existing methods on install', function () {
		...
		FishComponent.prototype = Object.create(Component_Componentjs.prototype);
		...
		BananaComponent.prototype = Object.create(Component_Componentjs.prototype);
	...
	*/
	...
	it('can add components on a world-less entity', function () {
		var entity = new Entity_Entityjs();
		entity.setComponent(new CameraComponent_CameraComponentjs());
		expect(entity.cameraComponent).toBeTruthy();
	});
