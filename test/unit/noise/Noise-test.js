import { Noise as srcgoonoiseNoise_Noisejs } from "../../../src/goo/noise/Noise";
...
describe('Noise.fractal2d', function () {
	it('Contains correctly generated values', function () {
		...
		for (var y = 0; y < N; y++) {
			for (var x = 0; x < N; x++) {
				var offset = (y * N + x);
				var value = Math.floor(srcgoonoiseNoise_Noisejs.fractal2d(x, y, 256.0, 16, 0.75, 2.0, srcgoonoiseValueNoise_ValueNoisejs) * 255.0);
