...
describe('Matrix', function () {
	...
	describe('add', function () {
		it('can perform component-wise addition between two matrices', function () {
			...
			expect(Matrixjs.add(b, b)).toBeCloseToMatrix(new Matrixjs(2, 2).set(4, 8, 12, 16));
		});
		...
		it('performs partial addition when applied to matrices of different size', function () {
			...
			expect(Matrixjs.add(m2, m3)).toBeCloseToMatrix(expected1);

			var expected2 = new Matrixjs(3, 3).set(2, 4, 6, 8, NaN, NaN, NaN, NaN, NaN);
			expect(Matrixjs.add(m3, m2)).toBeCloseToMatrix(expected2);
		});
	});
	...
	describe('sub', function () {
		it('can perform component-wise subtraction between two matrices', function () {
			...
			expect(Matrixjs.sub(b, b)).toBeCloseToMatrix(new Matrixjs(2, 2).set(0, 0, 0, 0));
		});
		...
		it('performs partial subtraction when applied to matrices of different size', function () {
			...
			expect(Matrixjs.sub(m2, m3)).toBeCloseToMatrix(expected1);

			var expected2 = new Matrixjs(3, 3).set(0, 0, 0, 0, NaN, NaN, NaN, NaN, NaN);
			expect(Matrixjs.sub(m3, m2)).toBeCloseToMatrix(expected2);
		});
	});
	...
	describe('mul', function () {
		it('can perform component-wise multiplication between two matrices', function () {
			...
			expect(Matrixjs.mul(b, b)).toBeCloseToMatrix(new Matrixjs(2, 2).set(4, 16, 36, 64));
		});
		...
		it('performs partial multiplication when applied to matrices of different size', function () {
			...
			expect(Matrixjs.mul(m2, m3)).toBeCloseToMatrix(expected1);

			var expected2 = new Matrixjs(3, 3).set(1, 4, 9, 16, NaN, NaN, NaN, NaN, NaN);
			expect(Matrixjs.mul(m3, m2)).toBeCloseToMatrix(expected2);
		});
	});
	...
	describe('div', function () {
		it('can perform component-wise division between two matrices', function () {
			...
			expect(Matrixjs.div(b, b)).toBeCloseToMatrix(new Matrixjs(2, 2).set(1, 1, 1, 1));
		});
		...
		it('performs partial multiplication when applied to matrices of different size', function () {
			...
			expect(Matrixjs.div(m2, m3)).toBeCloseToMatrix(expected1);

			var expected2 = new Matrixjs(3, 3).set(1, 1, 1, 1, NaN, NaN, NaN, NaN, NaN);
			expect(Matrixjs.div(m3, m2)).toBeCloseToMatrix(expected2);
		});
	});
	...
	it('Can perform component-wise addition between a matrix and a scalar', function () {
		...
		expect(Matrixjs.add(b, 2)).toBeCloseToMatrix(new Matrixjs(2, 2).set(4, 6, 8, 10));
	});
	...
	it('can perform component-wise subtraction between a matrix and a scalar', function () {
		...
		expect(Matrixjs.sub(b, 2)).toBeCloseToMatrix(new Matrixjs(2, 2).set(0, 2, 4, 6));
	});
	...
	it('can perform component-wise multiplication between a matrix and a scalar', function () {
		...
		expect(a).toBeCloseToMatrix(new Matrixjs(2, 2).set(4, 8, 12, 16));
		expect(Matrixjs.mul(b, 2)).toBeCloseToMatrix(new Matrixjs(2, 2).set(4, 8, 12, 16));
	});
	...
	it('can perform component-wise division between a matrix and a scalar', function () {
		...
		expect(Matrixjs.div(b, 2)).toBeCloseToMatrix(new Matrixjs(2, 2).set(1, 2, 3, 4));
	});
	...
	describe('combine', function () {
		it('can combine multiple matrices into a single matrix', function () {
			...
			expect(Matrixjs.combine(b, b)).toBeCloseToMatrix(new Matrixjs(2, 2).set(28, 40, 60, 88));
		});
		...
		it('performs partial combination when applied to matrices of different size', function () {
			...
			expect(Matrixjs.combine(m2, m3)).toEqual(jasmine.any(Matrixjs));
			expect(Matrixjs.combine(m3, m2)).toEqual(jasmine.any(Matrixjs));
		});
	});
	...
	describe('transpose', function () {
		it('can be transposed', function () {
			...
			expect(Matrixjs.transpose(b, b)).toBeCloseToMatrix(new Matrixjs(2, 2).set(0, 2, 1, 3));
			expect(Matrixjs.transpose(c)).toBeCloseToMatrix(new Matrixjs(2, 3).set(0, 3, 1, 4, 2, 5));
		});
		...
		it('performs partial combination when applied to matrices of different size', function () {
			...
			// reusults are unpredictable - they're surely going to be some matrices partially filled with NaN
			expect(Matrixjs.transpose(m32, m32)).toEqual(jasmine.any(Matrixjs));
		});
	});
	...
	it('can be copied', function () {
		...
		expect(b).toEqual(a);
		expect(Matrixjs.copy(b, a)).toEqual(a);
	});
	...
	describe('', function () {
		it('can be tested for approximate equaltiy', function () {
			...
			expect(Matrixjs.equals(a, b)).toEqual(true);
			expect(a.equals(c)).toEqual(false);
			expect(Matrixjs.equals(a, c)).toEqual(false);
		});
