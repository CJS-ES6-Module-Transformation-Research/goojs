...
describe('Matrix2', function () {
	...
	describe('constructor', function () {
		it('creates an identity matrix when given no parameters', function () {
			expect(new _Matrix.Matrix2()).toBeCloseToMatrix(Matrix2js_IDENTITY);
		});
	...
	describe('deprecated shim added 2015-10-07 (v1.0)', function () {
		it('can add', function () {
			...
			expect(Matrix2js_add(a, a)).toBeCloseToMatrix(new _Matrix.Matrix2(2, 4, 6, 8));
		...
		it('can combine multiple matrices into a single matrix', function () {
			...
			expect(Matrix2js_combine(b, b)).toBeCloseToMatrix(new _Matrix.Matrix2(7, 10, 15, 22));
		});
		it('can divide', function () {
			...
			expect(Matrix2js_div(b, b)).toBeCloseToMatrix(new _Matrix.Matrix2(1, 1, 1, 1));
		});
