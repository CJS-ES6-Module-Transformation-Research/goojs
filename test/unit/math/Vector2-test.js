...
describe('Vector2', function () {
	...
	describe('constructor', function () {
		it('creates a zero vector when given no parameters', function () {
			expect(new Vector2js()).toBeCloseToVector(Vector2js.ZERO);
		});

		it('creates a vector when given 2 parameters', function () {
			var vector = new Vector2js(11, 22);
			var expected = new Vector2js();
		...
		it('creates a vector when given an array', function () {
			var vector = new Vector2js([11, 22]);
			var expected = new Vector2js(11,22);

			expect(vector).toBeCloseToVector(expected);
		});

		it('creates a vector when given a vector', function () {
			var original = new Vector2js(1, 2);
			var vector = new Vector2js(original);
			var expected = new Vector2js(1, 2);
	...
	describe('aliases', function () {
		...
		it('can be modified through aliases', function () {
			var v1 = new Vector2js();
			v1.x = 11;
			v1.y = 22;
			expect(v1).toBeCloseToVector(new Vector2js(11, 22));

			var v2 = new Vector2js();
			v2.u = 22;
			v2.v = 33;
			expect(v2).toBeCloseToVector(new Vector2js(22, 33));
		});
	});

	describe('scale', function () {
		it('scales a vector', function () {
			var vector = new Vector2js(1, 2);
			vector.scale(123);
			expect(vector).toBeCloseToVector(new Vector2js(1 * 123, 2 * 123));
		});
	});

	describe('dot', function () {
		it('can calculate dot products', function () {
			var a = new Vector2js(1, 2);
			var b = new Vector2js(1, 2);
	...
	describe('reflect', function () {
		it('can reflect a vector', function () {
			var plane = new Vector2js(-1, 1).normalize(); // more like a vector
			var original = new Vector2js(1, 0);
			var reflection = original.clone().reflect(plane);

			expect(reflection).toBeCloseToVector(new Vector2js(0, 1));
		});
	});
	...
	describe('copy', function () {
		it('can copy values from a vector', function () {
			var vector = new Vector2js(11, 22);
			vector.set(new Vector2js(55, 66));
			expect(vector).toBeCloseToVector(new Vector2js(55, 66));
		});
	});

	describe('clone', function () {
		it('clones a vector', function () {
			var original = new Vector2js(11, 22);
	...
	describe('addDirect', function () {
		it('can add to a vector', function () {
			...
			expect(vector).toBeCloseToVector(new Vector2js(66, 88));
		});
	});
	...
	describe('add', function () {
		it('can add to a vector', function () {
			var vector = new Vector2js(11, 22);
			vector.add(new Vector2js(55, 66));
			expect(vector).toBeCloseToVector(new Vector2js(66, 88));
		});
	});
	...
	describe('subDirect', function () {
		it('can subtract from a vector', function () {
			...
			expect(vector).toBeCloseToVector(new Vector2js(11 - 55, 22 - 66));
		});
	});
	...
	describe('sub', function () {
		it('can subtract from a vector', function () {
			var vector = new Vector2js(11, 22);
			vector.sub(new Vector2js(55, 66));
			expect(vector).toBeCloseToVector(new Vector2js(11 - 55, 22 - 66));
		});
	});
	...
	describe('mul', function () {
		it('can multiply with a vector', function () {
			var vector = new Vector2js(11, 22);
			vector.mul(new Vector2js(55, 66));
			expect(vector).toBeCloseToVector(new Vector2js(11 * 55, 22 * 66));
		});
	});
	...
	describe('div', function () {
		it('can multiply with a vector', function () {
			var vector = new Vector2js(11, 22);
			vector.div(new Vector2js(55, 66));
			expect(vector).toBeCloseToVector(new Vector2js(11 / 55, 22 / 66));
		});
	});
	...
	describe('fromArray', function () {
		it('creates a Vector2 from an array', function () {
			expect(Vector2js.fromArray([11, 22]))
				.toBeCloseToVector(new Vector2js(11, 22));
		});
	});

	describe('fromAny', function () {
		it('creates a Vector2 from 2 numbers', function () {
			expect(Vector2js.fromAny(11, 22))
				.toBeCloseToVector(new Vector2js(11, 22));
		});
		...
		it('creates a Vector2 from an { x, y } object', function () {
			expect(Vector2js.fromAny({ x: 11, y: 22 }))
				.toBeCloseToVector(new Vector2js(11, 22));
		});

		it('clones a Vector2', function () {
			var original = new Vector2js(11, 22);
			var clone = Vector2js.fromAny(original);
	...
	describe('toArray', function () {
		it('converts to array', function () {
			expect(Vector2js.fromArray([1, 2]).toArray()).toEqual([1, 2]);
		});
	});
	...
	describe('deprecated shim added 2015-10-07 (v1.0)', function () {
		describe('.data', function () {
			...
			it('distinguishes vectors', function () {
				var u = new Vector2js(1, 2);
				var v = new Vector2js(4, 5);
		...
		describe('add', function () {
			it('can perform addition', function () {
				...
				expect(a).toBeCloseToVector(new Vector2js(2, 4));
				expect(Vector2js.add(b, b)).toBeCloseToVector(new Vector2js(2, 4));

				expect(Vector2js.add(b, 1)).toBeCloseToVector(new Vector2js(2, 3));
				expect(Vector2js.add(1, b)).toBeCloseToVector(new Vector2js(2, 3));

				expect(Vector2js.add(b, [1, 2])).toBeCloseToVector(new Vector2js(2, 4));
				expect(Vector2js.add([1, 2], b)).toBeCloseToVector(new Vector2js(2, 4));
			});
		});
		...
		describe('sub', function () {
			it('can perform subtraction', function () {
				...
				expect(a).toBeCloseToVector(new Vector2js(0, 0));
				expect(Vector2js.sub(b, b)).toBeCloseToVector(new Vector2js(0, 0));

				expect(Vector2js.sub(b, 1)).toBeCloseToVector(new Vector2js(0, 1));
				expect(Vector2js.sub(1, b)).toBeCloseToVector(new Vector2js(0, -1));

				expect(Vector2js.sub(b, [1, 2])).toBeCloseToVector(new Vector2js(0, 0));
				expect(Vector2js.sub([1, 2], b)).toBeCloseToVector(new Vector2js(0, 0));
			});
		});
		...
		describe('mul', function () {
			it('can perform multiplication', function () {
				...
				expect(a).toBeCloseToVector(new Vector2js(1, 4));
				expect(Vector2js.mul(b, b)).toBeCloseToVector(new Vector2js(1, 4));

				expect(Vector2js.mul(b, 1)).toBeCloseToVector(new Vector2js(1, 2));
				expect(Vector2js.mul(1, b)).toBeCloseToVector(new Vector2js(1, 2));

				expect(Vector2js.mul(b, [1, 2])).toBeCloseToVector(new Vector2js(1, 4));
				expect(Vector2js.mul([1, 2], b)).toBeCloseToVector(new Vector2js(1, 4));
			});
		});
		...
		describe('div', function () {
			it('can perform division', function () {
				...
				expect(a).toBeCloseToVector(new Vector2js(1, 1));
				expect(Vector2js.div(b, b)).toBeCloseToVector(new Vector2js(1, 1));

				expect(Vector2js.div(b, 1)).toBeCloseToVector(new Vector2js(1, 2));
				expect(Vector2js.div(1, b)).toBeCloseToVector(new Vector2js(1, 1/2));

				expect(Vector2js.div(b, [1, 2])).toBeCloseToVector(new Vector2js(1, 1));
				expect(Vector2js.div([1, 2], b)).toBeCloseToVector(new Vector2js(1, 1));
			});
		});
		...
		describe('dot', function () {
			it('can calculate dot products', function () {
				...
				expect(a.dot(b)).toEqual(5);
				expect(Vector2js.dot(a, b)).toEqual(5);
			});

			it('returns garbage if supplied with garbage', function () {
				expect(Vector2js.dot([1, 2], [5])).toEqual(NaN);
			});
		});
		...
		describe('copy', function () {
			it('can copy values from a vector', function () {
				var vector = new Vector2js(11, 22);
				vector.setVector(new Vector2js(55, 66));
				expect(vector).toBeCloseToVector(new Vector2js(55, 66));
			});
		});
		...
		describe('addVector', function () {
			it('can add to a vector', function () {
				var vector = new Vector2js(11, 22);
				vector.addVector(new Vector2js(55, 66));
				expect(vector).toBeCloseToVector(new Vector2js(66, 88));
			});
		});
		...
		describe('mulVector', function () {
			it('can multiply with a vector', function () {
				var vector = new Vector2js(11, 22);
				vector.mulVector(new Vector2js(55, 66));
				expect(vector).toBeCloseToVector(new Vector2js(11 * 55, 22 * 66));
			});
		});
		...
		describe('subVector', function () {
			it('can subtract from a vector', function () {
				var vector = new Vector2js(11, 22);
				vector.subVector(new Vector2js(55, 66));
				expect(vector).toBeCloseToVector(new Vector2js(11 - 55, 22 - 66));
			});
		});
	});
