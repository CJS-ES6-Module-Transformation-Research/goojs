...
describe('Vector2', function () {
	...
	describe('constructor', function () {
		it('creates a zero vector when given no parameters', function () {
			expect(new _Vector.Vector2()).toBeCloseToVector(_Vector.Vector2.ZERO);
		});
	...
	describe('fromArray', function () {
		it('creates a Vector2 from an array', function () {
			expect(_Vector.Vector2.fromArray([11, 22])).toBeCloseToVector(new _Vector.Vector2(11, 22));
		});
	});

	describe('fromAny', function () {
		it('creates a Vector2 from 2 numbers', function () {
			expect(_Vector.Vector2.fromAny(11, 22)).toBeCloseToVector(new _Vector.Vector2(11, 22));
		});
		...
		it('creates a Vector2 from an { x, y } object', function () {
			expect(_Vector.Vector2.fromAny({ x: 11, y: 22 })).toBeCloseToVector(new _Vector.Vector2(11, 22));
		});

		it('clones a Vector2', function () {
			var original = new _Vector.Vector2(11, 22);
			var clone = _Vector.Vector2.fromAny(original);
	...
	describe('toArray', function () {
		it('converts to array', function () {
			expect(_Vector.Vector2.fromArray([1, 2]).toArray()).toEqual([1, 2]);
		});
	});
	...
	describe('deprecated shim added 2015-10-07 (v1.0)', function () {
		...
		describe('add', function () {
			it('can perform addition', function () {
				...
				expect(_Vector.Vector2.add(b, b)).toBeCloseToVector(new _Vector.Vector2(2, 4));

				expect(_Vector.Vector2.add(b, 1)).toBeCloseToVector(new _Vector.Vector2(2, 3));
				expect(_Vector.Vector2.add(1, b)).toBeCloseToVector(new _Vector.Vector2(2, 3));

				expect(_Vector.Vector2.add(b, [1, 2])).toBeCloseToVector(new _Vector.Vector2(2, 4));
				expect(_Vector.Vector2.add([1, 2], b)).toBeCloseToVector(new _Vector.Vector2(2, 4));
			});
		});
		...
		describe('sub', function () {
			it('can perform subtraction', function () {
				...
				expect(_Vector.Vector2.sub(b, b)).toBeCloseToVector(new _Vector.Vector2(0, 0));

				expect(_Vector.Vector2.sub(b, 1)).toBeCloseToVector(new _Vector.Vector2(0, 1));
				expect(_Vector.Vector2.sub(1, b)).toBeCloseToVector(new _Vector.Vector2(0, -1));

				expect(_Vector.Vector2.sub(b, [1, 2])).toBeCloseToVector(new _Vector.Vector2(0, 0));
				expect(_Vector.Vector2.sub([1, 2], b)).toBeCloseToVector(new _Vector.Vector2(0, 0));
			});
		});
		...
		describe('mul', function () {
			it('can perform multiplication', function () {
				...
				expect(_Vector.Vector2.mul(b, b)).toBeCloseToVector(new _Vector.Vector2(1, 4));

				expect(_Vector.Vector2.mul(b, 1)).toBeCloseToVector(new _Vector.Vector2(1, 2));
				expect(_Vector.Vector2.mul(1, b)).toBeCloseToVector(new _Vector.Vector2(1, 2));

				expect(_Vector.Vector2.mul(b, [1, 2])).toBeCloseToVector(new _Vector.Vector2(1, 4));
				expect(_Vector.Vector2.mul([1, 2], b)).toBeCloseToVector(new _Vector.Vector2(1, 4));
			});
		});
		...
		describe('div', function () {
			it('can perform division', function () {
				...
				expect(_Vector.Vector2.div(b, b)).toBeCloseToVector(new _Vector.Vector2(1, 1));

				expect(_Vector.Vector2.div(b, 1)).toBeCloseToVector(new _Vector.Vector2(1, 2));
				expect(_Vector.Vector2.div(1, b)).toBeCloseToVector(new _Vector.Vector2(1, 1 / 2));

				expect(_Vector.Vector2.div(b, [1, 2])).toBeCloseToVector(new _Vector.Vector2(1, 1));
				expect(_Vector.Vector2.div([1, 2], b)).toBeCloseToVector(new _Vector.Vector2(1, 1));
			});
		});
		...
		describe('dot', function () {
			it('can calculate dot products', function () {
				...
				expect(a.dot(b)).toEqual(5);
				expect(_Vector.Vector2.dot(a, b)).toEqual(5);
			});

			it('returns garbage if supplied with garbage', function () {
				expect(_Vector.Vector2.dot([1, 2], [5])).toEqual(NaN);
			});
		});
