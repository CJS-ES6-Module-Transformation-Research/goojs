...
describe('Vector2', function () {
	...
	describe('constructor', function () {
		it('creates a zero vector when given no parameters', function () {
			expect(new Vector2js()).toBeCloseToVector(Vector2js_ZERO);
		});
	...
	describe('fromArray', function () {
		it('creates a Vector2 from an array', function () {
			expect(Vector2js_fromArray([11, 22]))
	...
	describe('fromAny', function () {
		it('creates a Vector2 from 2 numbers', function () {
			expect(Vector2js_fromAny(11, 22))
				.toBeCloseToVector(new Vector2js(11, 22));
		});
		...
		it('creates a Vector2 from an { x, y } object', function () {
			expect(Vector2js_fromAny({ x: 11, y: 22 }))
				.toBeCloseToVector(new Vector2js(11, 22));
		});
	...
	describe('deprecated shim added 2015-10-07 (v1.0)', function () {
		...
		describe('add', function () {
			it('can perform addition', function () {
				...
				expect(Vector2js_add(b, b)).toBeCloseToVector(new Vector2js(2, 4));

				expect(Vector2js_add(b, 1)).toBeCloseToVector(new Vector2js(2, 3));
				expect(Vector2js_add(1, b)).toBeCloseToVector(new Vector2js(2, 3));

				expect(Vector2js_add(b, [1, 2])).toBeCloseToVector(new Vector2js(2, 4));
				expect(Vector2js_add([1, 2], b)).toBeCloseToVector(new Vector2js(2, 4));
			});
		});
		...
		describe('sub', function () {
			it('can perform subtraction', function () {
				...
				expect(Vector2js_sub(b, b)).toBeCloseToVector(new Vector2js(0, 0));

				expect(Vector2js_sub(b, 1)).toBeCloseToVector(new Vector2js(0, 1));
				expect(Vector2js_sub(1, b)).toBeCloseToVector(new Vector2js(0, -1));

				expect(Vector2js_sub(b, [1, 2])).toBeCloseToVector(new Vector2js(0, 0));
				expect(Vector2js_sub([1, 2], b)).toBeCloseToVector(new Vector2js(0, 0));
			});
		});
		...
		describe('mul', function () {
			it('can perform multiplication', function () {
				...
				expect(Vector2js_mul(b, b)).toBeCloseToVector(new Vector2js(1, 4));

				expect(Vector2js_mul(b, 1)).toBeCloseToVector(new Vector2js(1, 2));
				expect(Vector2js_mul(1, b)).toBeCloseToVector(new Vector2js(1, 2));

				expect(Vector2js_mul(b, [1, 2])).toBeCloseToVector(new Vector2js(1, 4));
				expect(Vector2js_mul([1, 2], b)).toBeCloseToVector(new Vector2js(1, 4));
			});
		});
		...
		describe('div', function () {
			it('can perform division', function () {
				...
				expect(Vector2js_div(b, b)).toBeCloseToVector(new Vector2js(1, 1));

				expect(Vector2js_div(b, 1)).toBeCloseToVector(new Vector2js(1, 2));
				expect(Vector2js_div(1, b)).toBeCloseToVector(new Vector2js(1, 1/2));

				expect(Vector2js_div(b, [1, 2])).toBeCloseToVector(new Vector2js(1, 1));
				expect(Vector2js_div([1, 2], b)).toBeCloseToVector(new Vector2js(1, 1));
			});
		});
