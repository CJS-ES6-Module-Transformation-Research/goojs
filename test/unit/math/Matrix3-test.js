...
describe('Matrix3', function () {
	...
	describe('constructor', function () {
		it('creates an identity matrix when given no parameters', function () {
			expect(new Matrix3js()).toBeCloseToMatrix(Matrix3js.IDENTITY);
		});
	...
	it('can be inverted', function () {
		...
		expect(Matrix3js.invert(b)).toBeCloseToMatrix(new Matrix3js(4, -1, 2, 2, 0, 1, 1, 0, 0));
	...
	it('can be set to identity', function () {
		...
		expect(a).toBeCloseToMatrix(Matrix3js.IDENTITY);
		expect(b).toBeCloseToMatrix(Matrix3js.IDENTITY);
	});
	...
	describe('deprecated shim added 2015-10-07 (v1.0)', function () {
		...
		it('Matrix3.prototype.combine', function () {
			...
			expect(Matrix3js.combine(b, b)).toBeCloseToMatrix(new Matrix3js(30, 36, 42, 66, 81, 96, 102, 126, 150));
		});

		it('can be transposed', function () {
			var a = new Matrix3js(1, 2, 3, 4, 5, 6, 7, 8, 9);

			expect(Matrix3js.transpose(a)).toBeCloseToMatrix(new Matrix3js(1, 4, 7, 2, 5, 8, 3, 6, 9));
		});
