...
describe('MathUtils', function () {
	...
	it('can compute the area of a triangle', function () {
		expect(MathUtilsjs_triangleArea(new srcgoomathVector2_Vector2js(5, 5), new srcgoomathVector2_Vector2js(5, 6), new srcgoomathVector2_Vector2js(7, 5))).toBeCloseTo(1.0);
	});
	...
	it('can do barycentric interpolation', function () {
		...
		expect(MathUtilsjs_barycentricInterpolation(t1, t2, t3, new srcgoomathVector3_Vector3js(2, 4, 123)).z).toBeCloseTo(40);
		expect(MathUtilsjs_barycentricInterpolation(t1, t2, t3, new srcgoomathVector3_Vector3js(3, 2, 123)).z).toBeCloseTo(35);
