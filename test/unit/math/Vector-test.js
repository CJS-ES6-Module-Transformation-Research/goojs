...
describe('Vector', function () {
	...
	describe('add', function () {
		it('can perform addition', function () {
			...
			expect(Vectorjs_add(b, b)).toBeCloseToVector(new _Vector.Vector(2).set(2, 4));
		});
	});
	...
	describe('sub', function () {
		it('can perform subtraction', function () {
			...
			expect(Vectorjs_sub(b, b)).toBeCloseToVector(new _Vector.Vector(2).set(0, 0));
		});
	});
	...
	describe('mul', function () {
		it('can perform multiplication', function () {
			...
			expect(Vectorjs_mul(b, b)).toBeCloseToVector(new _Vector.Vector(2).set(1, 4));
		});
	});
	...
	describe('div', function () {
		it('can perform division', function () {
			...
			expect(Vectorjs_div(b, b)).toBeCloseToVector(new _Vector.Vector(2).set(1, 1));
		});
	});
	...
	describe('copy', function () {
		it('can copy values', function () {
			...
			expect(Vectorjs_copy(source)).toBeCloseToVector(new _Vector.Vector(2).set(1, 2));
		});
	});
