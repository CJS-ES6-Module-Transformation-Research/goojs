...
import { LerpCurve as srcgooaddonsparticlepackcurvesLerpCurve_LerpCurvejs } from "../../../../../src/goo/addons/particlepack/curves/LerpCurve";

describe('LerpCurve', function () {
	it('.getValueAt', function () {
		var curve = new srcgooaddonsparticlepackcurvesLerpCurve_LerpCurvejs({
			curveA: new srcgooaddonsparticlepackcurvesConstantCurve_ConstantCurvejs({ value: 1 }),
			curveB: new srcgooaddonsparticlepackcurvesConstantCurve_ConstantCurvejs({ value: 2 })
		});
