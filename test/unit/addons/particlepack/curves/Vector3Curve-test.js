...
describe('Vector3Curve', function () {
	it('.getVec3ValueAt', function () {
		var curve = new Vector3Curve_Vector3Curvejs({
		...
		var store0 = new Vector3_Vector3js();
		var store1 = new Vector3_Vector3js();
		var store2 = new Vector3_Vector3js();

		curve.getVec3ValueAt(0, 0, store0);
		curve.getVec3ValueAt(0.5, 0, store1);
		curve.getVec3ValueAt(1, 0, store2);

		expect(store0).toEqual(new Vector3_Vector3js(1, 2, 3));
		expect(store1).toEqual(new Vector3_Vector3js(1, 2, 3));
		expect(store2).toEqual(new Vector3_Vector3js(1, 2, 3));
	});
	...
	it('.getVec3IntegralValueAt', function () {
		...
		expect(store0).toEqual(new Vector3_Vector3js(0, 0, 0));
		expect(store1).toEqual(new Vector3_Vector3js(0.5, 1, 1.5));
		expect(store2).toEqual(new Vector3_Vector3js(1, 2, 3));
	});
