...
var karmaWebpackProvidePluginSettings_karmaWebpackProvidePluginSettingsjsjsjs = _interopRequireWildcard(_karmaWebpackProvidePluginSettings);
...
module.exports = function (config) {
	config.set({
		...
		webpack: {
			...
			plugins: [new _webpack2.default.ProvidePlugin(karmaWebpackProvidePluginSettings_karmaWebpackProvidePluginSettingsjsjs)]
