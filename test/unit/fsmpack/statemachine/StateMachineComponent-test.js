import { Machine as Machine_Machinejs } from "../../../../src/goo/fsmpack/statemachine/Machine";
import { State as State_Statejs } from "../../../../src/goo/fsmpack/statemachine/State";
import { StateMachineComponent as StateMachineComponent_StateMachineComponentjs } from "../../../../src/goo/fsmpack/statemachine/StateMachineComponent";

describe('StateMachineComponent', function () {
	var stateMachineComponent;
	beforeEach(function () {
		stateMachineComponent = new StateMachineComponent_StateMachineComponentjs();
	});
	...
	it('can run enter on initialisation on all machines', function () {
		...
		// set up machine 1
		var machine1 = new Machine_Machinejs();
		machine1.asyncMode = true;
		stateMachineComponent.addMachine(machine1);

		var state1 = new State_Statejs('entry');
		...
		// set up machine 2
		var machine2 = new Machine_Machinejs();
		machine2.asyncMode = true;
		stateMachineComponent.addMachine(machine2);

		var state2 = new State_Statejs('entry');
	...
	it('can run enter on initialisation only on the initial state', function () {
		...
		var state1 = new State_Statejs('first');
		state1.addAction({
			ready: function () {},
			enter: function () { gotData1 += 123; },
			exit: function () {},
		...
		var state2 = new State_Statejs('second');
		state2.addAction({
			ready: function () {},
			enter: function () { gotData2 += 234; },
			exit: function () {},
	...
	it('can transition down', function () {
		...
		var state21 = new State_Statejs('third');
		state21.addAction({
			ready: function () {},
		...
		var machine11 = new Machine_Machinejs();
	...
	it('can transition down 2 levels', function () {
		...
		// {
		var state211 = new State_Statejs('fourth');
		state211.addAction({
			ready: function () {},
		...
		var machine111 = new Machine_Machinejs();
