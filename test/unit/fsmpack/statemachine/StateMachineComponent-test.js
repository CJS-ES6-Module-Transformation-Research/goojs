import { Machine as srcgoofsmpackstatemachineMachine_Machinejs } from "../../../../src/goo/fsmpack/statemachine/Machine";
import { State as srcgoofsmpackstatemachineState_Statejs } from "../../../../src/goo/fsmpack/statemachine/State";
import {     StateMachineComponent as srcgoofsmpackstatemachineStateMachineComponent_StateMachineComponentjs, } from "../../../../src/goo/fsmpack/statemachine/StateMachineComponent";

describe('StateMachineComponent', function () {
	var stateMachineComponent;
	beforeEach(function () {
		stateMachineComponent = new srcgoofsmpackstatemachineStateMachineComponent_StateMachineComponentjs();
	});
	...
	it('can run enter on initialisation on all machines', function () {
		...
		// set up machine 1
		var machine1 = new srcgoofsmpackstatemachineMachine_Machinejs();
		machine1.asyncMode = true;
		stateMachineComponent.addMachine(machine1);

		var state1 = new srcgoofsmpackstatemachineState_Statejs('entry');
		...
		// set up machine 2
		var machine2 = new srcgoofsmpackstatemachineMachine_Machinejs();
		machine2.asyncMode = true;
		stateMachineComponent.addMachine(machine2);

		var state2 = new srcgoofsmpackstatemachineState_Statejs('entry');
	...
	it('can run enter on initialisation only on the initial state', function () {
		...
		var state1 = new srcgoofsmpackstatemachineState_Statejs('first');
		state1.addAction({
			ready: function () {},
			enter: function () { gotData1 += 123; },
			exit: function () {},
		...
		var state2 = new srcgoofsmpackstatemachineState_Statejs('second');
		state2.addAction({
			ready: function () {},
			enter: function () { gotData2 += 234; },
			exit: function () {},
	...
	it('can transition down', function () {
		...
		var state21 = new srcgoofsmpackstatemachineState_Statejs('third');
		state21.addAction({
			ready: function () {},
		...
		var machine11 = new srcgoofsmpackstatemachineMachine_Machinejs();
	...
	it('can transition down 2 levels', function () {
		...
		// {
		var state211 = new srcgoofsmpackstatemachineState_Statejs('fourth');
		state211.addAction({
			ready: function () {},
		...
		var machine111 = new srcgoofsmpackstatemachineMachine_Machinejs();
