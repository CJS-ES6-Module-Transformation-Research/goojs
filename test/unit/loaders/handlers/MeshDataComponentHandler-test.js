...
describe('MeshDataComponentHandler', function () {
	...
	it('loads an entity with a meshDataComponent', function (done) {
		...
		loader.load(config.id).then(function (entity) {
			expect(entity.meshDataComponent).toEqual(jasmine.any(MeshDataComponent_MeshDataComponentjs));
			expect(entity.meshDataComponent.meshData).toEqual(jasmine.any(MeshData_MeshDatajs));
			expect(entity.meshDataComponent.currentPose).toEqual(jasmine.any(SkeletonPose_SkeletonPosejs));
			done();
		});
	});
