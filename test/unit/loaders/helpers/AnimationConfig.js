...
var AnimationConfigjs_skeleton = function() {
    var skeleton = this.gooObject("skeleton", "Dummy");
    skeleton.joints = {};
    for (var i = 0; i < 6; i++) {
        skeleton.joints[this.randomRef()] = {
...
var AnimationConfigjs_animation = function() {
    var layers = this.gooObject("animation", "Dummy");
...
var AnimationConfigjs_animstate = function() {
    var state = this.gooObject("animstate", "Dummy");
...
var AnimationConfigjs_clip = function() {
    var clip = this.gooObject("clip", "Dummy");
    clip.binaryRef = this.binary(128);
...
var AnimationConfigjs_clipChannel = function(index, samples) {
    index = index !== undefined ? index : 0;
    samples = samples || 4;
...
export { AnimationConfigjs_skeleton as skeleton, AnimationConfigjs_animation as animation, AnimationConfigjs_animstate as animstate, AnimationConfigjs_clip as clip, AnimationConfigjs_clipChannel as clipChannel };