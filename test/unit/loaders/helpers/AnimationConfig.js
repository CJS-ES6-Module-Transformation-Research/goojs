...
var AnimationConfigjs_skeleton = function AnimationConfigjs_skeleton() {
				var skeleton = this.gooObject("skeleton", "Dummy");
				skeleton.joints = {};
				for (var i = 0; i < 6; i++) {
								skeleton.joints[this.randomRef()] = {
...
var AnimationConfigjs_animation = function AnimationConfigjs_animation() {
				var layers = this.gooObject("animation", "Dummy");
...
var AnimationConfigjs_animstate = function AnimationConfigjs_animstate() {
				var state = this.gooObject("animstate", "Dummy");
...
var AnimationConfigjs_clip = function AnimationConfigjs_clip() {
				var clip = this.gooObject("clip", "Dummy");
				clip.binaryRef = this.binary(128);
...
var AnimationConfigjs_clipChannel = function AnimationConfigjs_clipChannel(index, samples) {
				index = index !== undefined ? index : 0;
				samples = samples || 4;
...
exports.skeleton = AnimationConfigjs_skeleton;
exports.animation = AnimationConfigjs_animation;
exports.animstate = AnimationConfigjs_animstate;
exports.clip = AnimationConfigjs_clip;
exports.clipChannel = AnimationConfigjs_clipChannel;
