...
var exported_skeleton = function() {
    var skeleton = this.gooObject("skeleton", "Dummy");
    skeleton.joints = {};
    for (var i = 0; i < 6; i++) {
        skeleton.joints[this.randomRef()] = {
...
var exported_animation = function() {
    var layers = this.gooObject("animation", "Dummy");
...
var exported_animstate = function() {
    var state = this.gooObject("animstate", "Dummy");
...
var exported_clipChannel = function(index, samples) {
    index = index !== undefined ? index : 0;
    samples = samples || 4;
