...
var EntityConfigjs_EntityConfigjs = {
	...
	component: {
		...
		light: function (type, options) {
			var config = srcgooutilObjectUtil_ObjectUtilsjs({}, options, {
			...
			if (config.shadowCaster) {
				...
				srcgooutilObjectUtil_ObjectUtilsjs(config.shadowSettings, {
					type: 'Blur',
		...
		collider: function (type) {
			return srcgooutilObjectUtil_ObjectUtilsjs({}, {
