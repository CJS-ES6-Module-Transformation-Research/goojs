...
var EntityConfigjs = {
	...
	component: {
		...
		light: function (type, options) {
			var config = ObjectUtil_ObjectUtilsjs.copyOptions({}, options, {
			...
			if (config.shadowCaster) {
				...
				ObjectUtil_ObjectUtilsjs.defaults(config.shadowSettings, {
					type: 'Blur',
		...
		collider: function (type) {
			return ObjectUtil_ObjectUtilsjs.defaults({}, {
...
var EntityConfigjs_entity = function(components) {
    components = components || ["transform"];
    var entity = this.gooObject("entity", "Dummy");
    entity.components = {};
    for (var i = 0; i < components.length; i++) {
...
var EntityConfigjs_attachChild = function(parent, child) {
    if (!parent.components.transform.children) {
        parent.components.transform.children = {};
    }
    var size = Object.keys(parent.components.transform.children).length;
...
export { EntityConfigjs_entity as entity, EntityConfigjs_component as component, EntityConfigjs_attachChild as attachChild };
