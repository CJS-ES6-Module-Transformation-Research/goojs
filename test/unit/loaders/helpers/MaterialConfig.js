...
var exported_material = function() {
    var material = this.gooObject("material", "Dummy");
    _.extend(material, {
        uniforms: {
            materialAmbient: {
...
var exported_textureSVG = function() {
    var texture = this.gooObject("texture", "Dummy");
    _.extend(texture, {
        magFilter: "Bilinear",
        minFilter: "Trilinear",
