import { HeightMapBoundingScript as HeightMapBoundingScript_HeightMapBoundingScript } from "../../../src/goo/scriptpack/HeightMapBoundingScript";

describe('Build a basic heightmap and check basic points', function () {
	var heightMatrix = [[0, 0, 0, 0], [0, 0.5, 0.5, 0], [0.5, 1, 1, 0.5], [1, 1, 1, 1]];
	var heightMapScript = new HeightMapBoundingScript_HeightMapBoundingScript(heightMatrix);
