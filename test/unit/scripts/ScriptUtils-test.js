import { ScriptUtils as srcgooscriptsScriptUtils_ScriptUtilsjs } from "../../../src/goo/scripts/ScriptUtils";
...
describe('ScriptUtils', function () {
	it('defaults missing keys', function () {
		...
		srcgooscriptsScriptUtils_ScriptUtilsjs.fillDefaultValues(parametersValues, parametersDefinition);
