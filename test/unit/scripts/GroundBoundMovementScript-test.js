import {     GroundBoundMovementScript as GroundBoundMovementScript_GroundBoundMovementScriptjs, } from "../../../src/goo/scriptpack/GroundBoundMovementScript";
import { MovementSystem as MovementSystem_MovementSystemjs } from "../../../src/goo/entities/systems/MovementSystem";
...
xdescribe('Movement script tests', function () {
	var movementSystem = new MovementSystem_MovementSystemjs();
	...
	beforeEach(function () {
		groundBoundMovementScript = new GroundBoundMovementScript_GroundBoundMovementScriptjs();
		entity = {
			transformComponent: new TransformComponent_TransformComponentjs(),
			movementComponent: new MovementComponent_MovementComponentjs(),
			_world: { tpf: 0.1 }
		};
