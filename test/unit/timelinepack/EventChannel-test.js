import { EventChannel as srcgootimelinepackEventChannel_EventChanneljs } from "../../../src/goo/timelinepack/EventChannel";

describe('EventChannel', function () {
	var channel;
	beforeEach(function () {
		channel = new srcgootimelinepackEventChannel_EventChanneljs();
	});
