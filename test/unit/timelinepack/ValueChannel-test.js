import { ValueChannel as ValueChannel_ValueChanneljs } from "../../../src/goo/timelinepack/ValueChannel";
...
describe('ValueChannel', function () {
	var channel;
	beforeEach(function () {
		channel = new ValueChannel_ValueChanneljs();
...
describe('tweener factories', function () {
	...
	describe('getSimpleTransformTweener', function () {
		it('gets a translation tweener that alters the translation of the resolved entity', function () {
			var tweener = ValueChannel_ValueChanneljs.getSimpleTransformTweener('translation', 'y', '', resolver);
			tweener(0, 123);
		...
		it('gets a scale tweener that alters the scale of the resolved entity', function () {
			var tweener = ValueChannel_ValueChanneljs.getSimpleTransformTweener('scale', 'z', '', resolver);
			tweener(0, 123);
	...
	describe('getRotationTweener', function () {
		it('gets a rotation tweener that alters the rotation of the resolved entity', function () {
			var tweener = ValueChannel_ValueChanneljs.getRotationTweener(0, '', resolver, [0, 0, 0]);
			tweener(0, 123 * MathUtils_MathUtilsjs.RAD_TO_DEG);
			var expectedRotation = new Matrix3_Matrix3js().fromAngles(123, 0, 0);
