import { ValueChannel as ValueChannel_ValueChannel } from "../../../src/goo/timelinepack/ValueChannel";
...
describe('ValueChannel', function () {
	var channel;
	beforeEach(function () {
		channel = new ValueChannel_ValueChannel();
...
describe('tweener factories', function () {
	...
	describe('getSimpleTransformTweener', function () {
		it('gets a translation tweener that alters the translation of the resolved entity', function () {
			var tweener = ValueChannel_ValueChannel.getSimpleTransformTweener('translation', 'y', '', resolver);
			tweener(0, 123);
		...
		it('gets a scale tweener that alters the scale of the resolved entity', function () {
			var tweener = ValueChannel_ValueChannel.getSimpleTransformTweener('scale', 'z', '', resolver);
			tweener(0, 123);
	...
	describe('getRotationTweener', function () {
		it('gets a rotation tweener that alters the rotation of the resolved entity', function () {
			var tweener = ValueChannel_ValueChannel.getRotationTweener(0, '', resolver, [0, 0, 0]);
			tweener(0, 123 * MathUtils_MathUtils.RAD_TO_DEG);
			var expectedRotation = new Matrix3_Matrix3().fromAngles(123, 0, 0);
