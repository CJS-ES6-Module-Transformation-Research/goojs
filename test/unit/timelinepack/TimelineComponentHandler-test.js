...
import { TimelineComponent as TimelineComponent_TimelineComponentjs } from "../../../src/goo/timelinepack/TimelineComponent";
...
describe('TimelineComponentHandler', function () {
	...
	it('loads an entity with a timeline component', function (done) {
		...
		loader.load(config.id).then(function (entity) {
			expect(entity.timelineComponent).toEqual(jasmine.any(TimelineComponent_TimelineComponentjs));
